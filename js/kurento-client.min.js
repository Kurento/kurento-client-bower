...
function checkStatsType(t,a){if("string"!=typeof a)throw SyntaxError(t+" param should be a String, not "+typeof a);if(!a.match("inboundrtp|outboundrtp|session|datachannel|track|transport|candidatepair|localcandidate|remotecandidate"))throw SyntaxError(t+" param is not one of [inboundrtp|outboundrtp|session|datachannel|track|transport|candidatepair|localcandidate|remotecandidate] ("+a+")")}var kurentoClient=require("kurento-client");module.exports=checkStatsType;
