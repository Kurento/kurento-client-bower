...
function findIndex(e,n){for(var t,r=0;t=e[r];r++)if(n(t))return r;return-1}function serializeParams(e){for(var n in e){var t=e[n];if(t instanceof MediaObject){var r=t.id;void 0!==r&&(e[n]=r)}}return e}function serializeOperation(e,n){var t=e.params;switch(e.method){case"create":t.constructorParams=serializeParams(t.constructorParams);break;default:t=serializeParams(t),t.operationParams=serializeParams(t.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,t,r){var i=[];void 0!=e&&i.push(e);for(var a in n){var o=n[a];void 0!==o&&i.push(o)}return void 0!=t&&i.push(t),promiseCallback(Promise.all(i),r)}function noop(e){e&&console.trace(e)}function KurentoClient(e,n,t){function r(e){var n=e.method,t=e.params.value,r=t.object,i=g[r];if(!i)return console.warn("Unknown object id '"+r+"'",e);switch(n){case"onEvent":i.emit(t.type,t.data);break;default:console.warn("Unknown message type '"+n+"'")}}function i(e){var n=e.method,t=e.params,r=e.callback,i=e.stack,a=Date.now();O.encode(n,t,function(e,n){if(e){var t=Date.now(),o=Error;switch(e.code){case MEDIA_OBJECT_TYPE_NOT_FOUND:o=TypeError;break;case MEDIA_OBJECT_NOT_FOUND:o=ReferenceError;break;case MEDIA_OBJECT_METHOD_NOT_FOUND:o=SyntaxError}e=extend(new o(e.message||e),e),Object.defineProperties(e,{requestTimestamp:{value:a},responseTimestamp:{value:t},stack:{value:[e.toString()].concat(e.stack.split("\n")[1],i.split("\n").slice(2)).join("\n")}})}else v.sessionId!==n.sessionId&&Object.defineProperty(v,"sessionId",{configurable:!0,value:n.sessionId});r(e,n)})}function a(){var e=_.shift();if(_.length){for(;e&&"transaction"===e.method;)i(e),e=_.shift();for(var n=[];e;)"transaction"===e.method?(n.length&&(o("transaction",{operations:n},noop),n=[]),o("transaction",e.params,e.callback)):n.push(e),e=_.shift();n.length&&T({operations:n})}else i(e)}function o(e,n,t){var r=(new Error).stack;n.sessionId=v.sessionId,v.then(function(){_.length||async.setImmediate(a);var i={method:e,params:n,callback:t};Object.defineProperty(i,"stack",{value:r}),_.push(i)},t)}function c(e,n,t){function r(e,r){var i=n.object;if(i===r)return t(null,i);if(e)return i.emit("_id",e),t(e);var a=r.value;t(null,d(i,a))}return e?transactionOperation.call(e,"create",n,t):P.length?transactionOperation.call(P,"create",n,t):(t=t||noop,void deferred(null,n.constructorParams,null,function(e){return e?t(e):(n.constructorParams=serializeParams(n.constructorParams),void o("create",n,r))}))}function s(e,n,t,r){if(e)return transactionOperation.call(e,n,t,r);var i=t.object;if(i&&i.transactions&&i.transactions.length){var a=new TransactionNotCommitedException;return a.method=n,a.params=t,setTimeout(r,0,a)}for(var c in t.operationParams){var i=t.operationParams[c];if(i&&i.transactions&&i.transactions.length){var a=new TransactionNotCommitedException;return a.method=n,a.params=t,setTimeout(r,0,a)}}if(P.length)return transactionOperation.call(P,n,t,r);var s=new Promise(function(e,r){function i(n,t){return n?r(n):void e(t)}p=deferred(t.object,t.operationParams,p,function(e){return e?r(e):(t=serializeParams(t),t.operationParams=serializeParams(t.operationParams),void o(n,t,i))})});h=promiseCallback(s,r),"release"==n&&(p=h)}function u(e,n){function t(e,n){if(n instanceof MediaObject&&void 0===n.id){var t=findIndex(a,function(t){return e!=t&&t.params.object===n});if(t>=0)return"newref:"+t;l.push(n)}return n}function r(e,t){return e?n(e):(a.forEach(function(e,n){var r=e.callback||noop,i=t.value[n];if(void 0==i)return r(new Error("Command not executed in the server"));var a,o=i.error,c=i.result;switch(c&&(a=c.value),e.method){case"create":var s=e.params.object;if(o)return s.emit("_id",o),r(o);r(null,d(s,a));break;default:r(o,c)}}),void n(null,t))}if(P.length)return transactionOperation.call(P,"transaction",e,n);n=n||noop;for(var i,a=e.operations,c=0;i=a[c];c++){var s=i.params.object;if(s instanceof MediaObject&&null===s.id){var u=new ReferenceError("MediaObject not found in server");return u.code=40101,u.object=s,a.forEach(function(e){"create"==e.method&&e.params.object.emit("_id",u);var n=e.callback;n instanceof Function&&n(u)}),n(u)}}var l=[];a.forEach(function(e){var n=e.params;switch(e.method){case"create":var r=n.constructorParams;for(var i in r)r[i]=t(e,r[i]);break;default:n.object=t(e,n.object);var a=n.operationParams;for(var i in a)a[i]=t(e,a[i])}}),Promise.all(l).then(function(){a.forEach(serializeOperation),o("transaction",e,r)},n)}function l(e,n){if(P.length)return transactionOperation.call(P,"transaction",e,n);var t=e.operations;async.each(t,function(e){switch(e.method){case"create":c(void 0,e.params,e.callback);break;case"transaction":l(e.params.operations,e.callback);break;default:s(void 0,e.method,e.params,e.callback)}},n)}function d(e,n){var t=g[n];return t?t:(e.emit("_id",null,n),g[n]=e,e.once("release",function(){delete g[n]}),e)}function f(e,n){function t(t,r){if(t)return n(t);var i=k.createInmediate(r);return n(null,d(i,e))}if(void 0==e)return n(new TypeError("'id' can't be null or undefined"));var r=g[e];if(r)return n(null,r);var i={object:e};o("describe",i,t)}function m(t){var r=!1,i=reconnect({failAfter:b},function(e){r&&(e.writable=!1),O.transport=e}).connect(e);if(Object.defineProperty(this,"_re",{get:function(){return i}}),this.close=function(){r=!0,h.then(i.disconnect.bind(i))},i.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){var t=new Promise(function(t,r){function a(){i.removeListener("fail",o);var a;if(e)try{a=e.call(v,v)}catch(c){return n||console.trace("Uncaugh exception",c),r(c)}t(a)}function o(){i.removeListener("connection",a);var e=new Error("Connection error");if(n)try{e=n.call(v,e)}catch(t){return r(t)}else console.trace("Uncaugh exception",e);r(e)}i.connected?a():i.reconnect?(i.once("connection",a),i.once("fail",o)):o()});return disguise(t,this)},this["catch"]=this.then.bind(this,null),n.strict){var a=this.getServerManager().then(function(e){return e.getInfo()}).then(function(e){var n=e.modules.map(function(e){return e.name}),t=KurentoClient.register.modules.filter(function(e){return n.indexOf(e)<0}),r=t.length;if(r){if(1===r)var i="Module '"+t[0]+"' is not installed in the Kurento Media Server";else var i="Modules '"+t.slice(0,-1).join("', '")+"' and '"+t[r-1]+"' are not installed in the Kurento Media Server";var a=new SyntaxError(i);return a.modules=t,Promise.reject(a)}return Promise.resolve(v)});t&&a.then(t.bind(void 0,null),t)}else t&&this.then(t.bind(void 0,null),t)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,t);var v=this;EventEmitter.call(this);var p=Promise.resolve(),h=Promise.resolve();n instanceof Function&&(t=n,n=void 0),n=n||{};var b=n.failAfter;void 0==b&&(b=5),void 0===n.enableTransactions&&(n.enableTransactions=!0),void 0===n.strict&&(n.strict=!0),n.request_timeout=n.request_timeout||BASE_TIMEOUT,n.response_timeout=n.response_timeout||BASE_TIMEOUT,n.duplicates_timeout=n.duplicates_timeout||BASE_TIMEOUT;var g={};if("string"==typeof e){var E=n.access_token;void 0!=E&&(e=url.parse(e,!0),e.query.access_token=E,e=url.format(e),delete n.access_token)}var O=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):r(e):void console.error("Invalid request instance",e)}),T=n.enableTransactions?u:l,P=new TransactionsManager(this,function(e,n){var t={object:v,operations:e};T(t,n)});this.beginTransaction=P.beginTransaction.bind(P),this.endTransaction=P.endTransaction.bind(P),this.transaction=P.transaction.bind(P),Object.defineProperty(this,"sessionId",{configurable:!0}),this.on("disconnect",function(){Object.defineProperty(this,"sessionId",{configurable:!1,get:function(){throw new SyntaxError("Client has been disconnected")}});for(var e in g)g[e].emit("release")});var _=[];this.getMediaobjectById=function(e,n){return disguise(createPromise(e,f,n),this)};var k=new MediaObjectCreator(this,c,s,T,this.getMediaobjectById.bind(this),n.strict);Object.defineProperty(this,"_resetCache",{value:function(){g={}}}),this.create=k.create.bind(k),m.call(v,t)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),disguise=require("./disguise"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),TransactionsManager=require("./TransactionsManager"),TransactionNotCommitedException=TransactionsManager.TransactionNotCommitedException,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("kurento-client-core").abstracts.MediaObject;const MEDIA_OBJECT_TYPE_NOT_FOUND=40100,MEDIA_OBJECT_NOT_FOUND=40101,MEDIA_OBJECT_METHOD_NOT_FOUND=40105,BASE_TIMEOUT=2e4;inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e instanceof Array||(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0),e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var t=e[0],r=e[e.length-1],i=new Promise(function(n,r){function i(e,t){return e?r(e):void n(t)}async.each(e.slice(1),function(e,n){t=t.connect(e,n)},i)});return disguise(promiseCallback(i,n),r)},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)};var singletons={};KurentoClient.getSingleton=function(e,n){var t=singletons[e];return t||(t=KurentoClient(e,function(t,r){return t?n(t):(singletons[e]=r,void r.on("disconnect",function(){delete singletons[e]}))})),disguise(promiseCallback(t,n),t)},module.exports=KurentoClient;
