...
function BaseRtpEndpoint(){BaseRtpEndpoint.super_.call(this)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),ChecktypeError=kurentoClient.checkType.ChecktypeError,SdpEndpoint=require("./SdpEndpoint");inherits(BaseRtpEndpoint,SdpEndpoint),BaseRtpEndpoint.prototype.getMaxVideoSendBandwidth=function(t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(t=void 0),this._invoke(n,"getMaxVideoSendBandwidth",t)},BaseRtpEndpoint.prototype.getMinVideoSendBandwidth=function(t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(t=void 0),this._invoke(n,"getMinVideoSendBandwidth",t)},BaseRtpEndpoint.constructorParams={},BaseRtpEndpoint.events=SdpEndpoint.events,module.exports=BaseRtpEndpoint,BaseRtpEndpoint.check=function(t,n){if(!(n instanceof BaseRtpEndpoint))throw ChecktypeError(t,BaseRtpEndpoint,n)};
...
function serializeParams(e){for(var n in e){var r=e[n];r instanceof MediaObject&&(e[n]=r.id)}return e}function serializeOperation(e,n){var r=e.params;switch(e.method){case"create":r.constructorParams=serializeParams(r.constructorParams);break;default:var t=r.object&&r.object.id;void 0!==t&&(r.object=t),r.operationParams=serializeParams(r.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,r,t){var i=[];void 0!=e&&i.push(e);for(var a in n){var o=n[a];void 0!==o&&i.push(o)}return void 0!=r&&i.push(r),promiseCallback(Promise.all(i),t)}function noop(e){e&&console.trace(e)}function id2object(e,n,r,t,i){if(e)return i(e);var a=["getConnectedSinks","getMediaPipeline","getMediaSinks","getMediaSrcs","getParent"];if(-1!=a.indexOf(r)){var o=n.sessionId;return this.getMediaobjectById(t,function(e,n){if(e)return i(e);var n={sessionId:o,value:n};i(null,n)})}i(null,n)}function KurentoClient(e,n,r){function t(e){var n=e.method,r=e.params.value,t=r.object,i=h[t];if(!i)return console.warn("Unknown object id '"+t+"'",e);switch(n){case"onEvent":i.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+n+"'")}}function i(n){var r=!1,t=reconnect({failAfter:m},function(e){r&&(e.writable=!1),g.transport=e}).connect(e);Object.defineProperty(this,"_re",{configurable:!0,get:function(){return t}}),this.close=function(){r=!0,p.then(t.disconnect.bind(t))},t.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){return new Promise(function(r,i){function a(){t.removeListener("fail",o);var a;if(e)try{a=e.call(f,f)}catch(c){return n||console.trace("Uncaugh exception",c),i(c)}r(a)}function o(){t.removeListener("connection",a);var e=new Error("Connection error");if(n)try{e=n.call(f,e)}catch(r){return i(r)}else console.trace("Uncaugh exception",e);i(e)}t.connected?a():t.reconnect?(t.once("connection",a),t.once("fail",o)):o()})},this["catch"]=this.then.bind(this,null),n&&this.then(n.bind(void 0,null),n)}function a(e,n,r){f.then(function(){g.encode(e,n,function(e,n){e&&(e=extend(new Error(e.message||e),e)),r(e,n)})},function(){i.call(f,function(t){return t?r(t):void a(e,n,r)})})}function o(e,n,r){function t(e,t){var i=n.object;if(e)return i.emit("_id",e),r(e);var a=t.value;r(null,l(i,a))}return e?transactionOperation.call(e,"create",n,r):P.length?transactionOperation.call(P,"create",n,r):(r=r||noop,void deferred(null,n.constructorParams,null,function(e){return e?r(e):(n.constructorParams=serializeParams(n.constructorParams),void a("create",n,t))}))}function c(e,n,r,t){if(e)return transactionOperation.call(e,n,r,t);if(P.length)return transactionOperation.call(P,n,r,t);var i=new Promise(function(e,t){function i(n,i){var a=r.operation,o=i?i.value:void 0;id2object.call(f,n,i,a,o,function(n,r){return n?t(n):void e(r)})}v=deferred(r.object,r.operationParams,v,function(e){return e?t(e):(r.object=r.object.id,r.operationParams=serializeParams(r.operationParams),void a(n,r,i))})});p=promiseCallback(i,t)}function s(e,n){function r(e,n){if(n instanceof MediaObject&&void 0===n.id){var r=i.findIndex(function(r){return e!=r&&r.params.object===n});if(r>=0)return"newref:"+r;o.push(n)}return n}function t(e,r){return e?n(e):(i.forEach(function(e,n){var t=e.callback||noop,i=r.value[n];if(void 0==i)return t(new Error("Command not executed in the server"));var a,o=i.error,c=i.result;switch(c&&(a=c.value),e.method){case"create":var s=e.params.object;if(o)return s.emit("_id",o),t(o);t(null,l(s,a));break;default:id2object.call(f,o,c,e,a,t)}}),void n(null,r))}if(P.length)return transactionOperation.call(P,"transaction",e,n);var i=e.operations,o=[];i.forEach(function(e){var n=e.params;switch(e.method){case"create":var t=n.constructorParams;for(var i in t)t[i]=r(e,t[i]);break;default:n.object=r(e,n.object);var a=n.operationParams;for(var i in a)a[i]=r(e,a[i])}}),Promise.all(o).then(function(){i.forEach(serializeOperation),a("transaction",e,t)},n)}function u(e,n){if(P.length)return transactionOperation.call(P,"transaction",e,n);var r=e.operations;async.each(r,function(e){switch(e.method){case"create":o(void 0,e.params,e.callback);break;case"transaction":u(e.params.operations,e.callback);break;default:c(void 0,e.method,e.params,e.callback)}},n)}function l(e,n){var r=h[n];return r?r:(e.emit("_id",null,n),h[n]=e,e.once("release",function(){delete h[n]}),e)}function d(e,n){function r(r,t){if(r)return n(r);var i=j.createInmediate(t);return n(null,l(i,e))}var t=h[e];if(t)return n(null,t);var i={object:e};a("describe",i,r)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,r);var f=this;EventEmitter.call(this);var v=Promise.resolve(),p=Promise.resolve();n instanceof Function&&(r=n,n=void 0),n=n||{};var m=n.failAfter;void 0==m&&(m=5),n.enableTransactions=n.enableTransactions||!0;var h={};if("string"==typeof e){var b=n.access_token;void 0!=b&&(e=url.parse(e,!0),e.query.access_token=b,e=url.format(e),delete n.access_token)}var g=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):t(e):void console.error("Invalid request instance",e)});i.call(f,r);var k=n.enableTransactions?s:u,P=new TransactionsManager(this,function(e,n){var r={object:f,operations:e};k(r,n)});this.beginTransaction=P.beginTransaction.bind(P),this.endTransaction=P.endTransaction.bind(P),this.transaction=P.transaction.bind(P);var j=new MediaObjectCreator(void 0,o,c,k);this.getMediaobjectById=function(e,n){return createPromise(e,d,n)},this.create=j.create.bind(j)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),register=require("./register"),TransactionsManager=require("./TransactionsManager"),transactionOperation=TransactionsManager.transactionOperation;module.exports=KurentoClient,KurentoClient.KurentoClient=KurentoClient,KurentoClient.checkType=checkType,KurentoClient.MediaObjectCreator=MediaObjectCreator,KurentoClient.register=register,KurentoClient.TransactionsManager=TransactionsManager;var MediaObject=require("kurento-client-core").abstracts.MediaObject;Array.prototype.findIndex||(Array.prototype.findIndex=function(e){if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof e)throw new TypeError("predicate must be a function");for(var n,r=Object(this),t=r.length>>>0,i=arguments[1],a=0;t>a;a++)if(n=r[a],e.call(i,n,a,r))return a;return-1}),inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0,e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var r=new Promise(function(n,r){function t(e,t){return e?r(e):void n(t)}var i=e[0];async.each(e.slice(1),function(e,n){i.connect(e,n),i=e},t)});return promiseCallback(r,n)},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)},register(require("kurento-client-core")),register(require("kurento-client-elements")),register(require("kurento-client-filters"));
