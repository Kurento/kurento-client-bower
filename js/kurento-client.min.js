...
function registerAbstracts(e){for(var s in e){var r=e[s],t=r.check;t&&(checkType[s]=t),abstracts[s]=r}}function registerClass(e,s){var r=s.check;r&&(checkType[e]=r),classes[e]=s}function registerComplexTypes(e){for(var s in e)checkType[s]=e[s]}function register(e,s){if("string"!=typeof e)s=e,e=void 0;else if(void 0==s)return register(e,_dereq_(e));if(s instanceof Function){if(e||(e=s.name),void 0==e)throw new Error("Can't register an anonymous module");registerClass(e,s)}else for(key in s)switch(key){case"abstracts":registerAbstracts(s[key]);break;case"complexTypes":registerComplexTypes(s[key]);break;default:registerClass(key,s[key])}}var checkType=_dereq_("checktype"),abstracts={},classes={};module.exports=register,register.abstracts=abstracts,register.classes=classes;
//# sourceMappingURL=kurento-client.map
...
function FaceOverlayFilter(e){FaceOverlayFilter.super_.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),ChecktypeError=checkType.ChecktypeError,Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(FaceOverlayFilter,Filter),FaceOverlayFilter.prototype.setOverlayedImage=function(e,r,t,i,c,a){checkType("String","uri",e,{required:!0}),checkType("float","offsetXPercent",r,{required:!0}),checkType("float","offsetYPercent",t,{required:!0}),checkType("float","widthPercent",i,{required:!0}),checkType("float","heightPercent",c,{required:!0});var l={uri:e,offsetXPercent:r,offsetYPercent:t,widthPercent:i,heightPercent:c};return this.invoke("setOverlayedImage",l,a)},FaceOverlayFilter.prototype.unsetOverlayedImage=function(e){return this.invoke("unsetOverlayedImage",e)},FaceOverlayFilter.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},FaceOverlayFilter.events=Filter.events,module.exports=FaceOverlayFilter,FaceOverlayFilter.check=function(e,r){if(!(r instanceof FaceOverlayFilter))throw ChecktypeError(e,FaceOverlayFilter,r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":4,"inherits":43,"kurento-client-core":61}],80:[function(_dereq_,module,exports){
function GStreamerFilter(e){GStreamerFilter.super_.call(this,e)}var inherits=_dereq_("inherits"),ChecktypeError=_dereq_("checktype").ChecktypeError,Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(GStreamerFilter,Filter),GStreamerFilter.constructorParams={command:{type:"String",required:!0},filterType:{type:"FilterType"},mediaPipeline:{type:"MediaPipeline",required:!0}},GStreamerFilter.events=Filter.events,module.exports=GStreamerFilter,GStreamerFilter.check=function(e,r){if(!(r instanceof GStreamerFilter))throw ChecktypeError(e,GStreamerFilter,r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":4,"inherits":43,"kurento-client-core":61}],81:[function(_dereq_,module,exports){
function ZBarFilter(e){ZBarFilter.super_.call(this,e)}var inherits=_dereq_("inherits"),ChecktypeError=_dereq_("checktype").ChecktypeError,Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(ZBarFilter,Filter),ZBarFilter.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},ZBarFilter.events=Filter.events.concat(["CodeFound"]),module.exports=ZBarFilter,ZBarFilter.check=function(e,r){if(!(r instanceof ZBarFilter))throw ChecktypeError(e,ZBarFilter,r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":4,"inherits":43,"kurento-client-core":61}],82:[function(_dereq_,module,exports){
function OpenCVFilter(e){OpenCVFilter.super_.call(this,e)}var inherits=_dereq_("inherits"),ChecktypeError=_dereq_("checktype").ChecktypeError,Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(OpenCVFilter,Filter),OpenCVFilter.constructorParams={},OpenCVFilter.events=Filter.events,module.exports=OpenCVFilter,OpenCVFilter.check=function(e,r){if(!(r instanceof OpenCVFilter))throw ChecktypeError(e,OpenCVFilter,r)};
//# sourceMappingURL=kurento-client.map
