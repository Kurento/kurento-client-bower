...
function findIndex(e,n){for(var r,t=0;r=e[t];t++)if(n(r))return t;return-1}function serializeParams(e){for(var n in e){var r=e[n];if(r instanceof MediaObject){var t=r.id;void 0!==t&&(e[n]=t)}}return e}function serializeOperation(e,n){var r=e.params;switch(e.method){case"create":r.constructorParams=serializeParams(r.constructorParams);break;default:r=serializeParams(r),r.operationParams=serializeParams(r.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,r,t){var a=[];void 0!=e&&a.push(e);for(var i in n){var o=n[i];void 0!==o&&a.push(o)}return void 0!=r&&a.push(r),promiseCallback(Promise.all(a),t)}function noop(e){e&&console.trace(e)}function KurentoClient(e,n,r){function t(e){var n=e.method,r=e.params.value,t=r.object,a=h[t];if(!a)return console.warn("Unknown object id '"+t+"'",e);switch(n){case"onEvent":a.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+n+"'")}}function a(e,n,r){f.then(function(){var t=Date.now();E.encode(e,n,function(e,n){if(e){var a=Error;switch(e.code){case MEDIA_OBJECT_TYPE_NOT_FOUND:a=TypeError;break;case MEDIA_OBJECT_NOT_FOUND:a=ReferenceError;break;case MEDIA_OBJECT_METHOD_NOT_FOUND:a=SyntaxError}e=extend(new a(e.message||e),e),e.requestTime=t}r(e,n)})},r)}function i(e,n,r){function t(e,t){var a=n.object;if(e)return a.emit("_id",e),r(e);var i=t.value;r(null,u(a,i))}return e?transactionOperation.call(e,"create",n,r):O.length?transactionOperation.call(O,"create",n,r):(r=r||noop,void deferred(null,n.constructorParams,null,function(e){return e?r(e):(n.constructorParams=serializeParams(n.constructorParams),void a("create",n,t))}))}function o(e,n,r,t){if(e)return transactionOperation.call(e,n,r,t);var i=r.object;if(i&&i.transactions&&i.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}for(var c in r.operationParams){var i=r.operationParams[c];if(i&&i.transactions&&i.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}}if(O.length)return transactionOperation.call(O,n,r,t);var s=new Promise(function(e,t){function i(n,r){return n?t(n):void e(r)}m=deferred(r.object,r.operationParams,m,function(e){return e?t(e):(r=serializeParams(r),r.operationParams=serializeParams(r.operationParams),void a(n,r,i))})});v=promiseCallback(s,t),"release"==n&&(m=v)}function c(e,n){function r(e,n){if(n instanceof MediaObject&&void 0===n.id){var r=findIndex(o,function(r){return e!=r&&r.params.object===n});if(r>=0)return"newref:"+r;d.push(n)}return n}function t(e,r){return e?n(e):(o.forEach(function(e,n){var t=e.callback||noop,a=r.value[n];if(void 0==a)return t(new Error("Command not executed in the server"));var i,o=a.error,c=a.result;switch(c&&(i=c.value),e.method){case"create":var s=e.params.object;if(o)return s.emit("_id",o),t(o);t(null,u(s,i));break;default:if(o)return t(o);t(null,c)}}),void n(null,r))}if(O.length)return transactionOperation.call(O,"transaction",e,n);for(var i,o=e.operations,c=0;i=o[c];c++){var s=i.params.object;if(s instanceof MediaObject&&null===s.id){var l=new ReferenceError("MediaObject not found in server");return l.code=40101,l.object=s,o.forEach(function(e){"create"==e.method&&e.params.object.emit("_id",l);var n=e.callback;n instanceof Function&&n(l)}),n(l)}}var d=[];o.forEach(function(e){var n=e.params;switch(e.method){case"create":var t=n.constructorParams;for(var a in t)t[a]=r(e,t[a]);break;default:n.object=r(e,n.object);var i=n.operationParams;for(var a in i)i[a]=r(e,i[a])}}),Promise.all(d).then(function(){o.forEach(serializeOperation),a("transaction",e,t)},n)}function s(e,n){if(O.length)return transactionOperation.call(O,"transaction",e,n);var r=e.operations;async.each(r,function(e){switch(e.method){case"create":i(void 0,e.params,e.callback);break;case"transaction":s(e.params.operations,e.callback);break;default:o(void 0,e.method,e.params,e.callback)}},n)}function u(e,n){var r=h[n];return r?r:(e.emit("_id",null,n),h[n]=e,e.once("release",function(){delete h[n]}),e)}function l(e,n){function r(r,t){if(r)return n(r);var a=g.createInmediate(t);return n(null,u(a,e))}if(void 0==e)return n(new TypeError("'id' can't be null or undefined"));var t=h[e];if(t)return n(null,t);var i={object:e};a("describe",i,r)}function d(n){var r=!1,t=reconnect({failAfter:p},function(e){r&&(e.writable=!1),E.transport=e}).connect(e);this.close=function(){r=!0,v.then(t.disconnect.bind(t))},t.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){return new Promise(function(r,a){function i(){t.removeListener("fail",o);var i;if(e)try{i=e.call(f,f)}catch(c){return n||console.trace("Uncaugh exception",c),a(c)}r(i)}function o(){t.removeListener("connection",i);var e=new Error("Connection error");if(n)try{e=n.call(f,e)}catch(r){return a(r)}else console.trace("Uncaugh exception",e);a(e)}t.connected?i():t.reconnect?(t.once("connection",i),t.once("fail",o)):o()})},this["catch"]=this.then.bind(this,null);var a=this.getServerManager().then(function(e){return e.getInfo()}).then(function(e){var n=e.modules.map(function(e){return e.name}),r=KurentoClient.register.modules.filter(function(e){return n.indexOf(e)<0}),t=r.length;if(t){if(1===t)var a="Module '"+r[0]+"' is not installed in the Kurento Media Server";else var a="Modules '"+r.slice(0,-1).join("', '")+"' and '"+r[t-1]+"' are not installed in the Kurento Media Server";var i=new SyntaxError(a);return i.modules=r,Promise.reject(i)}return Promise.resolve(f)});n&&a.then(n.bind(void 0,null),n)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,r);var f=this;EventEmitter.call(this);var m=Promise.resolve(),v=Promise.resolve();n instanceof Function&&(r=n,n=void 0),n=n||{};var p=n.failAfter;void 0==p&&(p=5),n.enableTransactions=n.enableTransactions||!0,n.request_timeout=n.request_timeout||BASE_TIMEOUT,n.response_timeout=n.response_timeout||BASE_TIMEOUT,n.duplicates_timeout=n.duplicates_timeout||BASE_TIMEOUT;var h={};if("string"==typeof e){var b=n.access_token;void 0!=b&&(e=url.parse(e,!0),e.query.access_token=b,e=url.format(e),delete n.access_token)}var E=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):t(e):void console.error("Invalid request instance",e)}),T=n.enableTransactions?c:s,O=new TransactionsManager(this,function(e,n){var r={object:f,operations:e};T(r,n)});this.beginTransaction=O.beginTransaction.bind(O),this.endTransaction=O.endTransaction.bind(O),this.transaction=O.transaction.bind(O),this.getMediaobjectById=function(e,n){return createPromise(e,l,n)};var g=new MediaObjectCreator(this,i,o,T,this.getMediaobjectById.bind(this));this.create=g.create.bind(g),d.call(f,r)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),TransactionsManager=require("./TransactionsManager"),TransactionNotCommitedException=TransactionsManager.TransactionNotCommitedException,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("kurento-client-core").abstracts.MediaObject;const MEDIA_OBJECT_TYPE_NOT_FOUND=40100,MEDIA_OBJECT_NOT_FOUND=40101,MEDIA_OBJECT_METHOD_NOT_FOUND=40105,BASE_TIMEOUT=2e4;inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e instanceof Array||(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0),e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var r=new Promise(function(n,r){function t(e,t){return e?r(e):void n(t)}var a=e[0];e[e.length-1];async.each(e.slice(1),function(e,n){a=a.connect(e,n)},t)});return r=promiseCallback(r,n),r.connect=sink.connect.bind(sink),r},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)};var singletons={};KurentoClient.getSingleton=function(e,n){var r=singletons[e];return r||(r=KurentoClient(e,function(r,t){return r?n(r):(singletons[e]=t,void t.on("disconnect",function(){delete singletons[e]}))})),promiseCallback(r,n)},module.exports=KurentoClient;
