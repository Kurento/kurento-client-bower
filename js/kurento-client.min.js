...
function findIndex(e,n){for(var t,r=0;t=e[r];r++)if(n(t))return r;return-1}function serializeParams(e){for(var n in e){var t=e[n];if(t instanceof MediaObject){var r=t.id;void 0!==r&&(e[n]=r)}}return e}function serializeOperation(e,n){var t=e.params;switch(e.method){case"create":t.constructorParams=serializeParams(t.constructorParams);break;default:t=serializeParams(t),t.operationParams=serializeParams(t.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,t,r){var i=[];void 0!=e&&i.push(e);for(var a in n){var o=n[a];void 0!==o&&i.push(o)}return void 0!=t&&i.push(t),promiseCallback(Promise.all(i),r)}function noop(e){e&&console.trace(e)}function KurentoClient(e,n,t){function r(e){var n=e.method,t=e.params.value,r=t.object,i=O[r];if(!i)return console.warn("Unknown object id '"+r+"'",e);switch(n){case"onEvent":i.emit(t.type,t.data);break;default:console.warn("Unknown message type '"+n+"'")}}function i(e){var n=e.method,t=e.params,r=e.callback,i=e.stack,a=Date.now();P.encode(n,t,function(e,n){if(e){var t=Date.now(),o=Error;switch(e.code){case MEDIA_OBJECT_TYPE_NOT_FOUND:o=TypeError;break;case MEDIA_OBJECT_NOT_FOUND:o=ReferenceError;break;case MEDIA_OBJECT_METHOD_NOT_FOUND:o=SyntaxError}e=extend(new o(e.message||e),e),Object.defineProperties(e,{requestTimestamp:{value:a},responseTimestamp:{value:t},stack:{value:[e.toString()].concat(e.stack.split("\n")[1],i.split("\n").slice(2)).join("\n")}})}else h.sessionId!==n.sessionId&&Object.defineProperty(h,"sessionId",{configurable:!0,value:n.sessionId});r(e,n)})}function a(e,n){var t=e.callback||noop,r=this.value[n];if(void 0==r)return t(new Error("Command not executed in the server"));var i,a=r.error,o=r.result;switch(o&&(i=o.value),e.method){case"create":var c=e.params.object;if(a)return c.emit("_id",a),t(a);t(null,m(c,i));break;default:t(a,o)}}function o(e){function n(n,t){return n?console.error("Implicit transaction failed"):void e.forEach(a,t)}e.forEach(serializeOperation);var t={method:"transaction",params:{operations:e},callback:n};i(t)}function c(){var e=M.shift();if(M.length){for(;e&&"transaction"===e.method;)i(e),e=M.shift();for(var n=[];e;)"transaction"===e.method?(n.length&&(o(n),n=[]),i(e)):n.push(e),e=M.shift();n.length&&o(n)}else i(e)}function s(e,t,r){var a=(new Error).stack;t.sessionId=h.sessionId,h.then(function(){n.useImplicitTransactions&&!M.length&&async.setImmediate(c);var o={method:e,params:t,callback:r};Object.defineProperty(o,"stack",{value:a}),n.useImplicitTransactions?M.push(o):i(o)},r)}function u(e,n,t){function r(e,r){var i=n.object;if(i===r)return t(null,i);if(e)return i.emit("_id",e),t(e);var a=r.value;t(null,m(i,a))}return e?transactionOperation.call(e,"create",n,t):k.length?transactionOperation.call(k,"create",n,t):(t=t||noop,void deferred(null,n.constructorParams,null,function(e){return e?t(e):(n.constructorParams=serializeParams(n.constructorParams),void s("create",n,r))}))}function l(e,n,t,r){if(e)return transactionOperation.call(e,n,t,r);var i=t.object;if(i&&i.transactions&&i.transactions.length){var a=new TransactionNotCommitedException;return a.method=n,a.params=t,setTimeout(r,0,a)}for(var o in t.operationParams){var i=t.operationParams[o];if(i&&i.transactions&&i.transactions.length){var a=new TransactionNotCommitedException;return a.method=n,a.params=t,setTimeout(r,0,a)}}if(k.length)return transactionOperation.call(k,n,t,r);var c=new Promise(function(e,r){function i(n,t){return n?r(n):void e(t)}b=deferred(t.object,t.operationParams,b,function(e){return e?r(e):(t=serializeParams(t),t.operationParams=serializeParams(t.operationParams),void s(n,t,i))})});E=promiseCallback(c,r),"release"==n&&(b=E)}function d(e,n){function t(e,n){if(n instanceof MediaObject&&void 0===n.id){var t=findIndex(o,function(t){return e!=t&&t.params.object===n});if(t>=0)return"newref:"+t;d.push(n)}return n}function r(e,t){return e?n(e):(o.forEach(a,t),void n(null,t))}if(k.length)return transactionOperation.call(k,"transaction",e,n);n=n||noop;for(var i,o=e.operations,c=0;i=o[c];c++){var u=i.params.object;if(u instanceof MediaObject&&null===u.id){var l=new ReferenceError("MediaObject not found in server");return l.code=40101,l.object=u,o.forEach(function(e){"create"==e.method&&e.params.object.emit("_id",l);var n=e.callback;n instanceof Function&&n(l)}),n(l)}}var d=[];o.forEach(function(e){var n=e.params;switch(e.method){case"create":var r=n.constructorParams;for(var i in r)r[i]=t(e,r[i]);break;default:n.object=t(e,n.object);var a=n.operationParams;for(var i in a)a[i]=t(e,a[i])}}),Promise.all(d).then(function(){o.forEach(serializeOperation),s("transaction",e,r)},n)}function f(e,n){if(k.length)return transactionOperation.call(k,"transaction",e,n);var t=e.operations;async.each(t,function(e){switch(e.method){case"create":u(void 0,e.params,e.callback);break;case"transaction":f(e.params.operations,e.callback);break;default:l(void 0,e.method,e.params,e.callback)}},n)}function m(e,n){var t=O[n];return t?t:(e.emit("_id",null,n),O[n]=e,e.once("release",function(){delete O[n]}),e)}function v(e,n){function t(t,r){if(t)return n(t);var i=j.createInmediate(r);return n(null,m(i,e))}if(void 0==e)return n(new TypeError("'id' can't be null or undefined"));var r=O[e];if(r)return n(null,r);var i={object:e};s("describe",i,t)}function p(t){var r=!1,i=reconnect({failAfter:g},function(e){r&&(e.writable=!1),P.transport=e}).connect(e);if(Object.defineProperty(this,"_re",{get:function(){return i}}),this.close=function(){r=!0,E.then(i.disconnect.bind(i))},i.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){var t=new Promise(function(t,r){function a(){i.removeListener("fail",o);var a;if(e)try{a=e.call(h,h)}catch(c){return n||console.trace("Uncaugh exception",c),r(c)}t(a)}function o(){i.removeListener("connection",a);var e=new Error("Connection error");if(n)try{e=n.call(h,e)}catch(t){return r(t)}else console.trace("Uncaugh exception",e);r(e)}i.connected?a():i.reconnect?(i.once("connection",a),i.once("fail",o)):o()});return disguise(t,this)},this["catch"]=this.then.bind(this,null),n.strict){var a=this.getServerManager().then(function(e){return e.getInfo()}).then(function(e){var n=e.modules.map(function(e){return e.name}),t=KurentoClient.register.modules.filter(function(e){return n.indexOf(e)<0}),r=t.length;if(r){if(1===r)var i="Module '"+t[0]+"' is not installed in the Kurento Media Server";else var i="Modules '"+t.slice(0,-1).join("', '")+"' and '"+t[r-1]+"' are not installed in the Kurento Media Server";var a=new SyntaxError(i);return a.modules=t,Promise.reject(a)}return Promise.resolve(h)});t&&a.then(t.bind(void 0,null),t)}else t&&this.then(t.bind(void 0,null),t)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,t);var h=this;EventEmitter.call(this);var b=Promise.resolve(),E=Promise.resolve();n instanceof Function&&(t=n,n=void 0),n=n||{};var g=n.failAfter;void 0==g&&(g=5),void 0===n.enableTransactions&&(n.enableTransactions=!0),void 0===n.strict&&(n.strict=!0),n.request_timeout=n.request_timeout||BASE_TIMEOUT,n.response_timeout=n.response_timeout||BASE_TIMEOUT,n.duplicates_timeout=n.duplicates_timeout||BASE_TIMEOUT;var O={};if("string"==typeof e){var T=n.access_token;void 0!=T&&(e=url.parse(e,!0),e.query.access_token=T,e=url.format(e),delete n.access_token)}var P=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):r(e):void console.error("Invalid request instance",e)}),_=n.enableTransactions?d:f,k=new TransactionsManager(this,function(e,n){var t={object:h,operations:e};_(t,n)});this.beginTransaction=k.beginTransaction.bind(k),this.endTransaction=k.endTransaction.bind(k),this.transaction=k.transaction.bind(k),Object.defineProperty(this,"sessionId",{configurable:!0}),this.on("disconnect",function(){Object.defineProperty(this,"sessionId",{configurable:!1,get:function(){throw new SyntaxError("Client has been disconnected")}});for(var e in O)O[e].emit("release")});var M=[];this.getMediaobjectById=function(e,n){return disguise(createPromise(e,v,n),this)};var j=new MediaObjectCreator(this,u,l,_,this.getMediaobjectById.bind(this),n.strict);Object.defineProperty(this,"_resetCache",{value:function(){O={}}}),this.create=j.create.bind(j),p.call(h,t)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),disguise=require("./disguise"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),TransactionsManager=require("./TransactionsManager"),TransactionNotCommitedException=TransactionsManager.TransactionNotCommitedException,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("kurento-client-core").abstracts.MediaObject;const MEDIA_OBJECT_TYPE_NOT_FOUND=40100,MEDIA_OBJECT_NOT_FOUND=40101,MEDIA_OBJECT_METHOD_NOT_FOUND=40105,BASE_TIMEOUT=2e4;inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e instanceof Array||(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0),e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var t=e[0],r=e[e.length-1],i=new Promise(function(n,r){function i(e,t){return e?r(e):void n(t)}async.each(e.slice(1),function(e,n){t=t.connect(e,n)},i)});return disguise(promiseCallback(i,n),r)},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)};var singletons={};KurentoClient.getSingleton=function(e,n){var t=singletons[e];return t||(t=KurentoClient(e,function(t,r){return t?n(t):(singletons[e]=r,void r.on("disconnect",function(){delete singletons[e]}))})),disguise(promiseCallback(t,n),t)},module.exports=KurentoClient;
