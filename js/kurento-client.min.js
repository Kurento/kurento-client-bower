...
function HubPort(){HubPort.super_.call(this)}var inherits=require("inherits"),ChecktypeError=require("checktype").ChecktypeError,MediaElement=require("./abstracts/MediaElement");inherits(HubPort,MediaElement),HubPort.constructorParams={hub:{type:"Hub",required:!0}},HubPort.events=MediaElement.events,module.exports=HubPort,HubPort.check=function(e,r){if(!(r instanceof HubPort))throw ChecktypeError(e,HubPort,r)};
},{"./abstracts/MediaElement":49,"checktype":4,"inherits":43}],45:[function(require,module,exports){
function getConstructor(e){var t=register.classes[e]||register.abstracts[e];return t?t:(console.warn("Unknown type '"+e+"', using MediaObject instead"),MediaObject)}function MediaPipeline(){function e(e,t,r){var i={method:e,params:t,callback:r};c[0].push(i)}function t(t,r){c.length?e("create",t,r):a.emit("_create",t,r)}function r(t,r,i){c.length?e(t,r,i):a.emit("_rpc",t,r,i)}function i(t,r){c.length?e("transaction",t,r):a.then(function(){t.object=a.id,a.emit("_transaction",t,r)})}function n(e,i){var n=getConstructor(e.type);if(n.create){e=n.create(e.params);var c=n.prototype;inherits(n,getConstructor(e.type)),extend(n.prototype,c)}e.params.mediaPipeline=a,e.constructorParams=checkParams(e.params,n.constructorParams,e.type),delete e.params;var o=new n;return o.on("_rpc",function(e,t,i){t.object=o,r(e,t,i)}),o instanceof Hub&&o.on("_create",t),Object.defineProperty(e,"object",{value:o}),t(e,i),o}MediaPipeline.super_.call(this);var a=this,c=[];this.beginTransaction=function(){c.unshift([])},this.endTransaction=function(e){var t=c.shift(),r=new Promise(function(e,r){function n(t,i){return t?r(t):void e(i)}i({operations:t},n)});return promiseCallback(r,e)},this.transaction=function(e,t){return this.beginTransaction(),e.call(this),this.endTransaction(t)},this.create=function(e,t,r){if(t instanceof Function){if(r)throw new SyntaxError("Nothing can be defined after the callback");r=t,t=void 0}return t=t||{},e instanceof Array?createPromise(e,n,r):(e={params:t,type:e},n(e,r))}}var inherits=require("inherits"),Promise=require("es6-promise").Promise,promiseCallback=require("promisecallback"),checkParams=require("checktype").checkParams,kurentoClient=require("kurento-client"),register=kurentoClient.register,ChecktypeError=require("checktype").ChecktypeError,MediaObject=require("./abstracts/MediaObject");inherits(MediaPipeline,MediaObject),MediaPipeline.constructorParams={},MediaPipeline.events=MediaObject.events,module.exports=MediaPipeline,MediaPipeline.check=function(e,t){if(!(t instanceof MediaPipeline))throw ChecktypeError(e,MediaPipeline,t)};
...
function FaceOverlayFilter(){FaceOverlayFilter.super_.call(this)}var inherits=require("inherits"),checkType=require("checktype"),ChecktypeError=checkType.ChecktypeError,Filter=require("kurento-client-core").abstracts.Filter;inherits(FaceOverlayFilter,Filter),FaceOverlayFilter.prototype.setOverlayedImage=function(e,r,t,i,c,a){checkType("String","uri",e,{required:!0}),checkType("float","offsetXPercent",r,{required:!0}),checkType("float","offsetYPercent",t,{required:!0}),checkType("float","widthPercent",i,{required:!0}),checkType("float","heightPercent",c,{required:!0});var l={uri:e,offsetXPercent:r,offsetYPercent:t,widthPercent:i,heightPercent:c};return this.invoke("setOverlayedImage",l,a)},FaceOverlayFilter.prototype.unsetOverlayedImage=function(e){return this.invoke("unsetOverlayedImage",e)},FaceOverlayFilter.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},FaceOverlayFilter.events=Filter.events,module.exports=FaceOverlayFilter,FaceOverlayFilter.check=function(e,r){if(!(r instanceof FaceOverlayFilter))throw ChecktypeError(e,FaceOverlayFilter,r)};
},{"checktype":4,"inherits":43,"kurento-client-core":70}],89:[function(require,module,exports){
function GStreamerFilter(){GStreamerFilter.super_.call(this)}var inherits=require("inherits"),ChecktypeError=require("checktype").ChecktypeError,Filter=require("kurento-client-core").abstracts.Filter;inherits(GStreamerFilter,Filter),GStreamerFilter.constructorParams={command:{type:"String",required:!0},filterType:{type:"FilterType"},mediaPipeline:{type:"MediaPipeline",required:!0}},GStreamerFilter.events=Filter.events,module.exports=GStreamerFilter,GStreamerFilter.check=function(e,r){if(!(r instanceof GStreamerFilter))throw ChecktypeError(e,GStreamerFilter,r)};
},{"checktype":4,"inherits":43,"kurento-client-core":70}],90:[function(require,module,exports){
function ZBarFilter(){ZBarFilter.super_.call(this)}var inherits=require("inherits"),ChecktypeError=require("checktype").ChecktypeError,Filter=require("kurento-client-core").abstracts.Filter;inherits(ZBarFilter,Filter),ZBarFilter.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},ZBarFilter.events=Filter.events.concat(["CodeFound"]),module.exports=ZBarFilter,ZBarFilter.check=function(e,r){if(!(r instanceof ZBarFilter))throw ChecktypeError(e,ZBarFilter,r)};
},{"checktype":4,"inherits":43,"kurento-client-core":70}],91:[function(require,module,exports){
function OpenCVFilter(){OpenCVFilter.super_.call(this)}var inherits=require("inherits"),ChecktypeError=require("checktype").ChecktypeError,Filter=require("kurento-client-core").abstracts.Filter;inherits(OpenCVFilter,Filter),OpenCVFilter.constructorParams={},OpenCVFilter.events=Filter.events,module.exports=OpenCVFilter,OpenCVFilter.check=function(e,r){if(!(r instanceof OpenCVFilter))throw ChecktypeError(e,OpenCVFilter,r)};
