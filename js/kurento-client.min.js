...
function findIndex(e,n){for(var r,t=0;r=e[t];t++)if(n(r))return t;return-1}function serializeParams(e){for(var n in e){var r=e[n];if(r instanceof MediaObject){var t=r.id;void 0!==t&&(e[n]=t)}}return e}function serializeOperation(e,n){var r=e.params;switch(e.method){case"create":r.constructorParams=serializeParams(r.constructorParams);break;default:r=serializeParams(r),r.operationParams=serializeParams(r.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,r,t){var i=[];void 0!=e&&i.push(e);for(var a in n){var o=n[a];void 0!==o&&i.push(o)}return void 0!=r&&i.push(r),promiseCallback(Promise.all(i),t)}function noop(e){e&&console.trace(e)}function KurentoClient(e,n,r){function t(e){var n=e.method,r=e.params.value,t=r.object,i=h[t];if(!i)return console.warn("Unknown object id '"+t+"'",e);switch(n){case"onEvent":i.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+n+"'")}}function i(e,n,r){var t=(new Error).stack;n.sessionId=f.sessionId,f.then(function(){var i=Date.now();E.encode(e,n,function(e,n){if(e){var a=Date.now(),o=Error;switch(e.code){case MEDIA_OBJECT_TYPE_NOT_FOUND:o=TypeError;break;case MEDIA_OBJECT_NOT_FOUND:o=ReferenceError;break;case MEDIA_OBJECT_METHOD_NOT_FOUND:o=SyntaxError}e=extend(new o(e.message||e),e),Object.defineProperties(e,{requestTimestamp:{value:i},responseTimestamp:{value:a},stack:{value:[e.toString()].concat(e.stack.split("\n")[1],t.split("\n").slice(2)).join("\n")}})}else f.sessionId!==n.sessionId&&Object.defineProperty(f,"sessionId",{configurable:!0,value:n.sessionId});r(e,n)})},r)}function a(e,n,r){function t(e,t){var i=n.object;if(e)return i.emit("_id",e),r(e);var a=t.value;r(null,u(i,a))}return e?transactionOperation.call(e,"create",n,r):O.length?transactionOperation.call(O,"create",n,r):(r=r||noop,void deferred(null,n.constructorParams,null,function(e){return e?r(e):(n.constructorParams=serializeParams(n.constructorParams),void i("create",n,t))}))}function o(e,n,r,t){if(e)return transactionOperation.call(e,n,r,t);var a=r.object;if(a&&a.transactions&&a.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}for(var c in r.operationParams){var a=r.operationParams[c];if(a&&a.transactions&&a.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}}if(O.length)return transactionOperation.call(O,n,r,t);var s=new Promise(function(e,t){function a(n,r){return n?t(n):void e(r)}m=deferred(r.object,r.operationParams,m,function(e){return e?t(e):(r=serializeParams(r),r.operationParams=serializeParams(r.operationParams),void i(n,r,a))})});v=promiseCallback(s,t),"release"==n&&(m=v)}function c(e,n){function r(e,n){if(n instanceof MediaObject&&void 0===n.id){var r=findIndex(o,function(r){return e!=r&&r.params.object===n});if(r>=0)return"newref:"+r;d.push(n)}return n}function t(e,r){return e?n(e):(o.forEach(function(e,n){var t=e.callback||noop,i=r.value[n];if(void 0==i)return t(new Error("Command not executed in the server"));var a,o=i.error,c=i.result;switch(c&&(a=c.value),e.method){case"create":var s=e.params.object;if(o)return s.emit("_id",o),t(o);t(null,u(s,a));break;default:if(o)return t(o);t(null,c)}}),void n(null,r))}if(O.length)return transactionOperation.call(O,"transaction",e,n);for(var a,o=e.operations,c=0;a=o[c];c++){var s=a.params.object;if(s instanceof MediaObject&&null===s.id){var l=new ReferenceError("MediaObject not found in server");return l.code=40101,l.object=s,o.forEach(function(e){"create"==e.method&&e.params.object.emit("_id",l);var n=e.callback;n instanceof Function&&n(l)}),n(l)}}var d=[];o.forEach(function(e){var n=e.params;switch(e.method){case"create":var t=n.constructorParams;for(var i in t)t[i]=r(e,t[i]);break;default:n.object=r(e,n.object);var a=n.operationParams;for(var i in a)a[i]=r(e,a[i])}}),Promise.all(d).then(function(){o.forEach(serializeOperation),i("transaction",e,t)},n)}function s(e,n){if(O.length)return transactionOperation.call(O,"transaction",e,n);var r=e.operations;async.each(r,function(e){switch(e.method){case"create":a(void 0,e.params,e.callback);break;case"transaction":s(e.params.operations,e.callback);break;default:o(void 0,e.method,e.params,e.callback)}},n)}function u(e,n){var r=h[n];return r?r:(e.emit("_id",null,n),h[n]=e,e.once("release",function(){delete h[n]}),e)}function l(e,n){function r(r,t){if(r)return n(r);var i=T.createInmediate(t);return n(null,u(i,e))}if(void 0==e)return n(new TypeError("'id' can't be null or undefined"));var t=h[e];if(t)return n(null,t);var a={object:e};i("describe",a,r)}function d(r){var t=!1,i=reconnect({failAfter:p},function(e){t&&(e.writable=!1),E.transport=e}).connect(e);if(Object.defineProperty(this,"_re",{get:function(){return i}}),this.close=function(){t=!0,v.then(i.disconnect.bind(i))},i.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){var r=new Promise(function(r,t){function a(){i.removeListener("fail",o);var a;if(e)try{a=e.call(f,f)}catch(c){return n||console.trace("Uncaugh exception",c),t(c)}r(a)}function o(){i.removeListener("connection",a);var e=new Error("Connection error");if(n)try{e=n.call(f,e)}catch(r){return t(r)}else console.trace("Uncaugh exception",e);t(e)}i.connected?a():i.reconnect?(i.once("connection",a),i.once("fail",o)):o()});return disguise(r,this)},this["catch"]=this.then.bind(this,null),n.strict){var a=this.getServerManager().then(function(e){return e.getInfo()}).then(function(e){var n=e.modules.map(function(e){return e.name}),r=KurentoClient.register.modules.filter(function(e){return n.indexOf(e)<0}),t=r.length;if(t){if(1===t)var i="Module '"+r[0]+"' is not installed in the Kurento Media Server";else var i="Modules '"+r.slice(0,-1).join("', '")+"' and '"+r[t-1]+"' are not installed in the Kurento Media Server";var a=new SyntaxError(i);return a.modules=r,Promise.reject(a)}return Promise.resolve(f)});r&&a.then(r.bind(void 0,null),r)}else r&&this.then(r.bind(void 0,null),r)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,r);var f=this;EventEmitter.call(this);var m=Promise.resolve(),v=Promise.resolve();n instanceof Function&&(r=n,n=void 0),n=n||{};var p=n.failAfter;void 0==p&&(p=5),void 0===n.enableTransactions&&(n.enableTransactions=!0),void 0===n.strict&&(n.strict=!0),n.request_timeout=n.request_timeout||BASE_TIMEOUT,n.response_timeout=n.response_timeout||BASE_TIMEOUT,n.duplicates_timeout=n.duplicates_timeout||BASE_TIMEOUT;var h={};if("string"==typeof e){var b=n.access_token;void 0!=b&&(e=url.parse(e,!0),e.query.access_token=b,e=url.format(e),delete n.access_token)}var E=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):t(e):void console.error("Invalid request instance",e)}),g=n.enableTransactions?c:s,O=new TransactionsManager(this,function(e,n){var r={object:f,operations:e};g(r,n)});this.beginTransaction=O.beginTransaction.bind(O),this.endTransaction=O.endTransaction.bind(O),this.transaction=O.transaction.bind(O),Object.defineProperty(this,"sessionId",{configurable:!0}),this.on("disconnect",function(){Object.defineProperty(this,"sessionId",{configurable:!1,get:function(){throw new SyntaxError("Client has been disconnected")}});for(var e in h)h[e].emit("release")}),this.getMediaobjectById=function(e,n){return disguise(createPromise(e,l,n),this)};var T=new MediaObjectCreator(this,a,o,g,this.getMediaobjectById.bind(this),n.strict);Object.defineProperty(this,"_resetCache",{value:function(){h={}}}),this.create=T.create.bind(T),d.call(f,r)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),disguise=require("./disguise"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),TransactionsManager=require("./TransactionsManager"),TransactionNotCommitedException=TransactionsManager.TransactionNotCommitedException,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("kurento-client-core").abstracts.MediaObject;const MEDIA_OBJECT_TYPE_NOT_FOUND=40100,MEDIA_OBJECT_NOT_FOUND=40101,MEDIA_OBJECT_METHOD_NOT_FOUND=40105,BASE_TIMEOUT=2e4;inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e instanceof Array||(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0),e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var r=e[0],t=e[e.length-1],i=new Promise(function(n,t){function i(e,r){return e?t(e):void n(r)}async.each(e.slice(1),function(e,n){r=r.connect(e,n)},i)});return disguise(promiseCallback(i,n),t)},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)};var singletons={};KurentoClient.getSingleton=function(e,n){var r=singletons[e];return r||(r=KurentoClient(e,function(r,t){return r?n(r):(singletons[e]=t,void t.on("disconnect",function(){delete singletons[e]}))})),disguise(promiseCallback(r,n),r)},module.exports=KurentoClient;
...
function getConstructor(e,r){var t=register.classes[e]||register.abstracts[e];if(t)return t;if(r){var a=new SyntaxError("Unknown type '"+e+"'");throw a.type=e,a}return console.warn("Unknown type '"+e+"', using MediaObject instead"),register.abstracts.MediaObject}function createConstructor(e,r){var t=getConstructor(e.type,r);if(t.create){e=t.create(e.params);var a=t.prototype;inherits(t,getConstructor(e.type,r)),extend(t.prototype,a)}return t.item=e,t}function MediaObjectCreator(e,r,t,a,n,c){function i(e){var i=new e(c);return i.on("_describe",n),i.on("_rpc",t),(i instanceof register.abstracts.Hub||i instanceof register.classes.MediaPipeline)&&i.on("_create",r),i instanceof register.classes.MediaPipeline&&i.on("_transaction",a),i}function s(t,a){var n=t.transaction;delete t.transaction;var s=createConstructor(t,c);t=s.item,delete s.item;var o=t.params||{};delete t.params,e instanceof register.classes.MediaPipeline&&(o.mediaPipeline=e),t.constructorParams=checkParams(o,s.constructorParams,t.type),Object.keys(t.constructorParams).length||delete t.constructorParams;try{var u=i(s)}catch(d){return a(d)}return Object.defineProperty(t,"object",{value:u}),r(n,t,a),u}return this instanceof MediaObjectCreator?(this.create=function(r,t,a){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(arguments.length){case 1:t=void 0;case 2:a=void 0}if(t instanceof Function){if(a)throw new SyntaxError("Nothing can be defined after the callback");a=t,t=void 0}return r instanceof Array?t===!0&&e.connect?createPromise(r,s,function(r,t){return r?a(r):void e.connect(t,a)}):createPromise(r,s,a):(r={params:t,transaction:n,type:r},s(r,a))},void(this.createInmediate=function(e){var r=createConstructor(e,c);return delete r.item,i(r)})):new MediaObjectCreator(e,r,t,a,n)}var checkParams=require("checktype").checkParams,createPromise=require("./createPromise"),register=require("./register"),Transaction=require("./TransactionsManager").Transaction;module.exports=MediaObjectCreator;
...
function noop(e){e&&console.trace(e)}function MediaPipeline(e){function n(e,n,t){return e?transactionOperation.call(e,"create",n,t):r.length?transactionOperation.call(r,"create",n,t):void a.emit("_create",void 0,n,t)}function t(e,n,t,i){return e?transactionOperation.call(e,n,t,i):r.length?transactionOperation.call(r,n,t,i):void a.emit("_rpc",void 0,n,t,i)}function i(e,n){var t={operations:e};return r.length?transactionOperation.call(r,"transaction",t,n):void a.emit("_transaction",t,n)}MediaPipeline.super_.call(this);var a=this,r=new TransactionsManager(this,i);this.beginTransaction=r.beginTransaction.bind(r),this.endTransaction=r.endTransaction.bind(r),this.transaction=r.transaction.bind(r);var o=this.emit.bind(this,"_describe"),c=new MediaObjectCreator(this,n,t,i,o,e);this.create=c.create.bind(c)}function checkMediaPipeline(e,n){if(!(n instanceof MediaPipeline))throw ChecktypeError(e,MediaPipeline,n)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,MediaObjectCreator=kurentoClient.MediaObjectCreator,TransactionsManager=kurentoClient.TransactionsManager,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("./abstracts/MediaObject");inherits(MediaPipeline,MediaObject),MediaPipeline.prototype.getGstreamerDot=function(e,n){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;break;default:var i=new RangeError("Number of params ("+arguments.length+") not in range [0-1]");throw i.length=arguments.length,i.min=0,i.max=1,i}checkType("GstreamerDotDetails","details",e);var a={details:e};return n=(n||noop).bind(this),this._invoke(t,"getGstreamerDot",a,n)};var checkMediaElement=checkType.bind(null,"MediaElement","media");MediaPipeline.prototype.connect=function(e,n){if(e instanceof Array||(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0),n=(n||noop).bind(this),e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var t=e[0],i=e[e.length-1],a=new Promise(function(n,i){function a(e,t){return e?i(e):void n(t)}async.each(e.slice(1),function(e,n){t=t.connect(e,n)},a)});return disguise(promiseCallback(a,n),i)},MediaPipeline.constructorParams={},MediaPipeline.events=MediaObject.events,module.exports=MediaPipeline,MediaPipeline.check=checkMediaPipeline;
...
function noop(e){e&&console.trace(e)}function MediaElement(){MediaElement.super_.call(this)}function checkMediaElement(e,t){if(!(t instanceof MediaElement))throw ChecktypeError(e,MediaElement,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,MediaObject=require("./MediaObject");inherits(MediaElement,MediaObject),MediaElement.prototype.connect=function(e,t,n,r,a){var i=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(a=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:r=void 0;break;default:var o=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw o.length=arguments.length,o.min=1,o.max=4,o}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",r);var s={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:r};if(a=(a||noop).bind(this),e instanceof Array){var c=e;if(!c.length)throw new SyntaxError("Need at least one media element to connect");c.forEach(checkMediaElement);var p=this,e=c[c.length-1],u=new Promise(function(e,t){function n(n,r){return n?t(n):void e(r)}async.each(c,function(e,t){p=p.connect(e,t)},n)});return disguise(promiseCallback(u,a),e)}return this._invoke(i,"connect",s,a)},MediaElement.prototype.disconnect=function(e,t,n,r,a){var i=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(a=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:r=void 0;break;default:var o=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw o.length=arguments.length,o.min=1,o.max=4,o}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",r);var s={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:r};return a=(a||noop).bind(this),this._invoke(i,"disconnect",s,a)},MediaElement.prototype.getGstreamerDot=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(t=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;break;default:var r=new RangeError("Number of params ("+arguments.length+") not in range [0-1]");throw r.length=arguments.length,r.min=0,r.max=1,r}checkType("GstreamerDotDetails","details",e);var a={details:e};return t=(t||noop).bind(this),this._invoke(n,"getGstreamerDot",a,t)},MediaElement.prototype.getSinkConnections=function(e,t,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;default:var a=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw a.length=arguments.length,a.min=0,a.max=2,a}checkType("MediaType","mediaType",e),checkType("String","description",t);var i={mediaType:e,description:t};return n=(n||noop).bind(this),this._invoke(r,"getSinkConnections",i,n)},MediaElement.prototype.getSourceConnections=function(e,t,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;default:var a=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw a.length=arguments.length,a.min=0,a.max=2,a}checkType("MediaType","mediaType",e),checkType("String","description",t);var i={mediaType:e,description:t};return n=(n||noop).bind(this),this._invoke(r,"getSourceConnections",i,n)},MediaElement.prototype.setAudioFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("AudioCaps","caps",e,{required:!0});var r={caps:e};return t=(t||noop).bind(this),this._invoke(n,"setAudioFormat",r,t)},MediaElement.prototype.setOutputBitrate=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("int","bitrate",e,{required:!0});var r={bitrate:e};return t=(t||noop).bind(this),this._invoke(n,"setOutputBitrate",r,t)},MediaElement.prototype.setVideoFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("VideoCaps","caps",e,{required:!0});var r={caps:e};return t=(t||noop).bind(this),this._invoke(n,"setVideoFormat",r,t)},MediaElement.constructorParams={},MediaElement.events=MediaObject.events.concat(["ElementConnected","ElementDisconnected"]),module.exports=MediaElement,MediaElement.check=checkMediaElement;
},{"./MediaObject":49,"inherits":"inherits","kurento-client":"kurento-client"}],49:[function(require,module,exports){
function noop(e){e&&console.trace(e)}function MediaObject(){MediaObject.super_.call(this);var e=this;this.once("_id",function(e,t){return e?Object.defineProperties(this,{_createError:{value:e},id:{value:null,enumerable:!0}}):void Object.defineProperty(this,"id",{configurable:!0,enumerable:!0,value:t})});var t={};this.on("removeListener",function(n,r){if("_"!=n[0]&&"release"!=n&&"newListener"!=n){var i=EventEmitter.listenerCount(this,n);if(!i){var o=t[n],a={object:this,subscription:o};this.emit("_rpc",void 0,"unsubscribe",a,function(r){return r?e.emit("error",r):void delete t[n]})}}}),this.on("newListener",function(n,r){if("_"!=n[0]&&"release"!=n){var i=this.constructor;if(i.events.indexOf(n)<0)throw new SyntaxError(i.name+" doesn't accept events of type '"+n+"'");var o=EventEmitter.listenerCount(this,n);if(!o){var a={object:this,type:n};this.emit("_rpc",void 0,"subscribe",a,function(r,i){return r?e.emit("error",r):void(t[n]=i)})}}})}function throwRpcNotReady(){throw new SyntaxError("RPC result is not ready, use .then() method instead")}function checkMediaObject(e,t){if(!(t instanceof MediaObject))throw ChecktypeError(e,MediaObject,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,Promise=require("es6-promise").Promise,promiseCallback=require("promisecallback"),disguise=kurentoClient.disguise,EventEmitter=require("events").EventEmitter;inherits(MediaObject,EventEmitter),MediaObject.prototype.getChilds=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(t,"getChilds",function(t,n){return t?e(t):void this.emit("_describe",n,e)})},MediaObject.prototype.getCreationTime=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(t,"getCreationTime",e)},MediaObject.prototype.getMediaPipeline=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(t,"getMediaPipeline",function(t,n){return t?e(t):void this.emit("_describe",n,e)})},MediaObject.prototype.getName=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(t,"getName",e)},MediaObject.prototype.setName=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","name",e,{required:!0});var r={name:e};return t=(t||noop).bind(this),this._invoke(n,"setName",r,t)},MediaObject.prototype.getParent=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(t,"getParent",function(t,n){return t?e(t):void this.emit("_describe",n,e)})},MediaObject.prototype.getSendTagsInEvents=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(t,"getSendTagsInEvents",e)},MediaObject.prototype.setSendTagsInEvents=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("boolean","sendTagsInEvents",e,{required:!0});var r={sendTagsInEvents:e};return t=(t||noop).bind(this),this._invoke(n,"setSendTagsInEvents",r,t)},MediaObject.prototype.addTag=function(e,t,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","key",e,{required:!0}),checkType("String","value",t,{required:!0});var i={key:e,value:t};return n=(n||noop).bind(this),this._invoke(r,"addTag",i,n)},MediaObject.prototype.getTag=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","key",e,{required:!0});var r={key:e};return t=(t||noop).bind(this),this._invoke(n,"getTag",r,t)},MediaObject.prototype.getTags=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(t,"getTags",e)},MediaObject.prototype.removeTag=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","key",e,{required:!0});var r={key:e};return t=(t||noop).bind(this),this._invoke(n,"removeTag",r,t)},Object.defineProperty(MediaObject.prototype,"_invoke",{value:function(e,t,n,r){var i=this;if(n instanceof Function){if(r)throw new SyntaxError("Nothing can be defined after the callback");r=n,n=void 0}var o,a=this._createError;a?(o=Promise.reject(a),Object.defineProperty(o,"value",{get:function(){throw a}})):(o=new Promise(function(r,a){function s(e,t){if(delete o.value,e)return Object.defineProperty(o,"value",{get:function(){throw e}}),a(e);var n=t.value;void 0===n?n=i:Object.defineProperty(o,"value",{value:n}),r(n)}var c={object:i,operation:t};n&&(c.operationParams=n),i.emit("_rpc",e,"invoke",c,s)}),Object.defineProperty(o,"value",{configurable:!0,get:throwRpcNotReady}));var s=o.then;return o.then=function(e,t){return e instanceof Function&&(e=e.bind(i)),t instanceof Function&&(t=t.bind(i)),s.call(this,e,t),this},disguise(promiseCallback(o,r,this),this)}}),MediaObject.prototype.release=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;arguments.length||(e=void 0),e=(e||noop).bind(this);var n,r=this,i=this._createError;return n=i?Promise.reject(i):new Promise(function(e,n){function i(t){return t?n(t):(r.emit("release"),Object.keys(r._events).forEach(function(e){"_"!=e[0]&&"newListener"!=e&&"removeListener"!=e&&r.removeAllListeners(e)}),Object.defineProperty(r,"id",{value:null}),void e())}var o={object:r};r.emit("_rpc",t,"release",o,i)}),disguise(promiseCallback(n,e),this)},MediaObject.prototype.then=function(e,t){var n=this,r=new Promise(function(r,i){function o(o){var a;if(e)try{a=e.call(n,o)}catch(s){return t||console.trace("Uncaugh exception",s),i(s)}r(a)}function a(e){if(t)try{e=t.call(n,e)}catch(r){return i(r)}else console.trace("Uncaugh exception",e);i(e)}if(null===n.id){var s=new ReferenceError("MediaObject not found in server");s.code=40101,s.object=n,a(s)}else void 0!==n.id?o(n):n.once("_id",function(e,t){return e?a(e):void o(n)})});return disguise(r,this)},Object.defineProperty(MediaObject.prototype,"commited",{get:function(){return void 0!==this.id}}),MediaObject.constructorParams={},MediaObject.events=["Error"],module.exports=MediaObject,MediaObject.check=checkMediaObject;
...
function noop(e){e&&console.trace(e)}function DispatcherOneToMany(){DispatcherOneToMany.super_.call(this)}function checkDispatcherOneToMany(e,n){if(!(n instanceof DispatcherOneToMany))throw ChecktypeError(e,DispatcherOneToMany,n)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,Hub=require("kurento-client-core").abstracts.Hub;inherits(DispatcherOneToMany,Hub),DispatcherOneToMany.prototype.removeSource=function(e){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),e=(e||noop).bind(this),this._invoke(n,"removeSource",e)},DispatcherOneToMany.prototype.setSource=function(e,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("HubPort","source",e,{required:!0});var t={source:e};return n=(n||noop).bind(this),this._invoke(r,"setSource",t,n)},DispatcherOneToMany.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},DispatcherOneToMany.events=Hub.events,module.exports=DispatcherOneToMany,DispatcherOneToMany.check=checkDispatcherOneToMany;
...
function noop(n){n&&console.trace(n)}function PlayerEndpoint(){PlayerEndpoint.super_.call(this)}function checkPlayerEndpoint(n,e){if(!(e instanceof PlayerEndpoint))throw ChecktypeError(n,PlayerEndpoint,e)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,UriEndpoint=require("kurento-client-core").abstracts.UriEndpoint;inherits(PlayerEndpoint,UriEndpoint),PlayerEndpoint.prototype.play=function(n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(n=void 0),n=(n||noop).bind(this),this._invoke(e,"play",n)},PlayerEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0},uri:{type:"String",required:!0},useEncodedMedia:{type:"boolean"}},PlayerEndpoint.events=UriEndpoint.events.concat(["EndOfStream"]),module.exports=PlayerEndpoint,PlayerEndpoint.check=checkPlayerEndpoint;
...
function noop(t){t&&console.trace(t)}function WebRtcEndpoint(){WebRtcEndpoint.super_.call(this)}function checkWebRtcEndpoint(t,n){if(!(n instanceof WebRtcEndpoint))throw ChecktypeError(t,WebRtcEndpoint,n)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,BaseRtpEndpoint=require("kurento-client-core").abstracts.BaseRtpEndpoint;inherits(WebRtcEndpoint,BaseRtpEndpoint),WebRtcEndpoint.prototype.getStunServerAddress=function(t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(t=void 0),t=(t||noop).bind(this),this._invoke(n,"getStunServerAddress",t)},WebRtcEndpoint.prototype.setStunServerAddress=function(t,n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","stunServerAddress",t,{required:!0});var r={stunServerAddress:t};return n=(n||noop).bind(this),this._invoke(e,"setStunServerAddress",r,n)},WebRtcEndpoint.prototype.getStunServerPort=function(t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(t=void 0),t=(t||noop).bind(this),this._invoke(n,"getStunServerPort",t)},WebRtcEndpoint.prototype.setStunServerPort=function(t,n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("int","stunServerPort",t,{required:!0});var r={stunServerPort:t};return n=(n||noop).bind(this),this._invoke(e,"setStunServerPort",r,n)},WebRtcEndpoint.prototype.getTurnUrl=function(t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(t=void 0),t=(t||noop).bind(this),this._invoke(n,"getTurnUrl",t)},WebRtcEndpoint.prototype.setTurnUrl=function(t,n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","turnUrl",t,{required:!0});var r={turnUrl:t};return n=(n||noop).bind(this),this._invoke(e,"setTurnUrl",r,n)},WebRtcEndpoint.prototype.addIceCandidate=function(t,n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("IceCandidate","candidate",t,{required:!0});var r={candidate:t};return n=(n||noop).bind(this),this._invoke(e,"addIceCandidate",r,n)},WebRtcEndpoint.prototype.gatherCandidates=function(t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(t=void 0),t=(t||noop).bind(this),this._invoke(n,"gatherCandidates",t)},WebRtcEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},WebRtcEndpoint.events=BaseRtpEndpoint.events.concat(["OnIceCandidate","OnIceComponentStateChanged","OnIceGatheringDone"]),module.exports=WebRtcEndpoint,WebRtcEndpoint.check=checkWebRtcEndpoint;
