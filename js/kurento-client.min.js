...
function findIndex(e,n){for(var t,r=0;t=e[r];r++)if(n(t))return r;return-1}function serializeParams(e){for(var n in e){var t=e[n];if(t instanceof MediaObject){var r=t.id;void 0!==r&&(e[n]=r)}}return e}function serializeOperation(e,n){var t=e.params;switch(e.method){case"create":t.constructorParams=serializeParams(t.constructorParams);break;default:t=serializeParams(t),t.operationParams=serializeParams(t.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,t,r){var a=[];void 0!=e&&a.push(e);for(var i in n){var o=n[i];void 0!==o&&a.push(o)}return void 0!=t&&a.push(t),promiseCallback(Promise.all(a),r)}function noop(e,n){return e&&console.trace(e),n}function KurentoClient(e,n,t){function r(e){var n=e.method,t=e.params.value,r=t.object,a=O[r];if(!a)return console.warn("Unknown object id '"+r+"'",e);switch(n){case"onEvent":a.emit(t.type,t.data);break;default:console.warn("Unknown message type '"+n+"'")}}function a(e){var n=e.method,t=e.params,r=e.callback,a=e.stack,i=Date.now();P.encode(n,t,function(e,n){if(e){var t=Date.now(),o=Error;switch(e.code){case MEDIA_OBJECT_TYPE_NOT_FOUND:o=TypeError;break;case MEDIA_OBJECT_NOT_FOUND:o=ReferenceError;break;case MEDIA_OBJECT_METHOD_NOT_FOUND:o=SyntaxError}e=extend(new o(e.message||e),e),Object.defineProperties(e,{requestTimestamp:{value:i},responseTimestamp:{value:t},stack:{value:[e.toString()].concat(e.stack.split("\n")[1],a.split("\n").slice(2)).join("\n")}})}else p.sessionId!==n.sessionId&&Object.defineProperty(p,"sessionId",{configurable:!0,value:n.sessionId});r(e,n)})}function i(e,n){var t=e.callback||noop,r=this.value[n];if(void 0==r)return t(new Error("Command not executed in the server"));var a,i=r.error,o=r.result;switch(o&&(a=o.value),e.method){case"create":var c=e.params.object;if(i)return c.emit("_id",i),t(i);t(null,m(c,a));break;default:t(i,o)}}function o(e){function n(n,t){return n?console.error("Implicit transaction failed"):void e.forEach(i,t)}e.forEach(serializeOperation);var t={method:"transaction",params:{operations:e},callback:n};a(t)}function c(){var e=w.shift();if(w.length){for(;e&&"transaction"===e.method;)a(e),e=w.shift();for(var n=[];e;)"transaction"===e.method?(n.length&&(o(n),n=[]),a(e)):n.push(e),e=w.shift();n.length&&o(n)}else a(e)}function s(e,t,r){var i=(new Error).stack;t.sessionId=p.sessionId,p.then(function(){n.useImplicitTransactions&&!w.length&&async.setImmediate(c);var o={method:e,params:t,callback:r};Object.defineProperty(o,"stack",{value:i}),n.useImplicitTransactions?w.push(o):a(o)},r)}function u(e,n,t){function r(e,r){var a=n.object;if(a===r)return t(null,a);if(e)return a.emit("_id",e),t(e);var i=r.value;t(null,m(a,i))}return e?transactionOperation.call(e,"create",n,t):k.length?transactionOperation.call(k,"create",n,t):(t=t||noop,deferred(null,n.constructorParams,null,function(e){if(e)throw e;return n.constructorParams=serializeParams(n.constructorParams),s("create",n,r)})["catch"](t))}function l(e,n,t,r){if(e)return transactionOperation.call(e,n,t,r);var a=t.object;if(a&&a.transactions&&a.transactions.length){var i=new TransactionNotCommitedException;return i.method=n,i.params=t,setTimeout(r,0,i)}for(var o in t.operationParams){var a=t.operationParams[o];if(a&&a.transactions&&a.transactions.length){var i=new TransactionNotCommitedException;return i.method=n,i.params=t,setTimeout(r,0,i)}}if(k.length)return transactionOperation.call(k,n,t,r);var c=new Promise(function(e,r){function a(n,t){return n?r(n):void e(t)}b=deferred(t.object,t.operationParams,b,function(e){if(e)throw e;return t=serializeParams(t),t.operationParams=serializeParams(t.operationParams),s(n,t,a)})["catch"](r)});E=promiseCallback(c,r),"release"==n&&(b=E)}function d(e,n){function t(e,n){if(n instanceof MediaObject&&void 0===n.id){var t=findIndex(o,function(t){return e!=t&&t.params.object===n});if(t>=0)return"newref:"+t;d.push(n)}return n}function r(e,t){return e?n(e):(o.forEach(i,t),void n(null,t))}if(k.length)return transactionOperation.call(k,"transaction",e,n);n=n||noop;for(var a,o=e.operations,c=0;a=o[c];c++){var u=a.params.object;if(u instanceof MediaObject&&null===u.id){var l=new ReferenceError("MediaObject not found in server");return l.code=40101,l.object=u,o.forEach(function(e){"create"==e.method&&e.params.object.emit("_id",l);var n=e.callback;n instanceof Function&&n(l)}),n(l)}}var d=[];o.forEach(function(e){var n=e.params;switch(e.method){case"create":var r=n.constructorParams;for(var a in r)r[a]=t(e,r[a]);break;default:n.object=t(e,n.object);var i=n.operationParams;for(var a in i)i[a]=t(e,i[a])}}),Promise.all(d).then(function(){o.forEach(serializeOperation),s("transaction",e,r)},n)}function f(e,n){if(k.length)return transactionOperation.call(k,"transaction",e,n);var t=e.operations;async.each(t,function(e){switch(e.method){case"create":u(void 0,e.params,e.callback);break;case"transaction":f(e.params.operations,e.callback);break;default:l(void 0,e.method,e.params,e.callback)}},n)}function m(e,n){var t=O[n];return t?t:(e.emit("_id",null,n),O[n]=e,e.once("release",function(){delete O[n]}),e)}function v(e,n){function t(t,r){if(t)return n(t);var a=M.createInmediate(r);return n(null,m(a,e))}if(void 0==e)return n(new TypeError("'id' can't be null or undefined"));var r=O[e];if(r)return n(null,r);var a={object:e};s("describe",a,t)}function h(t){t=(t||noop).bind(this);var r=!1,a=reconnect({failAfter:g},function(e){r&&(e.writable=!1),P.transport=e}).connect(e);Object.defineProperty(this,"_re",{get:function(){return a}}),this.close=function(){r=!0,E.then(a.disconnect.bind(a))},a.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){var t=new Promise(function(t,r){function i(){a.removeListener("fail",o);var i;if(e)try{i=e.call(p,p)}catch(c){return n||console.trace("Uncaugh exception",c),r(c)}t(i)}function o(){a.removeListener("connection",i);var e=new Error("Connection error");if(n)try{e=n.call(p,e)}catch(t){return r(t)}else console.trace("Uncaugh exception",e);r(e)}a.connected?i():a.reconnect?(a.once("connection",i),a.once("fail",o)):o()});return disguise(t,this)},this["catch"]=this.then.bind(this,null);var i=this;n.strict&&(i=this.getServerManager().then(function(e){return e.getInfo()}).then(function(e){var n=e.modules.map(function(e){return e.name}),t=KurentoClient.register.modules.filter(function(e){return n.indexOf(e)<0}),r=t.length;if(r){if(1===r)var a="Module '"+t[0]+"' is not installed in the Kurento Media Server";else var a="Modules '"+t.slice(0,-1).join("', '")+"' and '"+t[r-1]+"' are not installed in the Kurento Media Server";var i=new SyntaxError(a);return i.modules=t,Promise.reject(i)}return Promise.resolve(p)})),promiseCallback(i,t)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,t);var p=this;EventEmitter.call(this);var b=Promise.resolve(),E=Promise.resolve();n instanceof Function&&(t=n,n=void 0),n=n||{};var g=n.failAfter;void 0==g&&(g=5),void 0===n.enableTransactions&&(n.enableTransactions=!0),void 0===n.strict&&(n.strict=!0),n.request_timeout=n.request_timeout||BASE_TIMEOUT,n.response_timeout=n.response_timeout||BASE_TIMEOUT,n.duplicates_timeout=n.duplicates_timeout||BASE_TIMEOUT;var O={};if("string"==typeof e){var T=n.access_token;void 0!=T&&(e=url.parse(e,!0),e.query.access_token=T,e=url.format(e),delete n.access_token)}var P=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):r(e):void console.error("Invalid request instance",e)}),_=n.enableTransactions?d:f,k=new TransactionsManager(this,function(e,n){var t={object:p,operations:e};_(t,n)});this.beginTransaction=k.beginTransaction.bind(k),this.endTransaction=k.endTransaction.bind(k),this.transaction=k.transaction.bind(k),Object.defineProperty(this,"sessionId",{configurable:!0}),this.on("disconnect",function(){Object.defineProperty(this,"sessionId",{configurable:!1,get:function(){throw new SyntaxError("Client has been disconnected")}});for(var e in O)O[e].emit("release")});var w=[];this.getMediaobjectById=function(e,n){return disguise(createPromise(e,v,n),this)};var M=new MediaObjectCreator(this,u,l,_,this.getMediaobjectById.bind(this),n.strict);Object.defineProperty(this,"_resetCache",{value:function(){O={}}}),this.create=M.create.bind(M),h.call(p,t)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),disguise=require("./disguise"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),TransactionsManager=require("./TransactionsManager"),TransactionNotCommitedException=TransactionsManager.TransactionNotCommitedException,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("kurento-client-core").abstracts.MediaObject;const MEDIA_OBJECT_TYPE_NOT_FOUND=40100,MEDIA_OBJECT_NOT_FOUND=40101,MEDIA_OBJECT_METHOD_NOT_FOUND=40105,BASE_TIMEOUT=2e4;inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e instanceof Array||(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0),e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var t=e[0],r=e[e.length-1],a=new Promise(function(n,r){function a(e,t){return e?r(e):void n(t)}async.each(e.slice(1),function(e,n){t=t.connect(e,n)},a)});return disguise(promiseCallback(a,n),r)},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)};var singletons={};KurentoClient.getSingleton=function(e,n){var t=singletons[e];return t||(t=KurentoClient(e,function(t,r){return t?n(t):(singletons[e]=r,void r.on("disconnect",function(){delete singletons[e]}))})),disguise(promiseCallback(t,n),t)},module.exports=KurentoClient;
