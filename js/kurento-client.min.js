...
function serializeParams(e){for(var n in e){var r=e[n];if(r instanceof MediaObject){var t=r.id;void 0!==t&&(e[n]=t)}}return e}function serializeOperation(e,n){var r=e.params;switch(e.method){case"create":r.constructorParams=serializeParams(r.constructorParams);break;default:r=serializeParams(r),r.operationParams=serializeParams(r.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,r,t){var a=[];void 0!=e&&a.push(e);for(var i in n){var o=n[i];void 0!==o&&a.push(o)}return void 0!=r&&a.push(r),promiseCallback(Promise.all(a),t)}function noop(e){e&&console.trace(e)}function id2object(e,n,r,t,a){if(e)return a(e);var i=["getConnectedSinks","getMediaPipeline","getMediaSinks","getMediaSrcs","getParent"];if(-1!=i.indexOf(r)){var o=n.sessionId;return this.getMediaobjectById(t,function(e,n){if(e)return a(e);var n={sessionId:o,value:n};a(null,n)})}a(null,n)}function KurentoClient(e,n,r){function t(e){var n=e.method,r=e.params.value,t=r.object,a=h[t];if(!a)return console.warn("Unknown object id '"+t+"'",e);switch(n){case"onEvent":a.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+n+"'")}}function a(n){var r=!1,t=reconnect({failAfter:p},function(e){r&&(e.writable=!1),P.transport=e}).connect(e);Object.defineProperty(this,"_re",{configurable:!0,get:function(){return t}}),this.close=function(){r=!0,v.then(t.disconnect.bind(t))},t.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){return new Promise(function(r,a){function i(){t.removeListener("fail",o);var i;if(e)try{i=e.call(f,f)}catch(c){return n||console.trace("Uncaugh exception",c),a(c)}r(i)}function o(){t.removeListener("connection",i);var e=new Error("Connection error");if(n)try{e=n.call(f,e)}catch(r){return a(r)}else console.trace("Uncaugh exception",e);a(e)}t.connected?i():t.reconnect?(t.once("connection",i),t.once("fail",o)):o()})},this["catch"]=this.then.bind(this,null),n&&this.then(n.bind(void 0,null),n)}function i(e,n,r){f.then(function(){P.encode(e,n,function(e,n){e&&(e=extend(new Error(e.message||e),e)),r(e,n)})},function(){a.call(f,function(t){return t?r(t):void i(e,n,r)})})}function o(e,n,r){function t(e,t){var a=n.object;if(e)return a.emit("_id",e),r(e);var i=t.value;r(null,l(a,i))}return e?transactionOperation.call(e,"create",n,r):E.length?transactionOperation.call(E,"create",n,r):(r=r||noop,void deferred(null,n.constructorParams,null,function(e){return e?r(e):(n.constructorParams=serializeParams(n.constructorParams),void i("create",n,t))}))}function c(e,n,r,t){if(e)return transactionOperation.call(e,n,r,t);var a=r.object;if(a&&a.transactions&&a.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}for(var c in r.operationParams){var a=r.operationParams[c];if(a&&a.transactions&&a.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}}if(E.length)return transactionOperation.call(E,n,r,t);var s=new Promise(function(e,t){function a(n,a){var i=r.operation,o=a?a.value:void 0;id2object.call(f,n,a,i,o,function(n,r){return n?t(n):void e(r)})}m=deferred(r.object,r.operationParams,m,function(e){return e?t(e):(r=serializeParams(r),r.operationParams=serializeParams(r.operationParams),void i(n,r,a))})});v=promiseCallback(s,t),"release"==n&&(m=v)}function s(e,n){function r(e,n){if(n instanceof MediaObject&&void 0===n.id){var r=o.findIndex(function(r){return e!=r&&r.params.object===n});if(r>=0)return"newref:"+r;d.push(n)}return n}function t(e,r){return e?n(e):(o.forEach(function(e,n){var t=e.callback||noop,a=r.value[n];if(void 0==a)return t(new Error("Command not executed in the server"));var i,o=a.error,c=a.result;switch(c&&(i=c.value),e.method){case"create":var s=e.params.object;if(o)return s.emit("_id",o),t(o);t(null,l(s,i));break;default:id2object.call(f,o,c,e,i,t)}}),void n(null,r))}if(E.length)return transactionOperation.call(E,"transaction",e,n);for(var a,o=e.operations,c=0;a=o[c];c++){var s=a.params.object;if(s instanceof MediaObject&&null===s.id){var u=new Error("MediaObject not found in server");return u.code=40101,u.object=s,o.forEach(function(e){"create"==e.method&&e.params.object.emit("_id",u);var n=e.callback;n instanceof Function&&n(u)}),n(u)}}var d=[];o.forEach(function(e){var n=e.params;switch(e.method){case"create":var t=n.constructorParams;for(var a in t)t[a]=r(e,t[a]);break;default:n.object=r(e,n.object);var i=n.operationParams;for(var a in i)i[a]=r(e,i[a])}}),Promise.all(d).then(function(){o.forEach(serializeOperation),i("transaction",e,t)},n)}function u(e,n){if(E.length)return transactionOperation.call(E,"transaction",e,n);var r=e.operations;async.each(r,function(e){switch(e.method){case"create":o(void 0,e.params,e.callback);break;case"transaction":u(e.params.operations,e.callback);break;default:c(void 0,e.method,e.params,e.callback)}},n)}function l(e,n){var r=h[n];return r?r:(e.emit("_id",null,n),h[n]=e,e.once("release",function(){delete h[n]}),e)}function d(e,n){function r(r,t){if(r)return n(r);var a=j.createInmediate(t);return n(null,l(a,e))}var t=h[e];if(t)return n(null,t);var a={object:e};i("describe",a,r)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,r);var f=this;EventEmitter.call(this);var m=Promise.resolve(),v=Promise.resolve();n instanceof Function&&(r=n,n=void 0),n=n||{};var p=n.failAfter;void 0==p&&(p=5),n.enableTransactions=n.enableTransactions||!0,n.request_timeout=n.request_timeout||BASE_TIMEOUT,n.response_timeout=n.response_timeout||BASE_TIMEOUT,n.duplicates_timeout=n.duplicates_timeout||BASE_TIMEOUT;var h={};if("string"==typeof e){var b=n.access_token;void 0!=b&&(e=url.parse(e,!0),e.query.access_token=b,e=url.format(e),delete n.access_token)}var P=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):t(e):void console.error("Invalid request instance",e)});a.call(f,r);var g=n.enableTransactions?s:u,E=new TransactionsManager(this,function(e,n){var r={object:f,operations:e};g(r,n)});this.beginTransaction=E.beginTransaction.bind(E),this.endTransaction=E.endTransaction.bind(E),this.transaction=E.transaction.bind(E);var j=new MediaObjectCreator(void 0,o,c,g);this.getMediaobjectById=function(e,n){return createPromise(e,d,n)},this.create=j.create.bind(j)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),TransactionsManager=require("./TransactionsManager"),TransactionNotCommitedException=TransactionsManager.TransactionNotCommitedException,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("kurento-client-core").abstracts.MediaObject;const BASE_TIMEOUT=2e4;Array.prototype.findIndex||(Array.prototype.findIndex=function(e){if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof e)throw new TypeError("predicate must be a function");for(var n,r=Object(this),t=r.length>>>0,a=arguments[1],i=0;t>i;i++)if(n=r[i],e.call(a,n,i,r))return i;return-1}),inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0,e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var r=new Promise(function(n,r){function t(e,t){return e?r(e):void n(t)}var a=e[0];async.each(e.slice(1),function(e,n){a.connect(e,n),a=e},t)});return promiseCallback(r,n)},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)},module.exports=KurentoClient;
...
function registerAbstracts(e){for(var s in e){var r=e[s],c=r.check;c&&(checkType[s]=c),abstracts[s]=r}}function registerClass(e,s){var r=s.check;r&&(checkType[e]=r),classes[e]=s}function registerComplexTypes(e){for(var s in e){var r=e[s],c=r.check;c?(checkType[s]=c,complexTypes[s]=r):checkType[s]=r}}function register(e,s){if("string"!=typeof e)s=e,e=void 0;else if(void 0==s)return register(e,require(e));if(s instanceof Function){if(e||(e=s.name),void 0==e)throw new Error("Can't register an anonymous module");registerClass(e,s)}else for(key in s)switch(key){case"abstracts":registerAbstracts(s[key]);break;case"complexTypes":registerComplexTypes(s[key]);break;default:registerClass(key,s[key])}}var checkType=require("checktype"),abstracts={},classes={},complexTypes={};module.exports=register,register.abstracts=abstracts,register.classes=classes,register.complexTypes=complexTypes;
...
function MediaPipeline(){function e(e,t,n){return e?transactionOperation.call(e,"create",t,n):i.length?transactionOperation.call(i,"create",t,n):void a.emit("_create",void 0,t,n)}function t(e,t,n,r){return e?transactionOperation.call(e,t,n,r):i.length?transactionOperation.call(i,t,n,r):void a.emit("_rpc",void 0,t,n,r)}function n(e,t){var n={operations:e};return i.length?transactionOperation.call(i,"transaction",n,t):void a.emit("_transaction",n,t)}MediaPipeline.super_.call(this);var a=this,i=new TransactionsManager(this,n);this.beginTransaction=i.beginTransaction.bind(i),this.endTransaction=i.endTransaction.bind(i),this.transaction=i.transaction.bind(i);var r=new MediaObjectCreator(this,e,t,n);this.create=r.create.bind(r)}function checkMediaPipeline(e,t){if(!(t instanceof MediaPipeline))throw ChecktypeError(e,MediaPipeline,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,MediaObjectCreator=kurentoClient.MediaObjectCreator,TransactionsManager=kurentoClient.TransactionsManager,transactionOperation=TransactionsManager.transactionOperation,MediaObject=require("./abstracts/MediaObject");inherits(MediaPipeline,MediaObject),MediaPipeline.prototype.getGstreamerDot=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(t=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;break;default:var a=new RangeError("Number of params ("+arguments.length+") not in range [0-1]");throw a.length=arguments.length,a.min=0,a.max=1,a}checkType("GstreamerDotDetails","details",e);var i={details:e};return this._invoke(n,"getGstreamerDot",i,t)},MediaPipeline.constructorParams={},MediaPipeline.events=MediaObject.events,module.exports=MediaPipeline,MediaPipeline.check=checkMediaPipeline;
...
function Hub(){Hub.super_.call(this)}function checkHub(e,t){if(!(t instanceof Hub))throw ChecktypeError(e,Hub,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),ChecktypeError=kurentoClient.checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,HubPort=require("../HubPort"),MediaObject=require("./MediaObject");inherits(Hub,MediaObject),Hub.prototype.createHubPort=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;arguments.length||(e=void 0);var r=new HubPort;r.on("_rpc",this.emit.bind(this,"_rpc"));var n={type:"HubPort",constructorParams:{hub:this}};return Object.defineProperty(n,"object",{value:r}),this.emit("_create",t,n,e),r},Hub.constructorParams={},Hub.events=MediaObject.events,module.exports=Hub,Hub.check=checkHub;
},{"../HubPort":41,"./MediaObject":49,"inherits":40,"kurento-client":"kurento-client"}],48:[function(require,module,exports){
function MediaElement(){MediaElement.super_.call(this)}function checkMediaElement(e,t){if(!(t instanceof MediaElement))throw ChecktypeError(e,MediaElement,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,MediaObject=require("./MediaObject");inherits(MediaElement,MediaObject),MediaElement.prototype.connect=function(e,t,n,r,a){var i=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(a=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:r=void 0;break;default:var o=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw o.length=arguments.length,o.min=1,o.max=4,o}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",r);var s={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:r},c=this._invoke(i,"connect",s,a);return c.connect=e.connect.bind(e),c},MediaElement.prototype.disconnect=function(e,t,n,r,a){var i=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(a=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:r=void 0;break;default:var o=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw o.length=arguments.length,o.min=1,o.max=4,o}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",r);var s={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:r};return this._invoke(i,"disconnect",s,a)},MediaElement.prototype.getGstreamerDot=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(t=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;break;default:var r=new RangeError("Number of params ("+arguments.length+") not in range [0-1]");throw r.length=arguments.length,r.min=0,r.max=1,r}checkType("GstreamerDotDetails","details",e);var a={details:e};return this._invoke(n,"getGstreamerDot",a,t)},MediaElement.prototype.getSinkConnections=function(e,t,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;default:var a=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw a.length=arguments.length,a.min=0,a.max=2,a}checkType("MediaType","mediaType",e),checkType("String","description",t);var i={mediaType:e,description:t};return this._invoke(r,"getSinkConnections",i,n)},MediaElement.prototype.getSourceConnections=function(e,t,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;default:var a=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw a.length=arguments.length,a.min=0,a.max=2,a}checkType("MediaType","mediaType",e),checkType("String","description",t);var i={mediaType:e,description:t};return this._invoke(r,"getSourceConnections",i,n)},MediaElement.prototype.setAudioFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("AudioCaps","caps",e,{required:!0});var r={caps:e};return this._invoke(n,"setAudioFormat",r,t)},MediaElement.prototype.setVideoFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("VideoCaps","caps",e,{required:!0});var r={caps:e};return this._invoke(n,"setVideoFormat",r,t)},MediaElement.constructorParams={},MediaElement.events=MediaObject.events,module.exports=MediaElement,MediaElement.check=checkMediaElement;
},{"./MediaObject":49,"inherits":40,"kurento-client":"kurento-client"}],49:[function(require,module,exports){
function MediaObject(){MediaObject.super_.call(this);var e=this;this.once("_id",function(e,t){return e?(this._createError=e,Object.defineProperty(this,"id",{value:null})):void Object.defineProperty(this,"id",{configurable:!0,enumerable:!0,value:t})});var t={};this.on("removeListener",function(r){if("_"!=r[0]&&"release"!=r&&"newListener"!=r){var n=EventEmitter.listenerCount(this,r);if(!n){var i=t[r],o={object:this,subscription:i};this.emit("_rpc",void 0,"unsubscribe",o,function(n){return n?e.emit("error",n):void delete t[r]})}}}),this.on("newListener",function(r){if("_"!=r[0]&&"release"!=r){var n=this.constructor;if(n.events.indexOf(r)<0)throw new SyntaxError(n.name+" doesn't accept events of type '"+r+"'");var i=EventEmitter.listenerCount(this,r);if(!i){var o={object:this,type:r};this.emit("_rpc",void 0,"subscribe",o,function(n,i){return n?e.emit("error",n):void(t[r]=i)})}}})}function throwRpcNotReady(){throw new Error("RPC result is not ready, use .then() method instead")}function checkMediaObject(e,t){if(!(t instanceof MediaObject))throw ChecktypeError(e,MediaObject,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,Promise=require("es6-promise").Promise,promiseCallback=require("promisecallback"),EventEmitter=require("events").EventEmitter;inherits(MediaObject,EventEmitter),MediaObject.prototype.getChilds=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(t,"getChilds",e)},MediaObject.prototype.getMediaPipeline=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(t,"getMediaPipeline",e)},MediaObject.prototype.getName=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(t,"getName",e)},MediaObject.prototype.setName=function(e,t){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","name",e,{required:!0});var n={name:e};return this._invoke(r,"setName",n,t)},MediaObject.prototype.getParent=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(t,"getParent",e)},MediaObject.prototype.getSendTagsInEvents=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(t,"getSendTagsInEvents",e)},MediaObject.prototype.setSendTagsInEvents=function(e,t){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("boolean","sendTagsInEvents",e,{required:!0});var n={sendTagsInEvents:e};return this._invoke(r,"setSendTagsInEvents",n,t)},MediaObject.prototype.addTag=function(e,t,r){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","key",e,{required:!0}),checkType("String","value",t,{required:!0});var i={key:e,value:t};return this._invoke(n,"addTag",i,r)},MediaObject.prototype.getTag=function(e,t){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","key",e,{required:!0});var n={key:e};return this._invoke(r,"getTag",n,t)},MediaObject.prototype.getTags=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(t,"getTags",e)},MediaObject.prototype.removeTag=function(e,t){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","key",e,{required:!0});var n={key:e};return this._invoke(r,"removeTag",n,t)},MediaObject.prototype._invoke=function(e,t,r,n){var i=this;if(r instanceof Function){if(n)throw new SyntaxError("Nothing can be defined after the callback");n=r,r=void 0}var o,a=this._createError;return a?(o=Promise.reject(a),Object.defineProperty(o,"value",{get:function(){throw a}})):(o=new Promise(function(n,a){function s(e,t){if(delete o.value,e)return Object.defineProperty(o,"value",{get:function(){throw e}}),a(e);var r=t.value;void 0===r?r=i:Object.defineProperty(o,"value",{value:r}),n(r)}var c={object:i,operation:t};r&&(c.operationParams=r),i.emit("_rpc",e,"invoke",c,s)}),Object.defineProperty(o,"value",{configurable:!0,get:throwRpcNotReady})),o=promiseCallback(o,n)},MediaObject.prototype.release=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;arguments.length||(e=void 0);var r,n=this,i=this._createError;return r=i?Promise.reject(i):new Promise(function(e,r){function i(t){return t?r(t):(n.emit("release"),Object.keys(n._events).forEach(function(e){"_"!=e[0]&&"newListener"!=e&&"removeListener"!=e&&n.removeAllListeners(e)}),Object.defineProperty(n,"id",{value:null}),void e())}var o={object:n};n.emit("_rpc",t,"release",o,i)}),promiseCallback(r,e)},MediaObject.prototype.then=function(e,t){var r=this;return new Promise(function(n,i){function o(o){var a;if(e)try{a=e.call(r,o)}catch(s){return t||console.trace("Uncaugh exception",s),i(s)}n(a)}function a(e){if(t)try{e=t.call(r,e)}catch(n){return i(n)}else console.trace("Uncaugh exception",e);i(e)}if(null===r.id){var s=new Error("MediaObject not found in server");s.code=40101,s.object=r,a(s)}else void 0!==r.id?o(r):r.once("_id",function(e){return e?a(e):void o(r)})})},Object.defineProperty(MediaObject.prototype,"commited",{get:function(){return void 0!==this.id}}),MediaObject.constructorParams={},MediaObject.events=["Error"],module.exports=MediaObject,MediaObject.check=checkMediaObject;
},{"es6-promise":9,"events":17,"inherits":40,"kurento-client":"kurento-client","promisecallback":119}],50:[function(require,module,exports){
function SdpEndpoint(){SdpEndpoint.super_.call(this)}function checkSdpEndpoint(n,e){if(!(e instanceof SdpEndpoint))throw ChecktypeError(n,SdpEndpoint,e)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,SessionEndpoint=require("./SessionEndpoint");inherits(SdpEndpoint,SessionEndpoint),SdpEndpoint.prototype.getMaxVideoRecvBandwidth=function(n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(n=void 0),this._invoke(e,"getMaxVideoRecvBandwidth",n)},SdpEndpoint.prototype.setMaxVideoRecvBandwidth=function(n,e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("int","maxVideoRecvBandwidth",n,{required:!0});var r={maxVideoRecvBandwidth:n};return this._invoke(t,"setMaxVideoRecvBandwidth",r,e)},SdpEndpoint.prototype.generateOffer=function(n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(n=void 0),this._invoke(e,"generateOffer",n)},SdpEndpoint.prototype.getLocalSessionDescriptor=function(n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(n=void 0),this._invoke(e,"getLocalSessionDescriptor",n)},SdpEndpoint.prototype.getRemoteSessionDescriptor=function(n){var e=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(n=void 0),this._invoke(e,"getRemoteSessionDescriptor",n)},SdpEndpoint.prototype.processAnswer=function(n,e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","answer",n,{required:!0});var r={answer:n};return this._invoke(t,"processAnswer",r,e)},SdpEndpoint.prototype.processOffer=function(n,e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("String","offer",n,{required:!0});var r={offer:n};return this._invoke(t,"processOffer",r,e)},SdpEndpoint.constructorParams={},SdpEndpoint.events=SessionEndpoint.events,module.exports=SdpEndpoint,SdpEndpoint.check=checkSdpEndpoint;
},{"./SessionEndpoint":52,"inherits":40,"kurento-client":"kurento-client"}],51:[function(require,module,exports){
function ServerManager(){ServerManager.super_.call(this)}function checkServerManager(e,r){if(!(r instanceof ServerManager))throw ChecktypeError(e,ServerManager,r)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),ChecktypeError=kurentoClient.checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,MediaObject=require("./MediaObject");inherits(ServerManager,MediaObject),ServerManager.prototype.getInfo=function(e){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(r,"getInfo",e)},ServerManager.prototype.getMetadata=function(e){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(r,"getMetadata",e)},ServerManager.prototype.getPipelines=function(e){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(r,"getPipelines",e)},ServerManager.prototype.getSessions=function(e){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(r,"getSessions",e)},ServerManager.constructorParams={},ServerManager.events=MediaObject.events.concat(["ObjectCreated","ObjectDestroyed"]),module.exports=ServerManager,ServerManager.check=checkServerManager;
...
function AudioCaps(e){return this instanceof AudioCaps?(checkType("AudioCodec","audioCapsDict.codec",e.codec,!0),checkType("int","audioCapsDict.bitrate",e.bitrate,!0),void Object.defineProperties(this,{codec:{writable:!0,enumerable:!0,value:e.codec},bitrate:{writable:!0,enumerable:!0,value:e.bitrate}})):new AudioCaps(e)}function checkAudioCaps(e,c){if(!(c instanceof AudioCaps))throw ChecktypeError(e,AudioCaps,c)}var kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError;module.exports=AudioCaps,AudioCaps.check=checkAudioCaps;
...
function Fraction(e){return this instanceof Fraction?(checkType("int","fractionDict.numerator",e.numerator,!0),checkType("int","fractionDict.denominator",e.denominator,!0),void Object.defineProperties(this,{numerator:{writable:!0,enumerable:!0,value:e.numerator},denominator:{writable:!0,enumerable:!0,value:e.denominator}})):new Fraction(e)}function checkFraction(e,r){if(!(r instanceof Fraction))throw ChecktypeError(e,Fraction,r)}var kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError;module.exports=Fraction,Fraction.check=checkFraction;
...
function RTCTransportStats(t){return this instanceof RTCTransportStats?(checkType("int","rTCTransportStatsDict.bytesSent",t.bytesSent,!0),checkType("int","rTCTransportStatsDict.bytesReceived",t.bytesReceived,!0),checkType("String","rTCTransportStatsDict.rtcpTransportStatsId",t.rtcpTransportStatsId,!0),checkType("boolean","rTCTransportStatsDict.activeConnection",t.activeConnection,!0),checkType("String","rTCTransportStatsDict.selectedCandidatePairId",t.selectedCandidatePairId,!0),checkType("String","rTCTransportStatsDict.localCertificateId",t.localCertificateId,!0),checkType("String","rTCTransportStatsDict.remoteCertificateId",t.remoteCertificateId,!0),RTCTransportStats.super_.call(this,t),void Object.defineProperties(this,{bytesSent:{writable:!0,enumerable:!0,value:t.bytesSent},bytesReceived:{writable:!0,enumerable:!0,value:t.bytesReceived},rtcpTransportStatsId:{writable:!0,enumerable:!0,value:t.rtcpTransportStatsId},activeConnection:{writable:!0,enumerable:!0,value:t.activeConnection},selectedCandidatePairId:{writable:!0,enumerable:!0,value:t.selectedCandidatePairId},localCertificateId:{writable:!0,enumerable:!0,value:t.localCertificateId},remoteCertificateId:{writable:!0,enumerable:!0,value:t.remoteCertificateId}})):new RTCTransportStats(t)}function checkRTCTransportStats(t,e){if(!(e instanceof RTCTransportStats))throw ChecktypeError(t,RTCTransportStats,e)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,RTCStats=require("./RTCStats");inherits(RTCTransportStats,RTCStats),module.exports=RTCTransportStats,RTCTransportStats.check=checkRTCTransportStats;
},{"./RTCStats":75,"inherits":40,"kurento-client":"kurento-client"}],80:[function(require,module,exports){
function ServerInfo(e){return this instanceof ServerInfo?(checkType("String","serverInfoDict.version",e.version,!0),checkType("ModuleInfo","serverInfoDict.modules",e.modules,!0),checkType("ServerType","serverInfoDict.type",e.type,!0),checkType("String","serverInfoDict.capabilities",e.capabilities,!0),void Object.defineProperties(this,{version:{writable:!0,enumerable:!0,value:e.version},modules:{writable:!0,enumerable:!0,value:e.modules},type:{writable:!0,enumerable:!0,value:e.type},capabilities:{writable:!0,enumerable:!0,value:e.capabilities}})):new ServerInfo(e)}function checkServerInfo(e,r){if(!(r instanceof ServerInfo))throw ChecktypeError(e,ServerInfo,r)}var kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError;module.exports=ServerInfo,ServerInfo.check=checkServerInfo;
...
function Tag(e){return this instanceof Tag?(checkType("String","tagDict.key",e.key,!0),checkType("String","tagDict.value",e.value,!0),void Object.defineProperties(this,{key:{writable:!0,enumerable:!0,value:e.key},value:{writable:!0,enumerable:!0,value:e.value}})):new Tag(e)}function checkTag(e,t){if(!(t instanceof Tag))throw ChecktypeError(e,Tag,t)}var kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError;module.exports=Tag,Tag.check=checkTag;
},{"kurento-client":"kurento-client"}],83:[function(require,module,exports){
function VideoCaps(e){return this instanceof VideoCaps?(checkType("VideoCodec","videoCapsDict.codec",e.codec,!0),checkType("Fraction","videoCapsDict.framerate",e.framerate,!0),void Object.defineProperties(this,{codec:{writable:!0,enumerable:!0,value:e.codec},framerate:{writable:!0,enumerable:!0,value:e.framerate}})):new VideoCaps(e)}function checkVideoCaps(e,c){if(!(c instanceof VideoCaps))throw ChecktypeError(e,VideoCaps,c)}var kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError;module.exports=VideoCaps,VideoCaps.check=checkVideoCaps;
...
var HubPort=require("./HubPort"),MediaPipeline=require("./MediaPipeline"),PassThrough=require("./PassThrough");exports.HubPort=HubPort,exports.MediaPipeline=MediaPipeline,exports.PassThrough=PassThrough,exports.abstracts=require("./abstracts"),exports.complexTypes=require("./complexTypes");
},{"./HubPort":41,"./MediaPipeline":42,"./PassThrough":43,"./abstracts":54,"./complexTypes":85}],87:[function(require,module,exports){
function AlphaBlending(){AlphaBlending.super_.call(this)}function checkAlphaBlending(e,r){if(!(r instanceof AlphaBlending))throw ChecktypeError(e,AlphaBlending,r)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,Hub=require("kurento-client-core").abstracts.Hub;inherits(AlphaBlending,Hub),AlphaBlending.prototype.setMaster=function(e,r,t){var i=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("HubPort","source",e,{required:!0}),checkType("int","zOrder",r,{required:!0});var n={source:e,zOrder:r};return this._invoke(i,"setMaster",n,t)},AlphaBlending.prototype.setPortProperties=function(e,r,t,i,n,a,c){var o=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("float","relativeX",e,{required:!0}),checkType("float","relativeY",r,{required:!0}),checkType("int","zOrder",t,{required:!0}),checkType("float","relativeWidth",i,{required:!0}),checkType("float","relativeHeight",n,{required:!0}),checkType("HubPort","port",a,{required:!0});var l={relativeX:e,relativeY:r,zOrder:t,relativeWidth:i,relativeHeight:n,port:a};return this._invoke(o,"setPortProperties",l,c)},AlphaBlending.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},AlphaBlending.events=Hub.events,module.exports=AlphaBlending,AlphaBlending.check=checkAlphaBlending;
...
function IceCandidate(e){return this instanceof IceCandidate?(checkType("String","iceCandidateDict.candidate",e.candidate,!0),checkType("String","iceCandidateDict.sdpMid",e.sdpMid,!0),checkType("int","iceCandidateDict.sdpMLineIndex",e.sdpMLineIndex,!0),void Object.defineProperties(this,{candidate:{writable:!0,enumerable:!0,value:e.candidate},sdpMid:{writable:!0,enumerable:!0,value:e.sdpMid},sdpMLineIndex:{writable:!0,enumerable:!0,value:e.sdpMLineIndex}})):new IceCandidate(e)}function checkIceCandidate(e,d){if(!(d instanceof IceCandidate))throw ChecktypeError(e,IceCandidate,d)}var kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError;module.exports=IceCandidate,IceCandidate.check=checkIceCandidate;
...
var FaceOverlayFilter=require("./FaceOverlayFilter"),GStreamerFilter=require("./GStreamerFilter"),ZBarFilter=require("./ZBarFilter");exports.FaceOverlayFilter=FaceOverlayFilter,exports.GStreamerFilter=GStreamerFilter,exports.ZBarFilter=ZBarFilter,exports.abstracts=require("./abstracts");
...
function promiseCallback(o,r){function n(o,n){try{r(o,n)}catch(e){throw console.error(e),e}}return r&&(o=o.then(n.bind(void 0,null),n)),o}module.exports=promiseCallback;
