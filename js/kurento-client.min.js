...
function checkElementConnectionData(e,c){checkType("MediaElement",e+".source",c.source,!0),checkType("MediaElement",e+".sink",c.sink,!0),checkType("MediaType",e+".type",c.type,!0),checkType("String",e+".sourceDescription",c.sourceDescription,!0),checkType("String",e+".sinkDescription",c.sinkDescription,!0)}var checkType=require("kurento-client").checkType;module.exports=checkElementConnectionData;
...
function checkGstreamerDotDetails(S,e){if("string"!=typeof e)throw SyntaxError(S+" param should be a String, not "+typeof e);if(!e.match("SHOW_MEDIA_TYPE|SHOW_CAPS_DETAILS|SHOW_NON_DEFAULT_PARAMS|SHOW_STATES|SHOW_ALL"))throw SyntaxError(S+" param is not one of [SHOW_MEDIA_TYPE|SHOW_CAPS_DETAILS|SHOW_NON_DEFAULT_PARAMS|SHOW_STATES|SHOW_ALL] ("+e+")")}var checkType=require("kurento-client").checkType;module.exports=checkGstreamerDotDetails;
...
function checkRTCCertificateStats(e,t){checkType("String",e+".fingerprint",t.fingerprint,!0),checkType("String",e+".fingerprintAlgorithm",t.fingerprintAlgorithm,!0),checkType("String",e+".base64Certificate",t.base64Certificate,!0),checkType("String",e+".issuerCertificateId",t.issuerCertificateId,!0),checkType("RTCStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCCertificateStats;
},{"kurento-client":"kurento-client"}],64:[function(require,module,exports){
function checkRTCCodec(e,c){checkType("int",e+".payloadType",c.payloadType,!0),checkType("String",e+".codec",c.codec,!0),checkType("int",e+".clockRate",c.clockRate,!0),checkType("int",e+".channels",c.channels,!0),checkType("String",e+".parameters",c.parameters,!0),checkType("RTCStats",e,c)}var checkType=require("kurento-client").checkType;module.exports=checkRTCCodec;
},{"kurento-client":"kurento-client"}],65:[function(require,module,exports){
function checkRTCDataChannelState(e,n){if("string"!=typeof n)throw SyntaxError(e+" param should be a String, not "+typeof n);if(!n.match("connecting|open|closing|closed"))throw SyntaxError(e+" param is not one of [connecting|open|closing|closed] ("+n+")")}var checkType=require("kurento-client").checkType;module.exports=checkRTCDataChannelState;
},{"kurento-client":"kurento-client"}],66:[function(require,module,exports){
function checkRTCDataChannelStats(e,t){checkType("String",e+".label",t.label,!0),checkType("String",e+".protocol",t.protocol,!0),checkType("int",e+".datachannelid",t.datachannelid,!0),checkType("RTCDataChannelState",e+".state",t.state,!0),checkType("int",e+".messagesSent",t.messagesSent,!0),checkType("int",e+".bytesSent",t.bytesSent,!0),checkType("int",e+".messagesReceived",t.messagesReceived,!0),checkType("int",e+".bytesReceived",t.bytesReceived,!0),checkType("RTCStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCDataChannelStats;
},{"kurento-client":"kurento-client"}],67:[function(require,module,exports){
function checkRTCIceCandidateAttributes(e,t){checkType("String",e+".ipAddress",t.ipAddress,!0),checkType("int",e+".portNumber",t.portNumber,!0),checkType("String",e+".transport",t.transport,!0),checkType("RTCStatsIceCandidateType",e+".candidateType",t.candidateType,!0),checkType("int",e+".priority",t.priority,!0),checkType("String",e+".addressSourceUrl",t.addressSourceUrl,!0),checkType("RTCStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCIceCandidateAttributes;
},{"kurento-client":"kurento-client"}],68:[function(require,module,exports){
function checkRTCIceCandidatePairStats(e,t){checkType("String",e+".transportId",t.transportId,!0),checkType("String",e+".localCandidateId",t.localCandidateId,!0),checkType("String",e+".remoteCandidateId",t.remoteCandidateId,!0),checkType("RTCStatsIceCandidatePairState",e+".state",t.state,!0),checkType("int",e+".priority",t.priority,!0),checkType("boolean",e+".nominated",t.nominated,!0),checkType("boolean",e+".writable",t.writable,!0),checkType("boolean",e+".readable",t.readable,!0),checkType("int",e+".bytesSent",t.bytesSent,!0),checkType("int",e+".bytesReceived",t.bytesReceived,!0),checkType("float",e+".roundTripTime",t.roundTripTime,!0),checkType("float",e+".availableOutgoingBitrate",t.availableOutgoingBitrate,!0),checkType("float",e+".availableIncomingBitrate",t.availableIncomingBitrate,!0),checkType("RTCStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCIceCandidatePairStats;
},{"kurento-client":"kurento-client"}],69:[function(require,module,exports){
function checkRTCInboundRTPStreamStats(e,t){checkType("int",e+".packetsReceived",t.packetsReceived,!0),checkType("int",e+".bytesReceived",t.bytesReceived,!0),checkType("int",e+".packetsLost",t.packetsLost,!0),checkType("float",e+".jitter",t.jitter,!0),checkType("float",e+".fractionLost",t.fractionLost,!0),checkType("RTCRTPStreamStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCInboundRTPStreamStats;
},{"kurento-client":"kurento-client"}],70:[function(require,module,exports){
function checkRTCMediaStreamStats(e,t){checkType("String",e+".streamIdentifier",t.streamIdentifier,!0),checkType("String",e+".trackIds",t.trackIds,!0),checkType("RTCStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCMediaStreamStats;
},{"kurento-client":"kurento-client"}],71:[function(require,module,exports){
function checkRTCMediaStreamTrackStats(e,c){checkType("String",e+".trackIdentifier",c.trackIdentifier,!0),checkType("boolean",e+".remoteSource",c.remoteSource,!0),checkType("String",e+".ssrcIds",c.ssrcIds,!0),checkType("int",e+".frameWidth",c.frameWidth,!0),checkType("int",e+".frameHeight",c.frameHeight,!0),checkType("float",e+".framesPerSecond",c.framesPerSecond,!0),checkType("int",e+".framesSent",c.framesSent,!0),checkType("int",e+".framesReceived",c.framesReceived,!0),checkType("int",e+".framesDecoded",c.framesDecoded,!0),checkType("int",e+".framesDropped",c.framesDropped,!0),checkType("int",e+".framesCorrupted",c.framesCorrupted,!0),checkType("float",e+".audioLevel",c.audioLevel,!0),checkType("float",e+".echoReturnLoss",c.echoReturnLoss,!0),checkType("float",e+".echoReturnLossEnhancement",c.echoReturnLossEnhancement,!0),checkType("RTCStats",e,c)}var checkType=require("kurento-client").checkType;module.exports=checkRTCMediaStreamTrackStats;
},{"kurento-client":"kurento-client"}],72:[function(require,module,exports){
function checkRTCOutboundRTPStreamStats(e,t){checkType("int",e+".packetsSent",t.packetsSent,!0),checkType("int",e+".bytesSent",t.bytesSent,!0),checkType("float",e+".targetBitrate",t.targetBitrate,!0),checkType("float",e+".roundTripTime",t.roundTripTime,!0),checkType("RTCRTPStreamStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCOutboundRTPStreamStats;
},{"kurento-client":"kurento-client"}],73:[function(require,module,exports){
function checkRTCPeerConnectionStats(e,n){checkType("int",e+".dataChannelsOpened",n.dataChannelsOpened,!0),checkType("int",e+".dataChannelsClosed",n.dataChannelsClosed,!0),checkType("RTCStats",e,n)}var checkType=require("kurento-client").checkType;module.exports=checkRTCPeerConnectionStats;
},{"kurento-client":"kurento-client"}],74:[function(require,module,exports){
function checkRTCRTPStreamStats(e,c){checkType("String",e+".ssrc",c.ssrc,!0),checkType("String",e+".associateStatsId",c.associateStatsId,!0),checkType("boolean",e+".isRemote",c.isRemote,!0),checkType("String",e+".mediaTrackId",c.mediaTrackId,!0),checkType("String",e+".transportId",c.transportId,!0),checkType("String",e+".codecId",c.codecId,!0),checkType("int",e+".firCount",c.firCount,!0),checkType("int",e+".pliCount",c.pliCount,!0),checkType("int",e+".nackCount",c.nackCount,!0),checkType("int",e+".sliCount",c.sliCount,!0),checkType("RTCStats",e,c)}var checkType=require("kurento-client").checkType;module.exports=checkRTCRTPStreamStats;
},{"kurento-client":"kurento-client"}],75:[function(require,module,exports){
function checkRTCStats(e,t){checkType("String",e+".id",t.id,!0),checkType("RTCStatsType",e+".type",t.type,!0),checkType("float",e+".timestamp",t.timestamp,!0)}var checkType=require("kurento-client").checkType;module.exports=checkRTCStats;
},{"kurento-client":"kurento-client"}],76:[function(require,module,exports){
function checkRTCStatsIceCandidatePairState(e,t){if("string"!=typeof t)throw SyntaxError(e+" param should be a String, not "+typeof t);if(!t.match("frozen|waiting|inprogress|failed|succeeded|cancelled"))throw SyntaxError(e+" param is not one of [frozen|waiting|inprogress|failed|succeeded|cancelled] ("+t+")")}var checkType=require("kurento-client").checkType;module.exports=checkRTCStatsIceCandidatePairState;
},{"kurento-client":"kurento-client"}],77:[function(require,module,exports){
function checkRTCStatsIceCandidateType(e,r){if("string"!=typeof r)throw SyntaxError(e+" param should be a String, not "+typeof r);if(!r.match("host|serverreflexive|peerreflexive|relayed"))throw SyntaxError(e+" param is not one of [host|serverreflexive|peerreflexive|relayed] ("+r+")")}var checkType=require("kurento-client").checkType;module.exports=checkRTCStatsIceCandidateType;
},{"kurento-client":"kurento-client"}],78:[function(require,module,exports){
function checkRTCStatsType(t,a){if("string"!=typeof a)throw SyntaxError(t+" param should be a String, not "+typeof a);if(!a.match("inboundrtp|outboundrtp|session|datachannel|track|transport|candidatepair|localcandidate|remotecandidate"))throw SyntaxError(t+" param is not one of [inboundrtp|outboundrtp|session|datachannel|track|transport|candidatepair|localcandidate|remotecandidate] ("+a+")")}var checkType=require("kurento-client").checkType;module.exports=checkRTCStatsType;
},{"kurento-client":"kurento-client"}],79:[function(require,module,exports){
function checkRTCTransportStats(e,t){checkType("int",e+".bytesSent",t.bytesSent,!0),checkType("int",e+".bytesReceived",t.bytesReceived,!0),checkType("String",e+".rtcpTransportStatsId",t.rtcpTransportStatsId,!0),checkType("boolean",e+".activeConnection",t.activeConnection,!0),checkType("String",e+".selectedCandidatePairId",t.selectedCandidatePairId,!0),checkType("String",e+".localCertificateId",t.localCertificateId,!0),checkType("String",e+".remoteCertificateId",t.remoteCertificateId,!0),checkType("RTCStats",e,t)}var checkType=require("kurento-client").checkType;module.exports=checkRTCTransportStats;
...
function checkTag(e,c){checkType("String",e+".key",c.key,!0),checkType("String",e+".value",c.value,!0)}var checkType=require("kurento-client").checkType;module.exports=checkTag;
...
function checkIceCandidate(e,c){checkType("String",e+".candidate",c.candidate,!0),checkType("String",e+".sdpMid",c.sdpMid,!0),checkType("int",e+".sdpMLineIndex",c.sdpMLineIndex,!0)}var checkType=require("kurento-client").checkType;module.exports=checkIceCandidate;
},{"kurento-client":"kurento-client"}],101:[function(require,module,exports){
function checkIceComponentState(e,t){if("string"!=typeof t)throw SyntaxError(e+" param should be a String, not "+typeof t);if(!t.match("DISCONNECTED|GATHERING|CONNECTING|CONNECTED|READY|FAILED"))throw SyntaxError(e+" param is not one of [DISCONNECTED|GATHERING|CONNECTING|CONNECTED|READY|FAILED] ("+t+")")}var checkType=require("kurento-client").checkType;module.exports=checkIceComponentState;
},{"kurento-client":"kurento-client"}],102:[function(require,module,exports){
function checkMediaProfileSpecType(e,r){if("string"!=typeof r)throw SyntaxError(e+" param should be a String, not "+typeof r);if(!r.match("WEBM|MP4|WEBM_VIDEO_ONLY|WEBM_AUDIO_ONLY|MP4_VIDEO_ONLY|MP4_AUDIO_ONLY"))throw SyntaxError(e+" param is not one of [WEBM|MP4|WEBM_VIDEO_ONLY|WEBM_AUDIO_ONLY|MP4_VIDEO_ONLY|MP4_AUDIO_ONLY] ("+r+")")}var checkType=require("kurento-client").checkType;module.exports=checkMediaProfileSpecType;
