...
function WebRtcEndpoint(){WebRtcEndpoint.super_.call(this)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,BaseRtpEndpoint=require("kurento-client-core").abstracts.BaseRtpEndpoint;inherits(WebRtcEndpoint,BaseRtpEndpoint),WebRtcEndpoint.prototype.addIceCandidate=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("IceCandidate","candidate",e,{required:!0});var i={candidate:e};return this._invoke(n,"addIceCandidate",i,t)},WebRtcEndpoint.prototype.gatherCandidates=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(e=void 0),this._invoke(t,"gatherCandidates",e)},WebRtcEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},WebRtcEndpoint.events=BaseRtpEndpoint.events.concat(["OnIceCandidate","OnIceGatheringDone"]),module.exports=WebRtcEndpoint,WebRtcEndpoint.check=function(e,t){if(!(t instanceof WebRtcEndpoint))throw ChecktypeError(e,WebRtcEndpoint,t)};
