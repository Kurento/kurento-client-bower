...
function serializeParams(e){for(var t in e){var r=e[t];r instanceof register.abstracts.MediaObject&&(e[t]=r.id)}return e}function getConstructor(e){return register.classes[e]||register.abstracts[e]||register.abstracts.MediaObject}function createConstructor(e){var t=getConstructor(e.type);if(t.create){e=t.create(e.params);var r=t.prototype;inherits(t,getConstructor(e.type)),extend(t.prototype,r)}return t.item=e,t}function createPromise(e,t,r){var n=new Promise(function(r,n){function i(e,t){return e?n(e):void r(t)}e instanceof Array?async.map(e,t,i):t(e,i)});return promiseCallback(n,r)}function KurentoClient(e,t,r){function n(e){var t=e.method,r=e.params.value,n=r.object,i=u[n];if(!i)return console.warn("Unknown object id '"+n+"'",e);switch(t){case"onEvent":i.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+t+"'")}}function i(e,t,r){var n=new e(t,r);return n.on("release",function(){delete u[t]}),n.on("_rpc",function(e,r,n){r.object=t,r.operationParams=serializeParams(r.operationParams),f.encode(e,r,function(e,t){if(e)return n(e);var i=r.operation;if("getConnectedSinks"==i||"getMediaSinks"==i||"getMediaSrcs"==i){var o=t.sessionId;return a.getMediaobjectById(t.value,function(e,t){var t={sessionId:o,value:t};n(e,t)})}n(null,t)})}),(n instanceof register.abstracts.Hub||n instanceof register.classes.MediaPipeline)&&n.on("_create",a.create.bind(a)),u[t]=n,n}function o(e,t){var r=createConstructor(e);e=r.item,delete r.item,e.constructorParams=checkParams(e.params,r.constructorParams,e.type),delete e.params,e.constructorParams=serializeParams(e.constructorParams),f.encode("create",e,function(e,n){if(e)return t(e);var o=n.value;t(null,u[o]||i(r,o))})}function c(e,t){var r=u[e];return r?t(null,r):void f.encode("describe",{object:e},function(r,n){if(r)return t(r);var o=createConstructor(n);return delete o.item,t(null,i(o,e))})}if(!(this instanceof KurentoClient))return new KurentoClient(e,t,r);var a=this;EventEmitter.call(this),t instanceof Function&&(r=t,t=void 0),t=t||{};var s=t.failAfter;void 0==s&&(s=5);var u={};if("string"==typeof e){var l=t.access_token;void 0!=l&&(e=url.parse(e,!0),e.query.access_token=l,e=url.format(e),delete t.access_token)}var f=new RpcBuilder(JsonRPC,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):n(e):void console.error("Invalid request instance",e)}),d=reconnect({failAfter:s},function(e){f.transport=e}).connect(e);this.close=d.disconnect.bind(d),d.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,t){return new Promise(function(r,n){function i(){d.removeListener("connection",o),d.removeListener("fail",c)}function o(){i();var o;if(e)try{o=e(a)}catch(c){return t||console.trace("Uncaugh exception",c),n(c)}r(o)}function c(){i();var e=new Error("Connection error");if(t)try{e=t(e)}catch(r){return n(r)}else console.trace("Uncaugh exception",e);n(e)}d.connected?o():d.reconnect?(d.on("connection",o),d.on("fail",c)):c()})},this.catch=this.then.bind(this,null),r&&this.then(r.bind(void 0,null),r),this.getMediaobjectById=function(e,t){return createPromise(e,c,t)},this.create=function(e,t,r){if(t instanceof Function){if(r)throw new SyntaxError("Nothing can be defined after the callback");r=t,t=void 0}return e instanceof Array||(e={params:t||{},type:e}),createPromise(e,o,r)}}var EventEmitter=require("events").EventEmitter,extend=require("extend"),inherits=require("inherits"),url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),reconnect=require("reconnect-ws"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,checkType=require("checktype"),checkParams=checkType.checkParams,promiseCallback=require("promisecallback"),register=require("./register");inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,t){if(e=Array.prototype.slice.call(arguments,0),t="function"==typeof e[e.length-1]?e.pop():void 0,e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var r=new Promise(function(t,r){function n(e,n){return e?r(e):void t(n)}var i=e[0];async.each(e.slice(1),function(e,t){i.connect(e,t),i=e},n)});return promiseCallback(r,t)},module.exports=KurentoClient,KurentoClient.KurentoClient=KurentoClient,KurentoClient.register=register,register(require("kurento-client-core")),register(require("kurento-client-elements")),register(require("kurento-client-filters"));
...
var FilterType=require("./FilterType"),MediaType=require("./MediaType");exports.FilterType=FilterType,exports.MediaType=MediaType;
