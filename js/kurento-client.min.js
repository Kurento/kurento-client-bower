...
function noop(e,t){return e&&console.trace(e),t}function Hub(){Hub.super_.call(this)}function checkHub(e,t){if(!(t instanceof Hub))throw ChecktypeError(e,Hub,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),disguise=kurentoClient.disguise,ChecktypeError=kurentoClient.checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,HubPort=require("../HubPort"),MediaObject=require("./MediaObject");inherits(Hub,MediaObject),Hub.prototype.createHubPort=function(e){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;arguments.length||(e=void 0),e=(e||noop).bind(this);var r=new HubPort;r.on("_rpc",this.emit.bind(this,"_rpc"));var n={type:"HubPort",constructorParams:{hub:this}};return Object.defineProperty(n,"object",{value:r}),this.emit("_create",t,n,e),r},Hub.constructorParams={},Hub.events=MediaObject.events,module.exports=Hub,Hub.check=checkHub;
},{"../HubPort":40,"./MediaObject":48,"inherits":"inherits","kurento-client":"kurento-client"}],47:[function(require,module,exports){
function noop(e,t){return e&&console.trace(e),t}function MediaElement(){MediaElement.super_.call(this)}function checkMediaElement(e,t){if(!(t instanceof MediaElement))throw ChecktypeError(e,MediaElement,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),disguise=kurentoClient.disguise,checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,checkArray=checkType.checkArray,Transaction=kurentoClient.TransactionsManager.Transaction,each=require("async").each,promiseCallback=require("promisecallback"),MediaObject=require("./MediaObject");inherits(MediaElement,MediaObject),MediaElement.prototype.connect=function(e,t,n,r,i){var a,o=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;if(e instanceof Array){i=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0;var s=e,c=this;if(e=s[s.length-1],!s.length)throw new SyntaxError("Need at least one media element to connect");checkArray("MediaElement","media",s),a=new Promise(function(e,t){function n(n,r){return n?t(n):void e(r)}each(s,function(e,t){c=c.connect(e,t)},n)}),a=promiseCallback(a,i)}else{var o=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(i=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:r=void 0;break;default:var p=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw p.length=arguments.length,p.min=1,p.max=4,p}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",r);var u={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:r};i=(i||noop).bind(this),a=this._invoke(o,"connect",u,i)}return disguise(a,e)},MediaElement.prototype.disconnect=function(e,t,n,r,i){var a=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(i=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:r=void 0;break;default:var o=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw o.length=arguments.length,o.min=1,o.max=4,o}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",r);var s={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:r};return i=(i||noop).bind(this),disguise(this._invoke(a,"disconnect",s,i),this)},MediaElement.prototype.getGstreamerDot=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(t=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;break;default:var r=new RangeError("Number of params ("+arguments.length+") not in range [0-1]");throw r.length=arguments.length,r.min=0,r.max=1,r}checkType("GstreamerDotDetails","details",e);var i={details:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"getGstreamerDot",i,t),this)},MediaElement.prototype.getSinkConnections=function(e,t,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;default:var i=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw i.length=arguments.length,i.min=0,i.max=2,i}checkType("MediaType","mediaType",e),checkType("String","description",t);var a={mediaType:e,description:t};return n=(n||noop).bind(this),disguise(this._invoke(r,"getSinkConnections",a,n),this)},MediaElement.prototype.getSourceConnections=function(e,t,n){var r=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;default:var i=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw i.length=arguments.length,i.min=0,i.max=2,i}checkType("MediaType","mediaType",e),checkType("String","description",t);var a={mediaType:e,description:t};return n=(n||noop).bind(this),disguise(this._invoke(r,"getSourceConnections",a,n),this)},MediaElement.prototype.setAudioFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("AudioCaps","caps",e,{required:!0});var r={caps:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"setAudioFormat",r,t),this)},MediaElement.prototype.setOutputBitrate=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("int","bitrate",e,{required:!0});var r={bitrate:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"setOutputBitrate",r,t),this)},MediaElement.prototype.setVideoFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("VideoCaps","caps",e,{required:!0});var r={caps:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"setVideoFormat",r,t),this)},MediaElement.constructorParams={},MediaElement.events=MediaObject.events.concat(["ElementConnected","ElementDisconnected"]),module.exports=MediaElement,MediaElement.check=checkMediaElement;
