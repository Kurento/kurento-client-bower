...
function RtpEndpoint(){RtpEndpoint.super_.call(this)}function checkRtpEndpoint(t,e){if(!(e instanceof RtpEndpoint))throw ChecktypeError(t,RtpEndpoint,e)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),disguise=kurentoClient.disguise,ChecktypeError=kurentoClient.checkType.ChecktypeError,BaseRtpEndpoint=require("kurento-client-core").abstracts.BaseRtpEndpoint;inherits(RtpEndpoint,BaseRtpEndpoint),RtpEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},RtpEndpoint.events=BaseRtpEndpoint.events,module.exports=RtpEndpoint,RtpEndpoint.check=checkRtpEndpoint;
