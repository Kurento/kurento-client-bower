...
function serializeParams(e){for(var t in e){var r=e[t];r instanceof abstracts.MediaObject&&(e[t]=r.id)}return e}function getConstructor(e){return registered[e]||abstracts[e]||abstracts.MediaObject}function createConstructor(e){var t=getConstructor(e.type);if(t.create){e=t.create(e.params);var r=t.prototype;inherits(t,getConstructor(e.type)),extend(t.prototype,r)}return t.item=e,t}function createPromise(e,t,r){var n=new Promise(function(r,n){function i(e,t){return e?n(e):void r(t)}e instanceof Array?async.map(e,t,i):t(e,i)});return promiseCallback(n,r)}function KurentoClient(e,t,r){function n(e){var t=e.method,r=e.params.value,n=r.object,i=u[n];if(!i)return console.warn("Unknown object id '"+n+"'",e);switch(t){case"onEvent":i.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+t+"'")}}function i(e,t,r){var n=new e(t,r);return n.on("release",function(){delete u[t]}),n.on("_rpc",function(e,r,n){r.object=t,r.operationParams=serializeParams(r.operationParams),f.encode(e,r,function(e,t){if(e)return n(e);var i=r.operation;if("getConnectedSinks"==i||"getMediaSinks"==i||"getMediaSrcs"==i){var o=t.sessionId;return a.getMediaobjectById(t.value,function(e,t){var t={sessionId:o,value:t};n(e,t)})}n(null,t)})}),(n instanceof abstracts.Hub||n instanceof registered.MediaPipeline)&&n.on("_create",a.create.bind(a)),u[t]=n,n}function o(e,t){var r=createConstructor(e);e=r.item,delete r.item,e.constructorParams=checkParams(e.params,r.constructorParams,e.type),delete e.params,e.constructorParams=serializeParams(e.constructorParams),f.encode("create",e,function(e,n){if(e)return t(e);var o=n.value;t(null,u[o]||i(r,o))})}function c(e,t){var r=u[e];return r?t(null,r):void f.encode("describe",{object:e},function(r,n){if(r)return t(r);var o=createConstructor(n);return delete o.item,t(null,i(o,e))})}if(!(this instanceof KurentoClient))return new KurentoClient(e,t,r);var a=this;EventEmitter.call(this),t instanceof Function&&(r=t,t=void 0),t=t||{};var s=t.failAfter;void 0==s&&(s=5);var u={};if("string"==typeof e){var l=t.access_token;void 0!=l&&(e=url.parse(e,!0),e.query.access_token=l,e=url.format(e),delete t.access_token)}var f=new RpcBuilder(JsonRPC,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):n(e):void console.error("Invalid request instance",e)}),d=reconnect({failAfter:s},function(e){f.transport=e}).connect(e);this.close=d.disconnect.bind(d),d.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,t){return new Promise(function(r,n){function i(){d.removeListener("connection",o),d.removeListener("fail",c)}function o(){i();var t;if(e)try{t=e(a)}catch(o){return n(o)}r(t)}function c(){i();var e;if(t)try{e=t(new Error("Connection error"))}catch(r){return n(r)}n(e)}d.connected?o():d.reconnect?(d.on("connection",o),d.on("fail",c)):c()})},this.catch=this.then.bind(this,null),r&&this.then(r.bind(void 0,null),r),this.getMediaobjectById=function(e,t){return createPromise(e,c,t)},this.create=function(e,t,r){if(t instanceof Function){if(r)throw new SyntaxError("Nothing can be defined after the callback");r=t,t=void 0}return e instanceof Array||(e={params:t||{},type:e}),createPromise(e,o,r)}}function registerAbstracts(e){for(var t in e){var r=e[t],n=r.check;n&&(checkType[t]=n),abstracts[t]=r}}function registerClass(e,t){var r=t.check;r&&(checkType[e]=r),registered[e]=t}function registerComplexTypes(e){for(var t in e)checkType[t]=e[t]}var EventEmitter=_dereq_("events").EventEmitter,extend=_dereq_("extend"),inherits=_dereq_("inherits"),url=_dereq_("url"),Promise=_dereq_("es6-promise").Promise,async=_dereq_("async"),reconnect=_dereq_("reconnect-ws"),RpcBuilder=_dereq_("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,checkType=_dereq_("checktype"),checkParams=checkType.checkParams,promiseCallback=_dereq_("promisecallback"),abstracts={},registered={},registered={};inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,t){if(e=Array.prototype.slice.call(arguments,0),t="function"==typeof e[e.length-1]?e.pop():void 0,e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var r=new Promise(function(t,r){function n(e,n){return e?r(e):void t(n)}var i=e[0];async.each(e.slice(1),function(e,t){i.connect(e,t),i=e},n)});return promiseCallback(r,t)},KurentoClient.register=function(e,t){if("string"!=typeof e&&(type=t,t=e,e=void 0),t instanceof Function){if(e||(e=t.name),void 0==e)throw new Error("Can't register an anonymous module");registerClass(e,t)}else for(key in t)switch(key){case"abstracts":registerAbstracts(t[key]);break;case"complexTypes":registerComplexTypes(t[key]);break;default:registerClass(key,t[key])}},KurentoClient.require=function(e){var t=_dereq_(e);if(t instanceof Function)KurentoClient.register(t);else for(var e in t)KurentoClient.register(e,t[e])},KurentoClient.register(_dereq_("kurento-client-core")),KurentoClient.register(_dereq_("kurento-client-elements")),KurentoClient.register(_dereq_("kurento-client-filters")),module.exports=KurentoClient,KurentoClient.KurentoClient=KurentoClient;
...
function checkArray(e,r,c){if(!(c instanceof Array))throw SyntaxError(r+" param should be an Array of "+e+", not "+typeof c);for(var o,n=0;o=c[n];n++)checkType(e,r+"["+n+"]",o)}function checkBoolean(e,r){if("boolean"!=typeof r)throw SyntaxError(e+" param should be a Boolean, not "+typeof r)}function checkNumber(e,r){if("number"!=typeof r)throw SyntaxError(e+" param should be a Number, not "+typeof r)}function checkInteger(e,r){if(!Number.isInteger(r))throw SyntaxError(e+" param should be an Integer, not "+typeof r)}function checkObject(e,r){if("object"!=typeof r)throw SyntaxError(e+" param should be an Object, not "+typeof r)}function checkString(e,r){if("string"!=typeof r)throw SyntaxError(e+" param should be a String, not "+typeof r)}function checkType(e,r,c,o){if(o=o||{},void 0!=c){if(o.isArray)return checkArray(e,r,c);var n=checkType[e];if(n)return n(r,c);console.warn("Could not check "+r+", unknown type "+e)}else if(o.required)throw SyntaxError(r+" param is required")}function checkParams(e,r,c){var o={};for(var n in r){var t=e[n],a=r[n],i={required:a.required,isArray:a.isList};checkType(a.type,n,t,i),void 0!=t&&(o[n]=t,delete e[n])}return Object.keys(e).length&&console.warn("Unused params for "+c+":",e),o}function checkMethodParams(e,r){for(var c,o={},n=0;c=r[n];n++){var t=c.name,a=e[n],i={required:c.required,isArray:c.isList};checkType(c.type,t,a,i),o[t]=a}var h=e.slice(n);return h.length&&console.warning("Unused params:",h),o}Number.isInteger||(Number.isInteger=function(e){return"number"==typeof e&&isFinite(e)&&e>-9007199254740992&&9007199254740992>e&&Math.floor(e)===e}),module.exports=checkType,checkType.checkParams=checkParams,checkType.boolean=checkBoolean,checkType.double=checkNumber,checkType.float=checkNumber,checkType.int=checkInteger,checkType.Object=checkObject,checkType.String=checkString;
//# sourceMappingURL=kurento-client.map
...
function Buffer(t,e,r){if(!(this instanceof Buffer))return new Buffer(t,e,r);var n,i=typeof t;if("number"===i)n=t>0?t>>>0:0;else if("string"===i)"base64"===e&&(t=base64clean(t)),n=Buffer.byteLength(t,e);else{if("object"!==i||null===t)throw new Error("First argument needs to be a number, array or string.");"Buffer"===t.type&&isArray(t.data)&&(t=t.data),n=+t.length>0?Math.floor(+t.length):0}var f;Buffer.TYPED_ARRAY_SUPPORT?f=Buffer._augment(new Uint8Array(n)):(f=this,f.length=n,f._isBuffer=!0);var s;if(Buffer.TYPED_ARRAY_SUPPORT&&"number"==typeof t.byteLength)f._set(t);else if(isArrayish(t))if(Buffer.isBuffer(t))for(s=0;n>s;s++)f[s]=t.readUInt8(s);else for(s=0;n>s;s++)f[s]=(t[s]%256+256)%256;else if("string"===i)f.write(t,0,e);else if("number"===i&&!Buffer.TYPED_ARRAY_SUPPORT&&!r)for(s=0;n>s;s++)f[s]=0;return f}function hexWrite(t,e,r,n){r=Number(r)||0;var i=t.length-r;n?(n=Number(n),n>i&&(n=i)):n=i;var f=e.length;assert(f%2===0,"Invalid hex string"),n>f/2&&(n=f/2);for(var s=0;n>s;s++){var u=parseInt(e.substr(2*s,2),16);assert(!isNaN(u),"Invalid hex string"),t[r+s]=u}return s}function utf8Write(t,e,r,n){var i=blitBuffer(utf8ToBytes(e),t,r,n);return i}function asciiWrite(t,e,r,n){var i=blitBuffer(asciiToBytes(e),t,r,n);return i}function binaryWrite(t,e,r,n){return asciiWrite(t,e,r,n)}function base64Write(t,e,r,n){var i=blitBuffer(base64ToBytes(e),t,r,n);return i}function utf16leWrite(t,e,r,n){var i=blitBuffer(utf16leToBytes(e),t,r,n);return i}function base64Slice(t,e,r){return base64.fromByteArray(0===e&&r===t.length?t:t.slice(e,r))}function utf8Slice(t,e,r){var n="",i="";r=Math.min(t.length,r);for(var f=e;r>f;f++)t[f]<=127?(n+=decodeUtf8Char(i)+String.fromCharCode(t[f]),i=""):i+="%"+t[f].toString(16);return n+decodeUtf8Char(i)}function asciiSlice(t,e,r){var n="";r=Math.min(t.length,r);for(var i=e;r>i;i++)n+=String.fromCharCode(t[i]);return n}function binarySlice(t,e,r){return asciiSlice(t,e,r)}function hexSlice(t,e,r){var n=t.length;(!e||0>e)&&(e=0),(!r||0>r||r>n)&&(r=n);for(var i="",f=e;r>f;f++)i+=toHex(t[f]);return i}function utf16leSlice(t,e,r){for(var n=t.slice(e,r),i="",f=0;f<n.length;f+=2)i+=String.fromCharCode(n[f]+256*n[f+1]);return i}function checkOffset(t,e,r){if(t%1!==0||0>t)throw new RangeError("offset is not uint");if(t+e>r)throw new RangeError("Trying to access beyond buffer length")}function checkInt(t,e,r,n,i,f){assert(Buffer.isBuffer(t),"buffer must be a Buffer instance"),assert(i>=e&&e>=f,"value is out of bounds"),assert(r+n<=t.length,"index out of range")}function objectWriteUInt16(t,e,r,n){0>e&&(e=65535+e+1);for(var i=0,f=Math.min(t.length-r,2);f>i;i++)t[r+i]=(e&255<<8*(n?i:1-i))>>>8*(n?i:1-i)}function objectWriteUInt32(t,e,r,n){0>e&&(e=4294967295+e+1);for(var i=0,f=Math.min(t.length-r,4);f>i;i++)t[r+i]=e>>>8*(n?i:3-i)&255}function checkIEEE754(t,e,r,n,i,f){assert(i>=e&&e>=f,"value is out of bounds"),assert(r+n<=t.length,"index out of range")}function writeFloat(t,e,r,n,i){return i||checkIEEE754(t,e,r,4,3.4028234663852886e38,-3.4028234663852886e38),ieee754.write(t,e,r,n,23,4),r+4}function writeDouble(t,e,r,n,i){return i||checkIEEE754(t,e,r,8,1.7976931348623157e308,-1.7976931348623157e308),ieee754.write(t,e,r,n,52,8),r+8}function base64clean(t){for(t=stringtrim(t).replace(INVALID_BASE64_RE,"");t.length%4!==0;)t+="=";return t}function stringtrim(t){return t.trim?t.trim():t.replace(/^\s+|\s+$/g,"")}function isArray(t){return(Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)})(t)}function isArrayish(t){return isArray(t)||Buffer.isBuffer(t)||t&&"object"==typeof t&&"number"==typeof t.length}function toHex(t){return 16>t?"0"+t.toString(16):t.toString(16)}function utf8ToBytes(t){for(var e=[],r=0;r<t.length;r++){var n=t.charCodeAt(r);if(127>=n)e.push(n);else{var i=r;n>=55296&&57343>=n&&r++;for(var f=encodeURIComponent(t.slice(i,r+1)).substr(1).split("%"),s=0;s<f.length;s++)e.push(parseInt(f[s],16))}}return e}function asciiToBytes(t){for(var e=[],r=0;r<t.length;r++)e.push(255&t.charCodeAt(r));return e}function utf16leToBytes(t){for(var e,r,n,i=[],f=0;f<t.length;f++)e=t.charCodeAt(f),r=e>>8,n=e%256,i.push(n),i.push(r);return i}function base64ToBytes(t){return base64.toByteArray(t)}function blitBuffer(t,e,r,n){for(var i=0;n>i&&!(i+r>=e.length||i>=t.length);i++)e[i+r]=t[i];return i}function decodeUtf8Char(t){try{return decodeURIComponent(t)}catch(e){return String.fromCharCode(65533)}}function assert(t,e){if(!t)throw new Error(e||"Failed assertion")}var base64=_dereq_("base64-js"),ieee754=_dereq_("ieee754");exports.Buffer=Buffer,exports.SlowBuffer=Buffer,exports.INSPECT_MAX_BYTES=50,Buffer.poolSize=8192,Buffer.TYPED_ARRAY_SUPPORT=function(){try{var t=new ArrayBuffer(0),e=new Uint8Array(t);return e.foo=function(){return 42},42===e.foo()&&"function"==typeof e.subarray&&0===new Uint8Array(1).subarray(1,1).byteLength}catch(r){return!1}}(),Buffer.isEncoding=function(t){switch(String(t).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"raw":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},Buffer.isBuffer=function(t){return!(null==t||!t._isBuffer)},Buffer.byteLength=function(t,e){var r;switch(t=t.toString(),e||"utf8"){case"hex":r=t.length/2;break;case"utf8":case"utf-8":r=utf8ToBytes(t).length;break;case"ascii":case"binary":case"raw":r=t.length;break;case"base64":r=base64ToBytes(t).length;break;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":r=2*t.length;break;default:throw new Error("Unknown encoding")}return r},Buffer.concat=function(t,e){if(assert(isArray(t),"Usage: Buffer.concat(list[, length])"),0===t.length)return new Buffer(0);if(1===t.length)return t[0];var r;if(void 0===e)for(e=0,r=0;r<t.length;r++)e+=t[r].length;var n=new Buffer(e),i=0;for(r=0;r<t.length;r++){var f=t[r];f.copy(n,i),i+=f.length}return n},Buffer.compare=function(t,e){assert(Buffer.isBuffer(t)&&Buffer.isBuffer(e),"Arguments must be Buffers");for(var r=t.length,n=e.length,i=0,f=Math.min(r,n);f>i&&t[i]===e[i];i++);return i!==f&&(r=t[i],n=e[i]),n>r?-1:r>n?1:0},Buffer.prototype.write=function(t,e,r,n){if(isFinite(e))isFinite(r)||(n=r,r=void 0);else{var i=n;n=e,e=r,r=i}e=Number(e)||0;var f=this.length-e;r?(r=Number(r),r>f&&(r=f)):r=f,n=String(n||"utf8").toLowerCase();var s;switch(n){case"hex":s=hexWrite(this,t,e,r);break;case"utf8":case"utf-8":s=utf8Write(this,t,e,r);break;case"ascii":s=asciiWrite(this,t,e,r);break;case"binary":s=binaryWrite(this,t,e,r);break;case"base64":s=base64Write(this,t,e,r);break;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":s=utf16leWrite(this,t,e,r);break;default:throw new Error("Unknown encoding")}return s},Buffer.prototype.toString=function(t,e,r){var n=this;if(t=String(t||"utf8").toLowerCase(),e=Number(e)||0,r=void 0===r?n.length:Number(r),r===e)return"";var i;switch(t){case"hex":i=hexSlice(n,e,r);break;case"utf8":case"utf-8":i=utf8Slice(n,e,r);break;case"ascii":i=asciiSlice(n,e,r);break;case"binary":i=binarySlice(n,e,r);break;case"base64":i=base64Slice(n,e,r);break;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":i=utf16leSlice(n,e,r);break;default:throw new Error("Unknown encoding")}return i},Buffer.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},Buffer.prototype.equals=function(t){return assert(Buffer.isBuffer(t),"Argument must be a Buffer"),0===Buffer.compare(this,t)},Buffer.prototype.compare=function(t){return assert(Buffer.isBuffer(t),"Argument must be a Buffer"),Buffer.compare(this,t)},Buffer.prototype.copy=function(t,e,r,n){var i=this;if(r||(r=0),n||0===n||(n=this.length),e||(e=0),n!==r&&0!==t.length&&0!==i.length){assert(n>=r,"sourceEnd < sourceStart"),assert(e>=0&&e<t.length,"targetStart out of bounds"),assert(r>=0&&r<i.length,"sourceStart out of bounds"),assert(n>=0&&n<=i.length,"sourceEnd out of bounds"),n>this.length&&(n=this.length),t.length-e<n-r&&(n=t.length-e+r);var f=n-r;if(100>f||!Buffer.TYPED_ARRAY_SUPPORT)for(var s=0;f>s;s++)t[s+e]=this[s+r];else t._set(this.subarray(r,r+f),e)}},Buffer.prototype.slice=function(t,e){var r=this.length;if(t=~~t,e=void 0===e?r:~~e,0>t?(t+=r,0>t&&(t=0)):t>r&&(t=r),0>e?(e+=r,0>e&&(e=0)):e>r&&(e=r),t>e&&(e=t),Buffer.TYPED_ARRAY_SUPPORT)return Buffer._augment(this.subarray(t,e));for(var n=e-t,i=new Buffer(n,void 0,!0),f=0;n>f;f++)i[f]=this[f+t];return i},Buffer.prototype.get=function(t){return console.log(".get() is deprecated. Access using array indexes instead."),this.readUInt8(t)},Buffer.prototype.set=function(t,e){return console.log(".set() is deprecated. Access using array indexes instead."),this.writeUInt8(t,e)},Buffer.prototype.readUInt8=function(t,e){return e||checkOffset(t,1,this.length),this[t]},Buffer.prototype.readUInt16LE=function(t,e){return e||checkOffset(t,2,this.length),this[t]|this[t+1]<<8},Buffer.prototype.readUInt16BE=function(t,e){return e||checkOffset(t,2,this.length),this[t]<<8|this[t+1]},Buffer.prototype.readUInt32LE=function(t,e){return e||checkOffset(t,4,this.length),(this[t]|this[t+1]<<8|this[t+2]<<16)+16777216*this[t+3]},Buffer.prototype.readUInt32BE=function(t,e){return e||checkOffset(t,4,this.length),16777216*this[t]+(this[t+1]<<16|this[t+2]<<8|this[t+3])},Buffer.prototype.readInt8=function(t,e){return e||checkOffset(t,1,this.length),128&this[t]?-1*(255-this[t]+1):this[t]},Buffer.prototype.readInt16LE=function(t,e){e||checkOffset(t,2,this.length);var r=this[t]|this[t+1]<<8;return 32768&r?4294901760|r:r},Buffer.prototype.readInt16BE=function(t,e){e||checkOffset(t,2,this.length);var r=this[t+1]|this[t]<<8;return 32768&r?4294901760|r:r},Buffer.prototype.readInt32LE=function(t,e){return e||checkOffset(t,4,this.length),this[t]|this[t+1]<<8|this[t+2]<<16|this[t+3]<<24},Buffer.prototype.readInt32BE=function(t,e){return e||checkOffset(t,4,this.length),this[t]<<24|this[t+1]<<16|this[t+2]<<8|this[t+3]},Buffer.prototype.readFloatLE=function(t,e){return e||checkOffset(t,4,this.length),ieee754.read(this,t,!0,23,4)},Buffer.prototype.readFloatBE=function(t,e){return e||checkOffset(t,4,this.length),ieee754.read(this,t,!1,23,4)},Buffer.prototype.readDoubleLE=function(t,e){return e||checkOffset(t,8,this.length),ieee754.read(this,t,!0,52,8)},Buffer.prototype.readDoubleBE=function(t,e){return e||checkOffset(t,8,this.length),ieee754.read(this,t,!1,52,8)},Buffer.prototype.writeUInt8=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,1,255,0),Buffer.TYPED_ARRAY_SUPPORT||(t=Math.floor(t)),this[e]=t,e+1},Buffer.prototype.writeUInt16LE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,2,65535,0),Buffer.TYPED_ARRAY_SUPPORT?(this[e]=t,this[e+1]=t>>>8):objectWriteUInt16(this,t,e,!0),e+2},Buffer.prototype.writeUInt16BE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,2,65535,0),Buffer.TYPED_ARRAY_SUPPORT?(this[e]=t>>>8,this[e+1]=t):objectWriteUInt16(this,t,e,!1),e+2},Buffer.prototype.writeUInt32LE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,4,4294967295,0),Buffer.TYPED_ARRAY_SUPPORT?(this[e+3]=t>>>24,this[e+2]=t>>>16,this[e+1]=t>>>8,this[e]=t):objectWriteUInt32(this,t,e,!0),e+4},Buffer.prototype.writeUInt32BE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,4,4294967295,0),Buffer.TYPED_ARRAY_SUPPORT?(this[e]=t>>>24,this[e+1]=t>>>16,this[e+2]=t>>>8,this[e+3]=t):objectWriteUInt32(this,t,e,!1),e+4},Buffer.prototype.writeInt8=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,1,127,-128),Buffer.TYPED_ARRAY_SUPPORT||(t=Math.floor(t)),0>t&&(t=255+t+1),this[e]=t,e+1},Buffer.prototype.writeInt16LE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,2,32767,-32768),Buffer.TYPED_ARRAY_SUPPORT?(this[e]=t,this[e+1]=t>>>8):objectWriteUInt16(this,t,e,!0),e+2},Buffer.prototype.writeInt16BE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,2,32767,-32768),Buffer.TYPED_ARRAY_SUPPORT?(this[e]=t>>>8,this[e+1]=t):objectWriteUInt16(this,t,e,!1),e+2},Buffer.prototype.writeInt32LE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,4,2147483647,-2147483648),Buffer.TYPED_ARRAY_SUPPORT?(this[e]=t,this[e+1]=t>>>8,this[e+2]=t>>>16,this[e+3]=t>>>24):objectWriteUInt32(this,t,e,!0),e+4},Buffer.prototype.writeInt32BE=function(t,e,r){return t=+t,e>>>=0,r||checkInt(this,t,e,4,2147483647,-2147483648),0>t&&(t=4294967295+t+1),Buffer.TYPED_ARRAY_SUPPORT?(this[e]=t>>>24,this[e+1]=t>>>16,this[e+2]=t>>>8,this[e+3]=t):objectWriteUInt32(this,t,e,!1),e+4},Buffer.prototype.writeFloatLE=function(t,e,r){return writeFloat(this,t,e,!0,r)},Buffer.prototype.writeFloatBE=function(t,e,r){return writeFloat(this,t,e,!1,r)},Buffer.prototype.writeDoubleLE=function(t,e,r){return writeDouble(this,t,e,!0,r)},Buffer.prototype.writeDoubleBE=function(t,e,r){return writeDouble(this,t,e,!1,r)},Buffer.prototype.fill=function(t,e,r){if(t||(t=0),e||(e=0),r||(r=this.length),assert(r>=e,"end < start"),r!==e&&0!==this.length){assert(e>=0&&e<this.length,"start out of bounds"),assert(r>=0&&r<=this.length,"end out of bounds");var n;if("number"==typeof t)for(n=e;r>n;n++)this[n]=t;else{var i=utf8ToBytes(t.toString()),f=i.length;for(n=e;r>n;n++)this[n]=i[n%f]}return this}},Buffer.prototype.inspect=function(){for(var t=[],e=this.length,r=0;e>r;r++)if(t[r]=toHex(this[r]),r===exports.INSPECT_MAX_BYTES){t[r+1]="...";break}return"<Buffer "+t.join(" ")+">"},Buffer.prototype.toArrayBuffer=function(){if("undefined"!=typeof Uint8Array){if(Buffer.TYPED_ARRAY_SUPPORT)return new Buffer(this).buffer;for(var t=new Uint8Array(this.length),e=0,r=t.length;r>e;e+=1)t[e]=this[e];return t.buffer}throw new Error("Buffer.toArrayBuffer not supported in this browser")};var BP=Buffer.prototype;Buffer._augment=function(t){return t._isBuffer=!0,t._get=t.get,t._set=t.set,t.get=BP.get,t.set=BP.set,t.write=BP.write,t.toString=BP.toString,t.toLocaleString=BP.toString,t.toJSON=BP.toJSON,t.equals=BP.equals,t.compare=BP.compare,t.copy=BP.copy,t.slice=BP.slice,t.readUInt8=BP.readUInt8,t.readUInt16LE=BP.readUInt16LE,t.readUInt16BE=BP.readUInt16BE,t.readUInt32LE=BP.readUInt32LE,t.readUInt32BE=BP.readUInt32BE,t.readInt8=BP.readInt8,t.readInt16LE=BP.readInt16LE,t.readInt16BE=BP.readInt16BE,t.readInt32LE=BP.readInt32LE,t.readInt32BE=BP.readInt32BE,t.readFloatLE=BP.readFloatLE,t.readFloatBE=BP.readFloatBE,t.readDoubleLE=BP.readDoubleLE,t.readDoubleBE=BP.readDoubleBE,t.writeUInt8=BP.writeUInt8,t.writeUInt16LE=BP.writeUInt16LE,t.writeUInt16BE=BP.writeUInt16BE,t.writeUInt32LE=BP.writeUInt32LE,t.writeUInt32BE=BP.writeUInt32BE,t.writeInt8=BP.writeInt8,t.writeInt16LE=BP.writeInt16LE,t.writeInt16BE=BP.writeInt16BE,t.writeInt32LE=BP.writeInt32LE,t.writeInt32BE=BP.writeInt32BE,t.writeFloatLE=BP.writeFloatLE,t.writeFloatBE=BP.writeFloatBE,t.writeDoubleLE=BP.writeDoubleLE,t.writeDoubleBE=BP.writeDoubleBE,t.fill=BP.fill,t.inspect=BP.inspect,t.toArrayBuffer=BP.toArrayBuffer,t};var INVALID_BASE64_RE=/[^+\/0-9A-z]/g;
//# sourceMappingURL=kurento-client.map
...
function HubPort(e){MediaElement.call(this,e)}var inherits=_dereq_("inherits"),MediaElement=_dereq_("./abstracts/MediaElement");inherits(HubPort,MediaElement),HubPort.constructorParams={hub:{type:"Hub",required:!0}},HubPort.events=MediaElement.events,module.exports=HubPort,HubPort.check=function(e,t){if(!(t instanceof HubPort))throw SyntaxError(e+" param should be a HubPort, not "+typeof t)};
//# sourceMappingURL=kurento-client.map
},{"./abstracts/MediaElement":47,"inherits":41}],43:[function(_dereq_,module,exports){
function MediaPipeline(e){MediaObject.call(this,e)}var inherits=_dereq_("inherits"),Promise=_dereq_("es6-promise").Promise,promiseCallback=_dereq_("promisecallback"),MediaObject=_dereq_("./abstracts/MediaObject");inherits(MediaPipeline,MediaObject),MediaPipeline.prototype.create=function(e,i,r){var a=this;if(i instanceof Function){if(r)throw new SyntaxError("Nothing can be defined after the callback");r=i,i=void 0}i=i||{};var n=new Promise(function(r,n){i.mediaPipeline=a,a.emit("_create",e,i,function(e,i){return e?n(e):void r(i)})});return promiseCallback(n,r)},MediaPipeline.constructorParams={},MediaPipeline.events=MediaObject.events,module.exports=MediaPipeline,MediaPipeline.check=function(e,i){if(!(i instanceof MediaPipeline))throw SyntaxError(e+" param should be a MediaPipeline, not "+typeof i)};
//# sourceMappingURL=kurento-client.map
},{"./abstracts/MediaObject":48,"es6-promise":4,"inherits":41,"promisecallback":91}],44:[function(_dereq_,module,exports){
function Endpoint(n){MediaElement.call(this,n)}var inherits=_dereq_("inherits"),MediaElement=_dereq_("./MediaElement");inherits(Endpoint,MediaElement),Endpoint.constructorParams={},Endpoint.events=MediaElement.events,module.exports=Endpoint,Endpoint.check=function(n,e){if(!(e instanceof Endpoint))throw SyntaxError(n+" param should be a Endpoint, not "+typeof e)};
//# sourceMappingURL=kurento-client.map
},{"./MediaElement":47,"inherits":41}],45:[function(_dereq_,module,exports){
function Filter(e){MediaElement.call(this,e)}var inherits=_dereq_("inherits"),MediaElement=_dereq_("./MediaElement");inherits(Filter,MediaElement),Filter.constructorParams={},Filter.events=MediaElement.events,module.exports=Filter,Filter.check=function(e,t){if(!(t instanceof Filter))throw SyntaxError(e+" param should be a Filter, not "+typeof t)};
//# sourceMappingURL=kurento-client.map
},{"./MediaElement":47,"inherits":41}],46:[function(_dereq_,module,exports){
function Hub(e){MediaObject.call(this,e)}var inherits=_dereq_("inherits"),Promise=_dereq_("es6-promise").Promise,promiseCallback=_dereq_("promisecallback"),MediaObject=_dereq_("./MediaObject");inherits(Hub,MediaObject),Hub.prototype.createHubPort=function(e){var r=this,t=new Promise(function(e,t){r.emit("_create","HubPort",{hub:r},function(r,i){return r?t(r):void e(i)})});return promiseCallback(t,e)},Hub.constructorParams={},Hub.events=MediaObject.events,module.exports=Hub,Hub.check=function(e,r){if(!(r instanceof Hub))throw SyntaxError(e+" param should be a Hub, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"./MediaObject":48,"es6-promise":4,"inherits":41,"promisecallback":91}],47:[function(_dereq_,module,exports){
function MediaElement(e){MediaObject.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),MediaObject=_dereq_("./MediaObject");inherits(MediaElement,MediaObject),MediaElement.prototype.connect=function(e,t,i,n){if(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0)switch(arguments.length){case 1:t=void 0;break;case 2:i=void 0}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","mediaDescription",i);var a={sink:e,mediaType:t,mediaDescription:i};return this.invoke("connect",a,n)},MediaElement.prototype.getMediaSinks=function(e,t,i){if(i=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0)switch(arguments.length){case 0:e=void 0;break;case 1:t=void 0}checkType("MediaType","mediaType",e),checkType("String","description",t);var n={mediaType:e,description:t};return this.invoke("getMediaSinks",n,i)},MediaElement.prototype.getMediaSrcs=function(e,t,i){if(i=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0)switch(arguments.length){case 0:e=void 0;break;case 1:t=void 0}checkType("MediaType","mediaType",e),checkType("String","description",t);var n={mediaType:e,description:t};return this.invoke("getMediaSrcs",n,i)},MediaElement.constructorParams={},MediaElement.events=MediaObject.events,module.exports=MediaElement,MediaElement.check=function(e,t){if(!(t instanceof MediaElement))throw SyntaxError(e+" param should be a MediaElement, not "+typeof t)};
//# sourceMappingURL=kurento-client.map
},{"./MediaObject":48,"checktype":3,"inherits":41}],48:[function(_dereq_,module,exports){
function MediaObject(e){EventEmitter.call(this,e),Object.defineProperty(this,"id",{value:e});var t={};this.on("removeListener",function(e){if("release"!=e&&"_rpc"!=e&&"newListener"!=e){var i=EventEmitter.listenerCount(this,e);if(!i){var r=t[e];this.emit("_rpc","unsubscribe",{subscription:r},function(i){return i?this.emit("error",i):void delete t[e]})}}}),this.on("newListener",function(e){if("release"!=e&&"_rpc"!=e&&"_create"!=e){var i=this.constructor;if(i.events.indexOf(e)<0)throw new SyntaxError(i.name+" doesn't accept events of type '"+e+"'");var r=EventEmitter.listenerCount(this,e);r||this.emit("_rpc","subscribe",{type:e},function(i,r){return i?this.emit("error",i):void(t[e]=r)})}})}var inherits=_dereq_("inherits"),Promise=_dereq_("es6-promise").Promise,promiseCallback=_dereq_("promisecallback"),EventEmitter=_dereq_("events").EventEmitter;inherits(MediaObject,EventEmitter),MediaObject.prototype.getMediaPipeline=function(e){return this.invoke("getMediaPipeline",e)},MediaObject.prototype.getParent=function(e){return this.invoke("getParent",e)},MediaObject.prototype.invoke=function(e,t,i){var r=this;if(t instanceof Function){if(i)throw new SyntaxError("Nothing can be defined after the callback");i=t,t=void 0}var n=new Promise(function(i,n){var o={operation:e};t&&(o.operationParams=t),r.emit("_rpc","invoke",o,function(e,t){if(e)return n(e);var o=t.value;void 0===o&&(o=r),i(o)})});return promiseCallback(n,i)},MediaObject.prototype.release=function(e){var t=this,i=new Promise(function(e,i){t.emit("_rpc","release",{},function(r){return r?i(r):(t.emit("release"),t.removeAllListeners(),void e())})});return promiseCallback(i,e)},MediaObject.constructorParams={},MediaObject.events=["Error"],module.exports=MediaObject,MediaObject.check=function(e,t){if(!(t instanceof MediaObject))throw SyntaxError(e+" param should be a MediaObject, not "+typeof t)};
//# sourceMappingURL=kurento-client.map
},{"es6-promise":4,"events":18,"inherits":41,"promisecallback":91}],49:[function(_dereq_,module,exports){
function MediaPad(e){MediaObject.call(this,e)}var inherits=_dereq_("inherits"),MediaObject=_dereq_("./MediaObject");inherits(MediaPad,MediaObject),MediaPad.prototype.getMediaDescription=function(e){return this.invoke("getMediaDescription",e)},MediaPad.prototype.getMediaElement=function(e){return this.invoke("getMediaElement",e)},MediaPad.prototype.getMediaType=function(e){return this.invoke("getMediaType",e)},MediaPad.constructorParams={},MediaPad.events=MediaObject.events,module.exports=MediaPad,MediaPad.check=function(e,i){if(!(i instanceof MediaPad))throw SyntaxError(e+" param should be a MediaPad, not "+typeof i)};
//# sourceMappingURL=kurento-client.map
},{"./MediaObject":48,"inherits":41}],50:[function(_dereq_,module,exports){
function MediaSink(e){MediaPad.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),MediaPad=_dereq_("./MediaPad");inherits(MediaSink,MediaPad),MediaSink.prototype.disconnect=function(e,i){checkType("MediaSource","src",e,{required:!0});var n={src:e};return this.invoke("disconnect",n,i)},MediaSink.prototype.getConnectedSrc=function(e){return this.invoke("getConnectedSrc",e)},MediaSink.constructorParams={},MediaSink.events=MediaPad.events,module.exports=MediaSink,MediaSink.check=function(e,i){if(!(i instanceof MediaSink))throw SyntaxError(e+" param should be a MediaSink, not "+typeof i)};
//# sourceMappingURL=kurento-client.map
},{"./MediaPad":49,"checktype":3,"inherits":41}],51:[function(_dereq_,module,exports){
function MediaSource(e){MediaPad.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),MediaPad=_dereq_("./MediaPad");inherits(MediaSource,MediaPad),MediaSource.prototype.connect=function(e,i){checkType("MediaSink","sink",e,{required:!0});var r={sink:e};return this.invoke("connect",r,i)},MediaSource.prototype.getConnectedSinks=function(e){return this.invoke("getConnectedSinks",e)},MediaSource.prototype.disconnect=function(e,i){checkType("MediaSink","sink",e,{required:!0});var r={src:this};return e.invoke("disconnect",r,i)},MediaSource.constructorParams={},MediaSource.events=MediaPad.events,module.exports=MediaSource,MediaSource.check=function(e,i){if(!(i instanceof MediaSource))throw SyntaxError(e+" param should be a MediaSource, not "+typeof i)};
//# sourceMappingURL=kurento-client.map
},{"./MediaPad":49,"checktype":3,"inherits":41}],52:[function(_dereq_,module,exports){
function SdpEndpoint(e){SessionEndpoint.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),SessionEndpoint=_dereq_("./SessionEndpoint");inherits(SdpEndpoint,SessionEndpoint),SdpEndpoint.prototype.generateOffer=function(e){return this.invoke("generateOffer",e)},SdpEndpoint.prototype.getLocalSessionDescriptor=function(e){return this.invoke("getLocalSessionDescriptor",e)},SdpEndpoint.prototype.getRemoteSessionDescriptor=function(e){return this.invoke("getRemoteSessionDescriptor",e)},SdpEndpoint.prototype.processAnswer=function(e,n){checkType("String","answer",e,{required:!0});var t={answer:e};return this.invoke("processAnswer",t,n)},SdpEndpoint.prototype.processOffer=function(e,n){checkType("String","offer",e,{required:!0});var t={offer:e};return this.invoke("processOffer",t,n)},SdpEndpoint.constructorParams={},SdpEndpoint.events=SessionEndpoint.events,module.exports=SdpEndpoint,SdpEndpoint.check=function(e,n){if(!(n instanceof SdpEndpoint))throw SyntaxError(e+" param should be a SdpEndpoint, not "+typeof n)};
//# sourceMappingURL=kurento-client.map
},{"./SessionEndpoint":53,"checktype":3,"inherits":41}],53:[function(_dereq_,module,exports){
function SessionEndpoint(n){Endpoint.call(this,n)}var inherits=_dereq_("inherits"),Endpoint=_dereq_("./Endpoint");inherits(SessionEndpoint,Endpoint),SessionEndpoint.constructorParams={},SessionEndpoint.events=Endpoint.events.concat(["MediaSessionStarted","MediaSessionTerminated"]),module.exports=SessionEndpoint,SessionEndpoint.check=function(n,i){if(!(i instanceof SessionEndpoint))throw SyntaxError(n+" param should be a SessionEndpoint, not "+typeof i)};
//# sourceMappingURL=kurento-client.map
},{"./Endpoint":44,"inherits":41}],54:[function(_dereq_,module,exports){
function UriEndpoint(n){Endpoint.call(this,n)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),Endpoint=_dereq_("./Endpoint");inherits(UriEndpoint,Endpoint),UriEndpoint.prototype.getUri=function(n){return this.invoke("getUri",n)},UriEndpoint.prototype.pause=function(n){return this.invoke("pause",n)},UriEndpoint.prototype.stop=function(n){return this.invoke("stop",n)},UriEndpoint.constructorParams={},UriEndpoint.events=Endpoint.events,module.exports=UriEndpoint,UriEndpoint.check=function(n,i){if(!(i instanceof UriEndpoint))throw SyntaxError(n+" param should be a UriEndpoint, not "+typeof i)};
//# sourceMappingURL=kurento-client.map
},{"./Endpoint":44,"checktype":3,"inherits":41}],55:[function(_dereq_,module,exports){
var Endpoint=_dereq_("./Endpoint"),Filter=_dereq_("./Filter"),Hub=_dereq_("./Hub"),MediaElement=_dereq_("./MediaElement"),MediaObject=_dereq_("./MediaObject"),MediaPad=_dereq_("./MediaPad"),MediaSink=_dereq_("./MediaSink"),MediaSource=_dereq_("./MediaSource"),SdpEndpoint=_dereq_("./SdpEndpoint"),SessionEndpoint=_dereq_("./SessionEndpoint"),UriEndpoint=_dereq_("./UriEndpoint");exports.Endpoint=Endpoint,exports.Filter=Filter,exports.Hub=Hub,exports.MediaElement=MediaElement,exports.MediaObject=MediaObject,exports.MediaPad=MediaPad,exports.MediaSink=MediaSink,exports.MediaSource=MediaSource,exports.SdpEndpoint=SdpEndpoint,exports.SessionEndpoint=SessionEndpoint,exports.UriEndpoint=UriEndpoint;
//# sourceMappingURL=kurento-client.map
...
function checkFilterType(e,r){if("string"!=typeof r)throw SyntaxError(e+" param should be a String, not "+typeof r);if(!r.match("AUDIO|AUTODETECT|VIDEO"))throw SyntaxError(e+" param is not one of [AUDIO|AUTODETECT|VIDEO] ("+r+")")}var checkType=_dereq_("checktype");module.exports=checkFilterType;
//# sourceMappingURL=kurento-client.map
...
var FilterType=_dereq_("./FilterType"),MediaType=_dereq_("./MediaType");exports.FilterType=FilterType,exports.MediaType=MediaType;
//# sourceMappingURL=kurento-client.map
},{"./FilterType":56,"./MediaType":57}],59:[function(_dereq_,module,exports){
var HubPort=_dereq_("./HubPort"),MediaPipeline=_dereq_("./MediaPipeline");exports.HubPort=HubPort,exports.MediaPipeline=MediaPipeline,exports.abstracts=_dereq_("./abstracts"),exports.complexTypes=_dereq_("./complexTypes");
//# sourceMappingURL=kurento-client.map
},{"./HubPort":42,"./MediaPipeline":43,"./abstracts":55,"./complexTypes":58}],60:[function(_dereq_,module,exports){
function AlphaBlending(e){Hub.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),Hub=_dereq_("kurento-client-core").abstracts.Hub;inherits(AlphaBlending,Hub),AlphaBlending.prototype.setMaster=function(e,r,t){checkType("HubPort","source",e,{required:!0}),checkType("int","zOrder",r,{required:!0});var i={source:e,zOrder:r};return this.invoke("setMaster",i,t)},AlphaBlending.prototype.setPortProperties=function(e,r,t,i,n,a,l){checkType("float","relativeX",e,{required:!0}),checkType("float","relativeY",r,{required:!0}),checkType("int","zOrder",t,{required:!0}),checkType("float","relativeWidth",i,{required:!0}),checkType("float","relativeHeight",n,{required:!0}),checkType("HubPort","port",a,{required:!0});var o={relativeX:e,relativeY:r,zOrder:t,relativeWidth:i,relativeHeight:n,port:a};return this.invoke("setPortProperties",o,l)},AlphaBlending.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},AlphaBlending.events=Hub.events,module.exports=AlphaBlending,AlphaBlending.check=function(e,r){if(!(r instanceof AlphaBlending))throw SyntaxError(e+" param should be a AlphaBlending, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],61:[function(_dereq_,module,exports){
function Composite(e){Hub.call(this,e)}var inherits=_dereq_("inherits"),Hub=_dereq_("kurento-client-core").abstracts.Hub;inherits(Composite,Hub),Composite.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},Composite.events=Hub.events,module.exports=Composite,Composite.check=function(e,o){if(!(o instanceof Composite))throw SyntaxError(e+" param should be a Composite, not "+typeof o)};
//# sourceMappingURL=kurento-client.map
},{"inherits":41,"kurento-client-core":59}],62:[function(_dereq_,module,exports){
function Dispatcher(e){Hub.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),Hub=_dereq_("kurento-client-core").abstracts.Hub;inherits(Dispatcher,Hub),Dispatcher.prototype.connect=function(e,r,t){checkType("HubPort","source",e,{required:!0}),checkType("HubPort","sink",r,{required:!0});var i={source:e,sink:r};return this.invoke("connect",i,t)},Dispatcher.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},Dispatcher.events=Hub.events,module.exports=Dispatcher,Dispatcher.check=function(e,r){if(!(r instanceof Dispatcher))throw SyntaxError(e+" param should be a Dispatcher, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],63:[function(_dereq_,module,exports){
function DispatcherOneToMany(e){Hub.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),Hub=_dereq_("kurento-client-core").abstracts.Hub;inherits(DispatcherOneToMany,Hub),DispatcherOneToMany.prototype.removeSource=function(e){return this.invoke("removeSource",e)},DispatcherOneToMany.prototype.setSource=function(e,r){checkType("HubPort","source",e,{required:!0});var n={source:e};return this.invoke("setSource",n,r)},DispatcherOneToMany.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},DispatcherOneToMany.events=Hub.events,module.exports=DispatcherOneToMany,DispatcherOneToMany.check=function(e,r){if(!(r instanceof DispatcherOneToMany))throw SyntaxError(e+" param should be a DispatcherOneToMany, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],64:[function(_dereq_,module,exports){
function HttpGetEndpoint(t){HttpEndpoint.call(this,t)}var inherits=_dereq_("inherits"),HttpEndpoint=_dereq_("./abstracts/HttpEndpoint");inherits(HttpGetEndpoint,HttpEndpoint),HttpGetEndpoint.constructorParams={disconnectionTimeout:{type:"int"},mediaPipeline:{type:"MediaPipeline",required:!0},mediaProfile:{type:"MediaProfileSpecType"},terminateOnEOS:{type:"boolean"}},HttpGetEndpoint.events=HttpEndpoint.events,module.exports=HttpGetEndpoint,HttpGetEndpoint.check=function(t,n){if(!(n instanceof HttpGetEndpoint))throw SyntaxError(t+" param should be a HttpGetEndpoint, not "+typeof n)};
//# sourceMappingURL=kurento-client.map
},{"./abstracts/HttpEndpoint":72,"inherits":41}],65:[function(_dereq_,module,exports){
function HttpPostEndpoint(t){HttpEndpoint.call(this,t)}var inherits=_dereq_("inherits"),HttpEndpoint=_dereq_("./abstracts/HttpEndpoint");inherits(HttpPostEndpoint,HttpEndpoint),HttpPostEndpoint.constructorParams={disconnectionTimeout:{type:"int"},mediaPipeline:{type:"MediaPipeline",required:!0},useEncodedMedia:{type:"boolean"}},HttpPostEndpoint.events=HttpEndpoint.events.concat(["EndOfStream"]),module.exports=HttpPostEndpoint,HttpPostEndpoint.check=function(t,n){if(!(n instanceof HttpPostEndpoint))throw SyntaxError(t+" param should be a HttpPostEndpoint, not "+typeof n)};
//# sourceMappingURL=kurento-client.map
},{"./abstracts/HttpEndpoint":72,"inherits":41}],66:[function(_dereq_,module,exports){
function Mixer(e){Hub.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),Hub=_dereq_("kurento-client-core").abstracts.Hub;inherits(Mixer,Hub),Mixer.prototype.connect=function(e,r,i,c){checkType("MediaType","media",e,{required:!0}),checkType("HubPort","source",r,{required:!0}),checkType("HubPort","sink",i,{required:!0});var t={media:e,source:r,sink:i};return this.invoke("connect",t,c)},Mixer.prototype.disconnect=function(e,r,i,c){checkType("MediaType","media",e,{required:!0}),checkType("HubPort","source",r,{required:!0}),checkType("HubPort","sink",i,{required:!0});var t={media:e,source:r,sink:i};return this.invoke("disconnect",t,c)},Mixer.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},Mixer.events=Hub.events,module.exports=Mixer,Mixer.check=function(e,r){if(!(r instanceof Mixer))throw SyntaxError(e+" param should be a Mixer, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],67:[function(_dereq_,module,exports){
function PlayerEndpoint(e){UriEndpoint.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),UriEndpoint=_dereq_("kurento-client-core").abstracts.UriEndpoint;inherits(PlayerEndpoint,UriEndpoint),PlayerEndpoint.prototype.play=function(e){return this.invoke("play",e)},PlayerEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0},uri:{type:"String",required:!0},useEncodedMedia:{type:"boolean"}},PlayerEndpoint.events=UriEndpoint.events.concat(["EndOfStream"]),module.exports=PlayerEndpoint,PlayerEndpoint.check=function(e,n){if(!(n instanceof PlayerEndpoint))throw SyntaxError(e+" param should be a PlayerEndpoint, not "+typeof n)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],68:[function(_dereq_,module,exports){
function PlumberEndpoint(e){Endpoint.call(this,e)}var inherits=_dereq_("inherits"),Endpoint=_dereq_("kurento-client-core").abstracts.Endpoint;inherits(PlumberEndpoint,Endpoint),PlumberEndpoint.constructorParams={localAddres:{type:"String",required:!0},localPort:{type:"int",required:!0},mediaPipeline:{type:"MediaPipeline",required:!0},remoteAddres:{type:"String",required:!0},remotePort:{type:"int",required:!0}},PlumberEndpoint.events=Endpoint.events,module.exports=PlumberEndpoint,PlumberEndpoint.check=function(e,n){if(!(n instanceof PlumberEndpoint))throw SyntaxError(e+" param should be a PlumberEndpoint, not "+typeof n)};
//# sourceMappingURL=kurento-client.map
},{"inherits":41,"kurento-client-core":59}],69:[function(_dereq_,module,exports){
function RecorderEndpoint(e){UriEndpoint.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),UriEndpoint=_dereq_("kurento-client-core").abstracts.UriEndpoint;inherits(RecorderEndpoint,UriEndpoint),RecorderEndpoint.prototype.record=function(e){return this.invoke("record",e)},RecorderEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0},mediaProfile:{type:"MediaProfileSpecType"},stopOnEndOfStream:{type:"boolean"},uri:{type:"String",required:!0}},RecorderEndpoint.events=UriEndpoint.events,module.exports=RecorderEndpoint,RecorderEndpoint.check=function(e,r){if(!(r instanceof RecorderEndpoint))throw SyntaxError(e+" param should be a RecorderEndpoint, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],70:[function(_dereq_,module,exports){
function RtpEndpoint(n){SdpEndpoint.call(this,n)}var inherits=_dereq_("inherits"),SdpEndpoint=_dereq_("kurento-client-core").abstracts.SdpEndpoint;inherits(RtpEndpoint,SdpEndpoint),RtpEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},RtpEndpoint.events=SdpEndpoint.events,module.exports=RtpEndpoint,RtpEndpoint.check=function(n,t){if(!(t instanceof RtpEndpoint))throw SyntaxError(n+" param should be a RtpEndpoint, not "+typeof t)};
//# sourceMappingURL=kurento-client.map
},{"inherits":41,"kurento-client-core":59}],71:[function(_dereq_,module,exports){
function WebRtcEndpoint(n){SdpEndpoint.call(this,n)}var inherits=_dereq_("inherits"),SdpEndpoint=_dereq_("kurento-client-core").abstracts.SdpEndpoint;inherits(WebRtcEndpoint,SdpEndpoint),WebRtcEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},WebRtcEndpoint.events=SdpEndpoint.events,module.exports=WebRtcEndpoint,WebRtcEndpoint.check=function(n,t){if(!(t instanceof WebRtcEndpoint))throw SyntaxError(n+" param should be a WebRtcEndpoint, not "+typeof t)};
//# sourceMappingURL=kurento-client.map
},{"inherits":41,"kurento-client-core":59}],72:[function(_dereq_,module,exports){
function HttpEndpoint(t){SessionEndpoint.call(this,t)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),SessionEndpoint=_dereq_("kurento-client-core").abstracts.SessionEndpoint;inherits(HttpEndpoint,SessionEndpoint),HttpEndpoint.prototype.getUrl=function(t){return this.invoke("getUrl",t)},HttpEndpoint.constructorParams={},HttpEndpoint.events=SessionEndpoint.events,module.exports=HttpEndpoint,HttpEndpoint.check=function(t,n){if(!(n instanceof HttpEndpoint))throw SyntaxError(t+" param should be a HttpEndpoint, not "+typeof n)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],73:[function(_dereq_,module,exports){
var HttpEndpoint=_dereq_("./HttpEndpoint");exports.HttpEndpoint=HttpEndpoint;
//# sourceMappingURL=kurento-client.map
...
var MediaProfileSpecType=_dereq_("./MediaProfileSpecType");exports.MediaProfileSpecType=MediaProfileSpecType;
//# sourceMappingURL=kurento-client.map
},{"./MediaProfileSpecType":74}],76:[function(_dereq_,module,exports){
var AlphaBlending=_dereq_("./AlphaBlending"),Composite=_dereq_("./Composite"),Dispatcher=_dereq_("./Dispatcher"),DispatcherOneToMany=_dereq_("./DispatcherOneToMany"),HttpGetEndpoint=_dereq_("./HttpGetEndpoint"),HttpPostEndpoint=_dereq_("./HttpPostEndpoint"),Mixer=_dereq_("./Mixer"),PlayerEndpoint=_dereq_("./PlayerEndpoint"),PlumberEndpoint=_dereq_("./PlumberEndpoint"),RecorderEndpoint=_dereq_("./RecorderEndpoint"),RtpEndpoint=_dereq_("./RtpEndpoint"),WebRtcEndpoint=_dereq_("./WebRtcEndpoint");exports.AlphaBlending=AlphaBlending,exports.Composite=Composite,exports.Dispatcher=Dispatcher,exports.DispatcherOneToMany=DispatcherOneToMany,exports.HttpGetEndpoint=HttpGetEndpoint,exports.HttpPostEndpoint=HttpPostEndpoint,exports.Mixer=Mixer,exports.PlayerEndpoint=PlayerEndpoint,exports.PlumberEndpoint=PlumberEndpoint,exports.RecorderEndpoint=RecorderEndpoint,exports.RtpEndpoint=RtpEndpoint,exports.WebRtcEndpoint=WebRtcEndpoint,exports.abstracts=_dereq_("./abstracts"),exports.complexTypes=_dereq_("./complexTypes");
//# sourceMappingURL=kurento-client.map
...
function FaceOverlayFilter(e){Filter.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(FaceOverlayFilter,Filter),FaceOverlayFilter.prototype.setOverlayedImage=function(e,r,t,i,a,c){checkType("String","uri",e,{required:!0}),checkType("float","offsetXPercent",r,{required:!0}),checkType("float","offsetYPercent",t,{required:!0}),checkType("float","widthPercent",i,{required:!0}),checkType("float","heightPercent",a,{required:!0});var l={uri:e,offsetXPercent:r,offsetYPercent:t,widthPercent:i,heightPercent:a};return this.invoke("setOverlayedImage",l,c)},FaceOverlayFilter.prototype.unsetOverlayedImage=function(e){return this.invoke("unsetOverlayedImage",e)},FaceOverlayFilter.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},FaceOverlayFilter.events=Filter.events,module.exports=FaceOverlayFilter,FaceOverlayFilter.check=function(e,r){if(!(r instanceof FaceOverlayFilter))throw SyntaxError(e+" param should be a FaceOverlayFilter, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"checktype":3,"inherits":41,"kurento-client-core":59}],78:[function(_dereq_,module,exports){
function GStreamerFilter(e){Filter.call(this,e)}var inherits=_dereq_("inherits"),Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(GStreamerFilter,Filter),GStreamerFilter.constructorParams={command:{type:"String",required:!0},filterType:{type:"FilterType"},mediaPipeline:{type:"MediaPipeline",required:!0}},GStreamerFilter.events=Filter.events,module.exports=GStreamerFilter,GStreamerFilter.check=function(e,r){if(!(r instanceof GStreamerFilter))throw SyntaxError(e+" param should be a GStreamerFilter, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"inherits":41,"kurento-client-core":59}],79:[function(_dereq_,module,exports){
function ZBarFilter(e){Filter.call(this,e)}var inherits=_dereq_("inherits"),Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(ZBarFilter,Filter),ZBarFilter.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},ZBarFilter.events=Filter.events.concat(["CodeFound"]),module.exports=ZBarFilter,ZBarFilter.check=function(e,r){if(!(r instanceof ZBarFilter))throw SyntaxError(e+" param should be a ZBarFilter, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"inherits":41,"kurento-client-core":59}],80:[function(_dereq_,module,exports){
function OpenCVFilter(e){Filter.call(this,e)}var inherits=_dereq_("inherits"),Filter=_dereq_("kurento-client-core").abstracts.Filter;inherits(OpenCVFilter,Filter),OpenCVFilter.constructorParams={},OpenCVFilter.events=Filter.events,module.exports=OpenCVFilter,OpenCVFilter.check=function(e,r){if(!(r instanceof OpenCVFilter))throw SyntaxError(e+" param should be a OpenCVFilter, not "+typeof r)};
//# sourceMappingURL=kurento-client.map
},{"inherits":41,"kurento-client-core":59}],81:[function(_dereq_,module,exports){
var OpenCVFilter=_dereq_("./OpenCVFilter");exports.OpenCVFilter=OpenCVFilter;
//# sourceMappingURL=kurento-client.map
},{"./OpenCVFilter":80}],82:[function(_dereq_,module,exports){
var FaceOverlayFilter=_dereq_("./FaceOverlayFilter"),GStreamerFilter=_dereq_("./GStreamerFilter"),ZBarFilter=_dereq_("./ZBarFilter");exports.FaceOverlayFilter=FaceOverlayFilter,exports.GStreamerFilter=GStreamerFilter,exports.ZBarFilter=ZBarFilter,exports.abstracts=_dereq_("./abstracts");
//# sourceMappingURL=kurento-client.map
