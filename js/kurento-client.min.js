...
function BaseRtpEndpoint(){BaseRtpEndpoint.super_.call(this)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),ChecktypeError=kurentoClient.checkType.ChecktypeError,Transaction=kurentoClient.TransactionsManager.Transaction,SdpEndpoint=require("./SdpEndpoint");inherits(BaseRtpEndpoint,SdpEndpoint),BaseRtpEndpoint.prototype.getMaxVideoSendBandwidth=function(n){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(n=void 0),this._invoke(t,"getMaxVideoSendBandwidth",n)},BaseRtpEndpoint.prototype.getMinVideoSendBandwidth=function(n){var t=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;return arguments.length||(n=void 0),this._invoke(t,"getMinVideoSendBandwidth",n)},BaseRtpEndpoint.constructorParams={},BaseRtpEndpoint.events=SdpEndpoint.events,module.exports=BaseRtpEndpoint,BaseRtpEndpoint.check=function(n,t){if(!(t instanceof BaseRtpEndpoint))throw ChecktypeError(n,BaseRtpEndpoint,t)};
...
function WebRtcEndpoint(){WebRtcEndpoint.super_.call(this)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),ChecktypeError=kurentoClient.checkType.ChecktypeError,BaseRtpEndpoint=require("kurento-client-core").abstracts.BaseRtpEndpoint;inherits(WebRtcEndpoint,BaseRtpEndpoint),WebRtcEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},WebRtcEndpoint.events=BaseRtpEndpoint.events,module.exports=WebRtcEndpoint,WebRtcEndpoint.check=function(e,t){if(!(t instanceof WebRtcEndpoint))throw ChecktypeError(e,WebRtcEndpoint,t)};
...
function serializeParams(e){for(var n in e){var r=e[n];if(r instanceof MediaObject){var t=r.id;void 0!==t&&(e[n]=t)}}return e}function serializeOperation(e,n){var r=e.params;switch(e.method){case"create":r.constructorParams=serializeParams(r.constructorParams);break;default:r=serializeParams(r),r.operationParams=serializeParams(r.operationParams)}e.jsonrpc="2.0",e.id=n}function deferred(e,n,r,t){var a=[];void 0!=e&&a.push(e);for(var i in n){var o=n[i];void 0!==o&&a.push(o)}return void 0!=r&&a.push(r),promiseCallback(Promise.all(a),t)}function noop(e){e&&console.trace(e)}function id2object(e,n,r,t,a){if(e)return a(e);var i=["getConnectedSinks","getMediaPipeline","getMediaSinks","getMediaSrcs","getParent"];if(-1!=i.indexOf(r)){var o=n.sessionId;return this.getMediaobjectById(t,function(e,n){if(e)return a(e);var n={sessionId:o,value:n};a(null,n)})}a(null,n)}function KurentoClient(e,n,r){function t(e){var n=e.method,r=e.params.value,t=r.object,a=h[t];if(!a)return console.warn("Unknown object id '"+t+"'",e);switch(n){case"onEvent":a.emit(r.type,r.data);break;default:console.warn("Unknown message type '"+n+"'")}}function a(n){var r=!1,t=reconnect({failAfter:p},function(e){r&&(e.writable=!1),g.transport=e}).connect(e);Object.defineProperty(this,"_re",{configurable:!0,get:function(){return t}}),this.close=function(){r=!0,v.then(t.disconnect.bind(t))},t.on("fail",this.emit.bind(this,"disconnect")),this.then=function(e,n){return new Promise(function(r,a){function i(){t.removeListener("fail",o);var i;if(e)try{i=e.call(f,f)}catch(c){return n||console.trace("Uncaugh exception",c),a(c)}r(i)}function o(){t.removeListener("connection",i);var e=new Error("Connection error");if(n)try{e=n.call(f,e)}catch(r){return a(r)}else console.trace("Uncaugh exception",e);a(e)}t.connected?i():t.reconnect?(t.once("connection",i),t.once("fail",o)):o()})},this["catch"]=this.then.bind(this,null),n&&this.then(n.bind(void 0,null),n)}function i(e,n,r){f.then(function(){g.encode(e,n,function(e,n){e&&(e=extend(new Error(e.message||e),e)),r(e,n)})},function(){a.call(f,function(t){return t?r(t):void i(e,n,r)})})}function o(e,n,r){function t(e,t){var a=n.object;if(e)return a.emit("_id",e),r(e);var i=t.value;r(null,l(a,i))}return e?transactionOperation.call(e,"create",n,r):k.length?transactionOperation.call(k,"create",n,r):(r=r||noop,void deferred(null,n.constructorParams,null,function(e){return e?r(e):(n.constructorParams=serializeParams(n.constructorParams),void i("create",n,t))}))}function c(e,n,r,t){if(e)return transactionOperation.call(e,n,r,t);var a=r.object;if(a&&a.transactions&&a.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}for(var c in r.operationParams){var a=r.operationParams[c];if(a&&a.transactions&&a.transactions.length){var o=new TransactionNotCommitedException;return o.method=n,o.params=r,setTimeout(t,0,o)}}if(k.length)return transactionOperation.call(k,n,r,t);var s=new Promise(function(e,t){function a(n,a){var i=r.operation,o=a?a.value:void 0;id2object.call(f,n,a,i,o,function(n,r){return n?t(n):void e(r)})}m=deferred(r.object,r.operationParams,m,function(e){return e?t(e):(r=serializeParams(r),r.operationParams=serializeParams(r.operationParams),void i(n,r,a))})});v=promiseCallback(s,t),"release"==n&&(m=v)}function s(e,n){function r(e,n){if(n instanceof MediaObject&&void 0===n.id){var r=o.findIndex(function(r){return e!=r&&r.params.object===n});if(r>=0)return"newref:"+r;d.push(n)}return n}function t(e,r){return e?n(e):(o.forEach(function(e,n){var t=e.callback||noop,a=r.value[n];if(void 0==a)return t(new Error("Command not executed in the server"));var i,o=a.error,c=a.result;switch(c&&(i=c.value),e.method){case"create":var s=e.params.object;if(o)return s.emit("_id",o),t(o);t(null,l(s,i));break;default:id2object.call(f,o,c,e,i,t)}}),void n(null,r))}if(k.length)return transactionOperation.call(k,"transaction",e,n);for(var a,o=e.operations,c=0;a=o[c];c++){var s=a.params.object;if(s instanceof MediaObject&&null===s.id){var u=new Error("MediaObject not found in server");return u.code=40101,u.object=s,o.forEach(function(e){"create"==e.method&&e.params.object.emit("_id",u);var n=e.callback;n instanceof Function&&n(u)}),n(u)}}var d=[];o.forEach(function(e){var n=e.params;switch(e.method){case"create":var t=n.constructorParams;for(var a in t)t[a]=r(e,t[a]);break;default:n.object=r(e,n.object);var i=n.operationParams;for(var a in i)i[a]=r(e,i[a])}}),Promise.all(d).then(function(){o.forEach(serializeOperation),i("transaction",e,t)},n)}function u(e,n){if(k.length)return transactionOperation.call(k,"transaction",e,n);var r=e.operations;async.each(r,function(e){switch(e.method){case"create":o(void 0,e.params,e.callback);break;case"transaction":u(e.params.operations,e.callback);break;default:c(void 0,e.method,e.params,e.callback)}},n)}function l(e,n){var r=h[n];return r?r:(e.emit("_id",null,n),h[n]=e,e.once("release",function(){delete h[n]}),e)}function d(e,n){function r(r,t){if(r)return n(r);var a=E.createInmediate(t);return n(null,l(a,e))}var t=h[e];if(t)return n(null,t);var a={object:e};i("describe",a,r)}if(!(this instanceof KurentoClient))return new KurentoClient(e,n,r);var f=this;EventEmitter.call(this);var m=Promise.resolve(),v=Promise.resolve();n instanceof Function&&(r=n,n=void 0),n=n||{};var p=n.failAfter;void 0==p&&(p=5),n.enableTransactions=n.enableTransactions||!0,n.request_timeout=n.request_timeout||BASE_TIMEOUT,n.response_timeout=n.response_timeout||BASE_TIMEOUT,n.duplicates_timeout=n.duplicates_timeout||BASE_TIMEOUT;var h={};if("string"==typeof e){var b=n.access_token;void 0!=b&&(e=url.parse(e,!0),e.query.access_token=b,e=url.format(e),delete n.access_token)}var g=new RpcBuilder(JsonRPC,n,function(e){return e instanceof RpcBuilder.RpcNotification?void 0!=e.duplicated?console.warning("Unexpected request:",e):t(e):void console.error("Invalid request instance",e)});a.call(f,r);var P=n.enableTransactions?s:u,k=new TransactionsManager(this,function(e,n){var r={object:f,operations:e};P(r,n)});this.beginTransaction=k.beginTransaction.bind(k),this.endTransaction=k.endTransaction.bind(k),this.transaction=k.transaction.bind(k);var E=new MediaObjectCreator(void 0,o,c,P);this.getMediaobjectById=function(e,n){return createPromise(e,d,n)},this.create=E.create.bind(E)}var EventEmitter=require("events").EventEmitter,url=require("url"),Promise=require("es6-promise").Promise,async=require("async"),extend=require("extend"),inherits=require("inherits"),reconnect=require("reconnect-ws"),checkType=require("checktype"),RpcBuilder=require("kurento-jsonrpc"),JsonRPC=RpcBuilder.packers.JsonRPC,promiseCallback=require("promisecallback"),createPromise=require("./createPromise"),MediaObjectCreator=require("./MediaObjectCreator"),register=require("./register"),TransactionsManager=require("./TransactionsManager"),TransactionNotCommitedException=TransactionsManager.TransactionNotCommitedException,transactionOperation=TransactionsManager.transactionOperation;module.exports=KurentoClient,KurentoClient.KurentoClient=KurentoClient,KurentoClient.checkType=checkType,KurentoClient.MediaObjectCreator=MediaObjectCreator,KurentoClient.register=register,KurentoClient.TransactionsManager=TransactionsManager;var MediaObject=require("kurento-client-core").abstracts.MediaObject;const BASE_TIMEOUT=2e4;Array.prototype.findIndex||(Array.prototype.findIndex=function(e){if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof e)throw new TypeError("predicate must be a function");for(var n,r=Object(this),t=r.length>>>0,a=arguments[1],i=0;t>i;i++)if(n=r[i],e.call(a,n,i,r))return i;return-1}),inherits(KurentoClient,EventEmitter);var checkMediaElement=checkType.bind(null,"MediaElement","media");KurentoClient.prototype.connect=function(e,n){if(e=Array.prototype.slice.call(arguments,0),n="function"==typeof e[e.length-1]?e.pop():void 0,e.length<2)throw new SyntaxError("Need at least two media elements to connect");e.forEach(checkMediaElement);var r=new Promise(function(n,r){function t(e,t){return e?r(e):void n(t)}var a=e[0];async.each(e.slice(1),function(e,n){a.connect(e,n),a=e},t)});return promiseCallback(r,n)},KurentoClient.prototype.getServerManager=function(e){return this.getMediaobjectById("manager_ServerManager",e)},register(require("kurento-client-core")),register(require("kurento-client-elements")),register(require("kurento-client-filters"));
