...
function JsonRpcClient(e){function n(){console.log("notReconnectIfNumLessThan = "+l+" (old="+c+")"),c=l}function o(){if(N){var o=null;0!=l&&l!=c||(o={interval:e.heartbeat||PING_INTERVAL}),l++,i.send("ping",o,function(e){return function(o,t){o&&(console.log("Error in ping request #"+e+" ("+o.message+")"),e>c&&(N=!1,n(),console.log("Server did not respond to ping message #"+e+". Reconnecting... "),d.reconnectWs()))}}(l))}else console.log("Trying to send ping, but ping is not enabled")}function t(){a||(console.log("Starting ping (if configured)"),a=!0,void 0!=e.heartbeat&&(r=setInterval(o,e.heartbeat),o()))}var r,i=this,s=e.ws,c=-1,l=0,N=!0,a=!1,g=DISCONNECTED,u=s.onreconnecting,C=s.onreconnected,E=s.onconnected;e.rpc.pull=function(e,n){n.reply(null,"push")},s.onreconnecting=function(){return console.log("--------- ONRECONNECTING -----------"),g===RECONNECTING?void console.error("Websocket already in RECONNECTING state when receiving a new ONRECONNECTING message. Ignoring it"):(g=RECONNECTING,void(u&&u()))},s.onreconnected=function(){return console.log("--------- ONRECONNECTED -----------"),g===CONNECTED?void console.error("Websocket already in CONNECTED state when receiving a new ONRECONNECTED message. Ignoring it"):(g=CONNECTED,N=!0,n(),t(),void(C&&C()))},s.onconnected=function(){return console.log("--------- ONCONNECTED -----------"),g===CONNECTED?void console.error("Websocket already in CONNECTED state when receiving a new ONCONNECTED message. Ignoring it"):(g=CONNECTED,N=!0,t(),void(E&&E()))};var d=new WebSocketWithReconnection(s);console.log("Connecting websocket to URI: "+s.uri);var O={request_timeout:e.rpc.requestTimeout,ping_request_timeout:e.rpc.heartbeatRequestTimeout},R=new RpcBuilder(RpcBuilder.packers.JsonRPC,O,d,function(n){console.log("Received request: "+JSON.stringify(n));try{var o=e.rpc[n.method];void 0===o?console.error("Method "+n.method+" not registered in client"):o(n.params,n)}catch(e){console.error("Exception processing request: "+JSON.stringify(n)),console.error(e)}});this.send=function(e,n,o){"ping"!==e&&console.log("Request: method:"+e+" params:"+JSON.stringify(n));var t=Date.now();R.encode(e,n,function(r,i){if(r){try{console.error("ERROR:"+r.message+" in Request: method:"+e+" params:"+JSON.stringify(n)+" request:"+r.request),r.data&&console.error("ERROR DATA:"+JSON.stringify(r.data))}catch(e){}r.requestTime=t}o&&(void 0!=i&&"pong"!==i.value&&console.log("Response: "+JSON.stringify(i)),o(r,i))})},this.close=function(){console.log("Closing jsonRpcClient explicitely by client"),void 0!=r&&clearInterval(r),a=!1,N=!1,e.sendCloseMessage?this.send("closeSession",null,function(e,n){e&&console.error("Error sending close message: "+JSON.stringify(e)),d.close()}):d.close()},this.forceClose=function(e){d.forceClose(e)},this.reconnect=function(){d.reconnectWs()}}var RpcBuilder=require("../.."),WebSocketWithReconnection=require("./transports/webSocketWithReconnection");Date.now=Date.now||function(){return+new Date};var PING_INTERVAL=5e3,RECONNECTING="RECONNECTING",CONNECTED="CONNECTED",DISCONNECTED="DISCONNECTED";module.exports=JsonRpcClient;
...
"use strict";function WebSocketWithReconnection(n){function o(n,o){try{console.log("WebSocket connected to "+o)}catch(n){console.error(n)}}function e(o,t){if(console.log("reconnectInNewUri (attempt #"+t+", max="+o+")"),1===t){if(u)return void console.warn("Trying to reconnect when reconnecting... Ignoring this reconnection.");u=!0,n.onreconnecting&&n.onreconnecting()}f?c(o,t,r):n.newWsUriOnReconnection?n.newWsUriOnReconnection(function(n,i){n?(console.log(n),setTimeout(function(){e(o,t+1)},RETRY_TIME_MS)):c(o,t,i)}):c(o,t,r)}function c(c,s,f){console.log("Reconnection attempt #"+s),r=f||r;var S;S=l?new SockJS(r):new WebSocket(r),S.onopen=function(){console.log("Reconnected after "+s+" attempts..."),o(S,r),u=!1,t(),n.onreconnected()&&n.onreconnected(),S.onclose=g};var a=function(o){console.log("Reconnection error: ",o),s===c?n.ondisconnect&&n.ondisconnect():setTimeout(function(){e(c,s+1)},RETRY_TIME_MS)};S.onerror=a,i=S}var t,i,s=!1,r=n.uri,l=n.useSockJS,u=!1,f=!1;i=l?new SockJS(r):new WebSocket(r),i.onopen=function(){o(i,r),n.onconnected()},i.onerror=function(o){n.onconnected(o.data)};var g=function(){i.readyState===CLOSED?s?console.log("Connection closed by user"):(console.log("Connection closed unexpectecly. Reconnecting..."),e(MAX_RETRIES,1)):console.log("Close callback from previous websocket. Ignoring it")};i.onclose=g,this.close=function(){s=!0,i.close()},this.forceClose=function(n){if(console.log("Testing: Force WebSocket close"),n){console.log("Testing: Change wsUri for "+n+" millis to simulate net failure");var o=r;r="wss://21.234.12.34.4:443/",f=!0,setTimeout(function(){console.log("Testing: Recover good wsUri "+o),r=o,f=!1},n)}i.close()},this.reconnectWs=function(){console.log("reconnectWs"),e(MAX_RETRIES,1,r)},this.send=function(n){i.send(n)},this.addEventListener=function(n,o){(t=function(){i.addEventListener(n,o)})()}}var WebSocket=require("ws"),SockJS=require("sockjs-client"),MAX_RETRIES=2e3,RETRY_TIME_MS=3e3,CONNECTING=0,OPEN=1,CLOSING=2,CLOSED=3;module.exports=WebSocketWithReconnection;
