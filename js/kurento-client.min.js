...
function PlumberEndpoint(e){PlumberEndpoint.super_.call(this,e)}var inherits=_dereq_("inherits"),checkType=_dereq_("checktype"),ChecktypeError=checkType.ChecktypeError,Endpoint=_dereq_("kurento-client-core").abstracts.Endpoint;inherits(PlumberEndpoint,Endpoint),PlumberEndpoint.prototype.getAddress=function(e){return this.invoke("getAddress",e)},PlumberEndpoint.prototype.getPort=function(e){return this.invoke("getPort",e)},PlumberEndpoint.prototype.connect=function(e,n,r){checkType("String","address",e,{required:!0}),checkType("int","port",n,{required:!0});var t={address:e,port:n};return this.invoke("connect",t,r)},PlumberEndpoint.constructorParams={mediaPipeline:{type:"MediaPipeline",required:!0}},PlumberEndpoint.events=Endpoint.events,module.exports=PlumberEndpoint,PlumberEndpoint.check=function(e,n){if(!(n instanceof PlumberEndpoint))throw ChecktypeError(e,PlumberEndpoint,n)};
//# sourceMappingURL=kurento-client.map
