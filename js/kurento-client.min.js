...
function noop(e,t){return e&&console.trace(e),t}function MediaElement(){MediaElement.super_.call(this)}function checkMediaElement(e,t){if(!(t instanceof MediaElement))throw ChecktypeError(e,MediaElement,t)}var inherits=require("inherits"),kurentoClient=require("kurento-client"),disguise=kurentoClient.disguise,checkType=kurentoClient.checkType,ChecktypeError=checkType.ChecktypeError,checkArray=checkType.checkArray,Transaction=kurentoClient.TransactionsManager.Transaction,each=require("async").each,promiseCallback=require("promisecallback"),MediaObject=require("./MediaObject");inherits(MediaElement,MediaObject),MediaElement.prototype.connect=function(e,t,n,a,r){var i,o=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;if(e instanceof Array){r=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0;var s=e,c=this;if(e=s[s.length-1],!s.length)throw new SyntaxError("Need at least one media element to connect");checkArray("MediaElement","media",s),i=new Promise(function(e,t){function n(n,a){return n?t(n):void e(a)}each(s,function(e,t){c=c.connect(e,t)},n)}),i=promiseCallback(i,r)}else{var o=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(r=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:a=void 0;break;case 4:console.log("All optional params are used");break;default:var p=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw p.length=arguments.length,p.min=1,p.max=4,p}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",a);var u={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:a};r=(r||noop).bind(this),i=this._invoke(o,"connect",u,r)}return disguise(i,e)},MediaElement.prototype.disconnect=function(e,t,n,a,r){var i=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(r=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 1:t=void 0;case 2:n=void 0;case 3:a=void 0;break;case 4:console.log("All optional params are used");break;default:var o=new RangeError("Number of params ("+arguments.length+") not in range [1-4]");throw o.length=arguments.length,o.min=1,o.max=4,o}checkType("MediaElement","sink",e,{required:!0}),checkType("MediaType","mediaType",t),checkType("String","sourceMediaDescription",n),checkType("String","sinkMediaDescription",a);var s={sink:e,mediaType:t,sourceMediaDescription:n,sinkMediaDescription:a};return r=(r||noop).bind(this),disguise(this._invoke(i,"disconnect",s,r),this)},MediaElement.prototype.getGstreamerDot=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(t=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;break;case 1:console.log("All optional params are used");break;default:var a=new RangeError("Number of params ("+arguments.length+") not in range [0-1]");throw a.length=arguments.length,a.min=0,a.max=1,a}checkType("GstreamerDotDetails","details",e);var r={details:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"getGstreamerDot",r,t),this)},MediaElement.prototype.getSinkConnections=function(e,t,n){var a=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;case 2:console.log("All optional params are used");break;default:var r=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw r.length=arguments.length,r.min=0,r.max=2,r}checkType("MediaType","mediaType",e),checkType("String","description",t);var i={mediaType:e,description:t};return n=(n||noop).bind(this),disguise(this._invoke(a,"getSinkConnections",i,n),this)},MediaElement.prototype.getSourceConnections=function(e,t,n){var a=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;switch(n=arguments[arguments.length-1]instanceof Function?Array.prototype.pop.call(arguments):void 0,arguments.length){case 0:e=void 0;case 1:t=void 0;break;case 2:console.log("All optional params are used");break;default:var r=new RangeError("Number of params ("+arguments.length+") not in range [0-2]");throw r.length=arguments.length,r.min=0,r.max=2,r}checkType("MediaType","mediaType",e),checkType("String","description",t);var i={mediaType:e,description:t};return n=(n||noop).bind(this),disguise(this._invoke(a,"getSourceConnections",i,n),this)},MediaElement.prototype.setAudioFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("AudioCaps","caps",e,{required:!0});var a={caps:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"setAudioFormat",a,t),this)},MediaElement.prototype.setOutputBitrate=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("int","bitrate",e,{required:!0});var a={bitrate:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"setOutputBitrate",a,t),this)},MediaElement.prototype.setVideoFormat=function(e,t){var n=arguments[0]instanceof Transaction?Array.prototype.shift.apply(arguments):void 0;checkType("VideoCaps","caps",e,{required:!0});var a={caps:e};return t=(t||noop).bind(this),disguise(this._invoke(n,"setVideoFormat",a,t),this)},MediaElement.constructorParams={},MediaElement.events=MediaObject.events.concat(["ElementConnected","ElementDisconnected"]),module.exports=MediaElement,MediaElement.check=checkMediaElement;
